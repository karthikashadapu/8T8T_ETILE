...
# jop_en                            : 1 or 0
# hps_ftile_25gbe_1588_en           : 1 or 0
# hps_ftile_25gbe_1588_count        : 1
#
...
if { ![ info exists hps_ftile_25gbe_1588_en ] } {
 set hps_ftile_25gbe_1588_en $HPS_FTILE_25GBE_1588_EN
} else {
 puts "-- Accepted parameter \$U:\ghrd\fm\agilex_ftile\agilex_ftile_v2 = $hps_ftile_25gbe_1588_en"
}

if { ![ info exists hps_ftile_25gbe_1588_count ] } {
 set hps_ftile_25gbe_1588_count $HPS_FTILE_25GBE_1588_COUNT
} else {
 puts "-- Accepted parameter \$hps_ftile_25gbe_1588_count = $hps_ftile_25gbe_1588_count"
}
...
# for acp_adapter
if {$hps_ftile_25gbe_1588_en == 1 || $fpga_pcie == 1 || ($h2f_f2h_loopback_acp_adapter_en == 1 && $h2f_f2h_loopback_en == 1)} {
...
if { $hps_ftile_25gbe_1588_en == 1 || $fpga_pcie == 1} {
