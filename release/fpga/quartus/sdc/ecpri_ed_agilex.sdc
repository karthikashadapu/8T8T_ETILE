...
set CLK100          [get_clocks MAIN_CLOCK]

set_input_delay -clock $CLK100 1 [get_ports {AG_FBR_RSTN}] -add_delay 
...
set CORE_CLK0        [get_clocks {u_iopll_390p625|iopll_0_outclk0}]

# Clock groups
set_clock_groups -asynchronous -group $CLK100 -group $ALT_RSV_CLK
set_clock_groups -asynchronous -group $CLK100 -group $OSC_CLK
...
set_false_path -from {*ecpri_ip_inst|*_std_synchronizer_nocut|dreg*} -to {*ecpri_ip_inst|*fifo*|auto_generated|*aclr|dffe*}

set_max_delay -from [get_keepers {soc_inst|*|ecpri_i|csrunit|ipv4_header_checksum*}] -to [get_keepers {soc_inst|*|ecpri_i|ecpri_mac_inst|ethframe_inst|ethframe_ins_inst|ipv4_header_length_checksum_d1*}] 100			  
set_min_delay -from [get_keepers {soc_inst|*|ecpri_i|csrunit|ipv4_header_checksum*}] -to [get_keepers {soc_inst|*|ecpri_i|ecpri_mac_inst|ethframe_inst|ethframe_ins_inst|ipv4_header_length_checksum_d1*}] -100		  

set_max_delay -from [get_keepers {soc_inst|*|ecpri_i|csrunit|ecpri_csr_inst|packet_type_enable_vlan_en}] -to [get_keepers {soc_inst|*|ecpri_i|ecpri_mac_inst|ethframe_inst|ethframe_ins_inst|data_src_mac_data*_ff*}] 100			  
set_min_delay -from [get_keepers {soc_inst|*|ecpri_i|csrunit|ecpri_csr_inst|packet_type_enable_vlan_en}] -to [get_keepers {soc_inst|*|ecpri_i|ecpri_mac_inst|ethframe_inst|ethframe_ins_inst|data_src_mac_data*_ff*}] -100		  

set_max_delay -from [get_keepers {soc_inst|*|ecpri_i|csrunit|ecpri_csr_inst|*}] -to [get_keepers {soc_inst|*|rx_packet_parser_inst|*}] 100			  
set_min_delay -from [get_keepers {soc_inst|*|ecpri_i|csrunit|ecpri_csr_inst|*}] -to [get_keepers {soc_inst|*|rx_packet_parser_inst|*}] -100		  

set_max_delay -from [get_keepers {soc_inst|*|ecpri_i|csrunit|ecpri_csr_inst|*}] -to [get_keepers {soc_inst|*|ecpri_i|ecpri_mac_inst|ethframe_inst|ethframe_ins_inst|*}] 100			  
set_min_delay -from [get_keepers {soc_inst|*|ecpri_i|csrunit|ecpri_csr_inst|*}] -to [get_keepers {soc_inst|*|ecpri_i|ecpri_mac_inst|ethframe_inst|ethframe_ins_inst|*}] -100		  

set_max_delay -from [get_keepers {soc_inst|*|reset_logic_inst|*_mm_sync|expand[0].inst_uflex_std_synchronizer_nocut|dreg*}] -to [get_keepers {soc_inst|*|reset_logic_inst|*_srst_*_mac_clk|expand[0].inst_uflex_std_synchronizer_nocut|*}] 100			  
set_min_delay -from [get_keepers {soc_inst|*|reset_logic_inst|*_mm_sync|expand[0].inst_uflex_std_synchronizer_nocut|dreg*}] -to [get_keepers {soc_inst|*|reset_logic_inst|*_srst_*_mac_clk|expand[0].inst_uflex_std_synchronizer_nocut|*}] -100		  
...
set channel_hier "soc_inst|*NUM_CHANNELS_LOOP[$i].ecpri_ip_inst|"
