...
# ----------------------------------------
# If ecpri_hwtcl_top is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 linux 2025.11.12.19:44:27
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ecpri_hwtcl_top.ecpri_hwtcl_top"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [ecpri_hwtcl_top::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [ecpri_hwtcl_top::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [ecpri_hwtcl_top::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [ecpri_hwtcl_top::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [ecpri_hwtcl_top::normalize_path "$file"]
  set normalized_dest [ecpri_hwtcl_top::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [ecpri_hwtcl_top::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [ecpri_hwtcl_top::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [ecpri_hwtcl_top::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [ecpri_hwtcl_top::get_design_files "$QSYS_SIMDIR"]]
