	component storeandforward_fifo_prach is
		generic (
			SYMBOLS_PER_BEAT    : integer := 2;
			BITS_PER_SYMBOL     : integer := 128;
	...
	end component storeandforward_fifo_prach;

	u0 : component storeandforward_fifo_prach
		generic map (
