	storeandforward_fifo_pusch #(
		...
		.MEM_TYPE            (STRING_VALUE_FOR_MEM_TYPE)
	) u0 (
		...
		.in_data           (_connected_to_in_data_),           //   input,  width = 256,           in.data
		...
		.in_empty          (_connected_to_in_empty_),          //   input,    width = 1,             .empty
		.in_channel        (_connected_to_in_channel_),        //   input,   width = 16,             .channel
		.out_data          (_connected_to_out_data_),          //  output,  width = 256,          out.data
		...
		.out_empty         (_connected_to_out_empty_),         //  output,    width = 1,             .empty
		.out_channel       (_connected_to_out_channel_)        //  output,   width = 16,             .channel
	);
