	component ram_128i_32o_3276d_dc is
		port (
			...
			byteena_a : in  std_logic_vector(15 downto 0)  := (others => 'X')  -- byte_enable_a
		);
	end component ram_128i_32o_3276d_dc;

	u0 : component ram_128i_32o_3276d_dc
		port map (
