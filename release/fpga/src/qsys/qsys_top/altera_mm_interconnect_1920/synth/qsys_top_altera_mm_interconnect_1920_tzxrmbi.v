// qsys_top_altera_mm_interconnect_1920_tzxrmbi.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_tzxrmbi (
		...
		input  wire         hps_sub_sys_acp_0_reset_reset_bridge_in_reset_reset,                                      //                                      hps_sub_sys_acp_0_reset_reset_bridge_in_reset.reset,             Reset Input
		...
		input  wire         hps_sub_sys_acp_0_s0_translator_clk_reset_reset_bridge_in_reset_reset,                    //                    hps_sub_sys_acp_0_s0_translator_clk_reset_reset_bridge_in_reset.reset,             Reset Input
		input  wire         crosser_002_in_clk_reset_reset_bridge_in_reset_reset,                                     //                                     crosser_002_in_clk_reset_reset_bridge_in_reset.reset,             Reset Input
		input  wire         dma_subsys_dma_clk_out_bridge_0_out_clk_clk,                                              //                                            dma_subsys_dma_clk_out_bridge_0_out_clk.clk,               Clock Input
	...
	wire  [695:0] cmd_demux_src0_data;                                                                            // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [695:0] crosser_out_data;                                                                               // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [695:0] cmd_demux_src1_data;                                                                            // cmd_demux:src1_data -> crosser_001:in_data
	...
	wire  [695:0] crosser_001_out_data;                                                                           // crosser_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [695:0] cmd_demux_001_src0_data;                                                                        // cmd_demux_001:src0_data -> crosser_002:in_data
	...
	wire  [695:0] crosser_002_out_data;                                                                           // crosser_002:out_data -> cmd_mux:sink1_data
	...
	wire  [695:0] cmd_demux_001_src1_data;                                                                        // cmd_demux_001:src1_data -> crosser_003:in_data
	...
	wire  [695:0] crosser_003_out_data;                                                                           // crosser_003:out_data -> cmd_mux_001:sink1_data
	...
	wire  [695:0] rsp_demux_src0_data;                                                                            // rsp_demux:src0_data -> crosser_004:in_data
	...
	wire  [695:0] crosser_004_out_data;                                                                           // crosser_004:out_data -> rsp_mux:sink0_data
	...
	wire  [695:0] rsp_demux_src1_data;                                                                            // rsp_demux:src1_data -> crosser_005:in_data
	...
	wire  [695:0] crosser_005_out_data;                                                                           // crosser_005:out_data -> rsp_mux_001:sink0_data
	...
	wire  [695:0] rsp_demux_001_src0_data;                                                                        // rsp_demux_001:src0_data -> crosser_006:in_data
	...
	wire  [695:0] crosser_006_out_data;                                                                           // crosser_006:out_data -> rsp_mux:sink1_data
	...
	wire  [695:0] rsp_demux_001_src1_data;                                                                        // rsp_demux_001:src1_data -> crosser_007:in_data
	...
	wire  [695:0] crosser_007_out_data;                                                                           // crosser_007:out_data -> rsp_mux_001:sink1_data
	...
	qsys_top_altera_merlin_axi_translator_1950_sjnedva #(
		...
		.aresetn           (~hps_sub_sys_acp_0_s0_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset_n
	...
	qsys_top_altera_merlin_axi_slave_ni_1990_vjrabui #(
		...
		.aresetn                (~hps_sub_sys_acp_0_s0_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,        reset_sink.reset_n
	...
	qsys_top_altera_merlin_router_1921_ag77fna router_002 (
		...
		.reset              (hps_sub_sys_acp_0_s0_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1922_vr43bja cmd_mux (
		...
		.sink0_data          (crosser_out_data),                                                      //   input,  width = 696,          .data
		...
		.sink1_data          (crosser_002_out_data),                                                  //   input,  width = 696,          .data
	...
	qsys_top_altera_merlin_multiplexer_1922_vr43bja cmd_mux_001 (
		...
		.sink0_data          (crosser_001_out_data),                                                  //   input,  width = 696,          .data
	...
	qsys_top_altera_merlin_multiplexer_1922_zoozktq rsp_mux (
		...
		.sink0_data          (crosser_004_out_data),                                                     //   input,  width = 696,          .data
		...
		.sink1_data          (crosser_006_out_data),                                                     //   input,  width = 696,          .data
	...
	qsys_top_altera_merlin_multiplexer_1922_zoozktq rsp_mux_001 (
		...
		.sink0_data          (crosser_005_out_data),                                                                     //   input,  width = 696,          .data
		...
		.sink1_data          (crosser_007_out_data),                                                                     //   input,  width = 696,          .data
	...
	qsys_top_hs_clk_xer_1940_jv2gq6y #(
		...
		.in_clk            (dma_subsys_dma_clk_out_bridge_0_out_clk_clk),                 //   input,    width = 1,        in_clk.clk
		...
		.out_reset         (hps_sub_sys_acp_0_reset_reset_bridge_in_reset_reset),         //   input,    width = 1, out_clk_reset.reset
		...
		.in_data           (cmd_demux_src0_data),                                         //   input,  width = 696,              .data
	...
	qsys_top_hs_clk_xer_1940_jv2gq6y #(
		...
		.in_data           (cmd_demux_src1_data),                                         //   input,  width = 696,              .data
	...
	qsys_top_hs_clk_xer_1940_jv2gq6y #(
		...
		.in_reset          (crosser_002_in_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  in_clk_reset.reset
		.out_clk           (dma_subsys_acp_bridge_in_clk_clk),                     //   input,    width = 1,       out_clk.clk
		.out_reset         (hps_sub_sys_acp_0_reset_reset_bridge_in_reset_reset),  //   input,    width = 1, out_clk_reset.reset
	...
	qsys_top_hs_clk_xer_1940_jv2gq6y #(
		...
		.in_reset          (hps_sub_sys_acp_0_reset_reset_bridge_in_reset_reset),         //   input,    width = 1,  in_clk_reset.reset
		.out_clk           (dma_subsys_dma_clk_out_bridge_0_out_clk_clk),                 //   input,    width = 1,       out_clk.clk
		...
		.in_data           (rsp_demux_src0_data),                                         //   input,  width = 696,              .data
		...
		.out_data          (crosser_004_out_data),                                        //  output,  width = 696,              .data
		.in_empty          (1'b0),                                                        // (terminated),                             
		.in_error          (1'b0),                                                        // (terminated),                             
		.out_empty         (),                                                            // (terminated),                             
		.out_error         ()                                                             // (terminated),                             
	...
	qsys_top_hs_clk_xer_1940_jv2gq6y #(
		...
		.out_reset         (crosser_002_in_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, out_clk_reset.reset
		...
		.out_data          (crosser_005_out_data),                                 //  output,  width = 696,              .data
		.in_empty          (1'b0),                                                 // (terminated),                             
		.in_error          (1'b0),                                                 // (terminated),                             
		.out_empty         (),                                                     // (terminated),                             
		.out_error         ()                                                      // (terminated),                             
	...
	qsys_top_hs_clk_xer_1940_jv2gq6y #(
		...
		.in_data           (rsp_demux_001_src0_data),                                     //   input,  width = 696,              .data
		...
		.out_data          (crosser_006_out_data),                                        //  output,  width = 696,              .data
		.in_empty          (1'b0),                                                        // (terminated),                             
		.in_error          (1'b0),                                                        // (terminated),                             
		.out_empty         (),                                                            // (terminated),                             
		.out_error         ()                                                             // (terminated),                             
	...
	qsys_top_hs_clk_xer_1940_jv2gq6y #(
		...
		.out_data          (crosser_007_out_data),                                 //  output,  width = 696,              .data
		.in_empty          (1'b0),                                                 // (terminated),                             
		.in_error          (1'b0),                                                 // (terminated),                             
		.out_empty         (),                                                     // (terminated),                             
		.out_error         ()                                                      // (terminated),                             
