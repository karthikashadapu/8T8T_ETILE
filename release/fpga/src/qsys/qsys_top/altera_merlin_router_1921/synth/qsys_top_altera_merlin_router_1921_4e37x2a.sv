...
//    output_name             qsys_top_altera_merlin_router_1921_4e37x2a
//    pkt_addr_h              67
//    pkt_addr_l              36
//    pkt_dest_id_h           111
//    pkt_dest_id_l           109
...
//    pkt_trans_read          71
//    pkt_trans_write         70
//    slaves_info             1:000001:0x0:0x8:both:1:0:0:1,3:001000:0x41000:0x41200:both:1:0:0:1,5:010000:0x42000:0x42008:read:1:0:0:1,0:000100:0x44000:0x46000:both:1:0:0:1,6:100000:0x50000:0x50080:both:1:0:0:1,4:000010:0x100000:0x200000:both:1:0:0:1
//    st_channel_w            7
//    st_data_w               152
// ------------------------------------------

module qsys_top_altera_merlin_router_1921_4e37x2a_default_decode
  #(
...
module qsys_top_altera_merlin_router_1921_4e37x2a
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    qsys_top_altera_merlin_router_1921_4e37x2a_default_decode the_default_decode(
    ...
    always @* begin
        ...
        // slave 4: [0x50000, 0x50080) : sel [20:7]
        if ( {address[20:7],{7 {1'b0}}} == 21'h50000   ) begin
            src_channel = 7'b100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
        end

        // slave 5: [0x100000, 0x200000) : sel [20:20]
