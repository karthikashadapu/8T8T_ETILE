// qsys_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1932_dt7zjqy.v

// Generated using ACDS version 24.1 115

`timescale 1 ps / 1 ps
module qsys_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1932_dt7zjqy #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 262,
	...
	qsys_top_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),           //   input,  width = 262,          .data
		...
		.out_data          (out_data),          //  output,  width = 262,          .data
