// qsys_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1932_hrzximq.v

// Generated using ACDS version 24.1 115

`timescale 1 ps / 1 ps
module qsys_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1932_hrzximq #(
	...
	qsys_top_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),           //   input,  width = 152,          .data
		...
		.out_data          (out_data),          //  output,  width = 152,          .data
