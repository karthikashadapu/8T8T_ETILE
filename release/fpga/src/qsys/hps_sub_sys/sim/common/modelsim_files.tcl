source [file join [file dirname [info script]] ./../../../ip/hps_sub_sys/hps_sub_sys_agilex_axi_bridge_for_acp_0/sim/common/modelsim_files.tcl]
...
namespace eval hps_sub_sys {
  proc get_design_libraries {} {
    set libraries [dict create]
    set libraries [dict merge $libraries [hps_sub_sys_agilex_axi_bridge_for_acp_0::get_design_libraries]]
    ...
    dict set libraries hps_sub_sys 1
    return $libraries
  }
  
  proc get_memory_files {QSYS_SIMDIR} {
    set memory_files [list]
    set memory_files [concat $memory_files [hps_sub_sys_agilex_axi_bridge_for_acp_0::get_memory_files "$QSYS_SIMDIR/../../ip/hps_sub_sys/hps_sub_sys_agilex_axi_bridge_for_acp_0/sim/"]]
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [hps_sub_sys_agilex_axi_bridge_for_acp_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/hps_sub_sys/hps_sub_sys_agilex_axi_bridge_for_acp_0/sim/"]]
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [concat $design_files [hps_sub_sys_agilex_axi_bridge_for_acp_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/hps_sub_sys/hps_sub_sys_agilex_axi_bridge_for_acp_0/sim/"]]
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/hps_sub_sys.v"]\"  -work hps_sub_sys"
    return $design_files
  }
  ...
  proc get_elab_options {SIMULATOR_TOOL_BITNESS} {
    set ELAB_OPTIONS ""
    append ELAB_OPTIONS [get_non_duplicate_elab_option $ELAB_OPTIONS [hps_sub_sys_agilex_axi_bridge_for_acp_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
    append ELAB_OPTIONS [get_non_duplicate_elab_option $ELAB_OPTIONS [agilex_hps::get_elab_options $SIMULATOR_TOOL_BITNESS]]
    append ELAB_OPTIONS [get_non_duplicate_elab_option $ELAB_OPTIONS [emif_hps::get_elab_options $SIMULATOR_TOOL_BITNESS]]
    append ELAB_OPTIONS [get_non_duplicate_elab_option $ELAB_OPTIONS [emif_calbus_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
  ...
  proc get_sim_options {SIMULATOR_TOOL_BITNESS} {
    set SIM_OPTIONS ""
    append SIM_OPTIONS [hps_sub_sys_agilex_axi_bridge_for_acp_0::get_sim_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_env_variables {SIMULATOR_TOOL_BITNESS} {
    ...
    set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [hps_sub_sys_agilex_axi_bridge_for_acp_0::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
  ...
  proc get_dpi_libraries {QSYS_SIMDIR} {
    set libraries [dict create]
    set libraries [dict merge $libraries [hps_sub_sys_agilex_axi_bridge_for_acp_0::get_dpi_libraries "$QSYS_SIMDIR/../../ip/hps_sub_sys/hps_sub_sys_agilex_axi_bridge_for_acp_0/sim/"]]
