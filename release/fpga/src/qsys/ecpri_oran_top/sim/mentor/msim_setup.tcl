...
# ----------------------------------------
# If ecpri_oran_top is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 linux 2025.11.21.14:06:32
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ecpri_oran_top.ecpri_oran_top"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/sibgath/intelFPGA_pro/24.1/quartus/"
}
...
append ELAB_OPTIONS [subst [ecpri_oran_top::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [ecpri_oran_top::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [ecpri_oran_top::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [ecpri_oran_top::normalize_path "$file"]
  set normalized_dest [ecpri_oran_top::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [ecpri_oran_top::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [ecpri_oran_top::get_design_libraries]]
...
alias dev_com {
  ...
  if [string is false -strict [modelsim_ae_select $FORCE_MODELSIM_AE_SELECTION]] {
    eval  qrun -compile -noautoorder -parallel -outdir ./libraries -vlog.options $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS -end \
     ...
     -makelib tennm_hssi_e0_ver "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/cr3v0_serdes_models_ncrypt.sv" -end \
     -makelib tennm_hssi_p0_ver "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms.sv" -end \
     -makelib tennm_hssi_p0_ver "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms_ncrypt.sv"  -permissive -end \
     -makelib lpm "$QUARTUS_INSTALL_DIR/eda/sim_lib/220pack.vhd" -end \
     -makelib lpm "$QUARTUS_INSTALL_DIR/eda/sim_lib/220model.vhd" -end \
     -makelib sgate "$QUARTUS_INSTALL_DIR/eda/sim_lib/sgate_pack.vhd" -end \
     -makelib sgate "$QUARTUS_INSTALL_DIR/eda/sim_lib/sgate.vhd" -end \
     -makelib altera "$QUARTUS_INSTALL_DIR/eda/sim_lib/altera_syn_attributes.vhd" -end \
     -makelib altera "$QUARTUS_INSTALL_DIR/eda/sim_lib/altera_standard_functions.vhd" -end \
     -makelib altera "$QUARTUS_INSTALL_DIR/eda/sim_lib/alt_dspbuilder_package.vhd" -end \
     -makelib altera "$QUARTUS_INSTALL_DIR/eda/sim_lib/altera_europa_support_lib.vhd" -end \
     -makelib altera "$QUARTUS_INSTALL_DIR/eda/sim_lib/altera_primitives_components.vhd" -end \
     -makelib altera "$QUARTUS_INSTALL_DIR/eda/sim_lib/altera_primitives.vhd" -end \
     -makelib altera_mf "$QUARTUS_INSTALL_DIR/eda/sim_lib/altera_mf_components.vhd" -end \
     -makelib altera_mf "$QUARTUS_INSTALL_DIR/eda/sim_lib/altera_mf.vhd" -end \
     -makelib altera_lnsim "$QUARTUS_INSTALL_DIR/eda/sim_lib/altera_lnsim.sv" -end \
     -makelib altera_lnsim "$QUARTUS_INSTALL_DIR/eda/sim_lib/altera_lnsim_components.vhd" -end \
     -makelib tennm "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/tennm_atoms_ncrypt.sv" -end \
     -makelib tennm "$QUARTUS_INSTALL_DIR/eda/sim_lib/tennm_atoms.vhd" -end \
     -makelib tennm "$QUARTUS_INSTALL_DIR/eda/sim_lib/tennm_components.vhd" -end \
     -makelib tennm_hssi "$QUARTUS_INSTALL_DIR/eda/sim_lib/tennm_hssi_atoms_ncrypt.sv"  -suppress 13314,2583 -end \
     -makelib tennm_hssi_e0 "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/cr3v0_serdes_models_ncrypt.sv" -end \
     -makelib tennm_hssi_p0 "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_components.vhd" -end \
     -makelib tennm_hssi_p0 "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms.vhd" -end \
...
alias com {
  ...
  set common_design_files [dict values [ecpri_oran_top::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [ecpri_oran_top::get_design_files "$QSYS_SIMDIR"]]
