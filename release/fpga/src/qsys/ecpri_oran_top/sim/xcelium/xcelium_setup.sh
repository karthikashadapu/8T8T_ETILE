...
TOP_LEVEL_NAME="ecpri_oran_top.ecpri_oran_top"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/sibgath/intelFPGA_pro/24.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [ecpri_oran_top::get_elab_options $SIMULATOR_TOOL_BITNESS]
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/cadence/cr3v0_serdes_models_ncrypt.sv" -work tennm_hssi_e0    
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_components.vhd"               -work tennm_hssi_p0    
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms.vhd"                    -work tennm_hssi_p0    
fi
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [ecpri_oran_top::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [ecpri_oran_top::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
