// subsys_ftile_25gbe_tx_dma_altera_avalon_st_adapter_1920_whdx2tq.v
...
`timescale 1 ps / 1 ps
module subsys_ftile_25gbe_tx_dma_altera_avalon_st_adapter_1920_whdx2tq #(
	...
	subsys_ftile_25gbe_tx_dma_data_format_adapter_1930_zypyqnq #(
		...
		.in_empty          (in_0_empty),          //   input,    width = 4,      .empty
		.in_error          (in_0_error),          //   input,    width = 1,      .error
