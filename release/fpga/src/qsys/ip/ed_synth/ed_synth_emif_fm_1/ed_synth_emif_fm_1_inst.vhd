	component ed_synth_emif_fm_1 is
		port (
	...
	end component ed_synth_emif_fm_1;

	u0 : component ed_synth_emif_fm_1
		port map (
			...
			ctrl_ecc_readdataerror_0        => CONNECTED_TO_ctrl_ecc_readdataerror_0,        --  ctrl_ecc_readdataerror_0.ctrl_ecc_readdataerror
			ctrl_ecc_sts_intr               => CONNECTED_TO_ctrl_ecc_sts_intr,               --           ctrl_ecc_status.ctrl_ecc_sts_intr
			ctrl_ecc_sts_sbe_error          => CONNECTED_TO_ctrl_ecc_sts_sbe_error,          --                          .ctrl_ecc_sts_sbe_error
			ctrl_ecc_sts_dbe_error          => CONNECTED_TO_ctrl_ecc_sts_dbe_error,          --                          .ctrl_ecc_sts_dbe_error
			ctrl_ecc_sts_corr_dropped       => CONNECTED_TO_ctrl_ecc_sts_corr_dropped,       --                          .ctrl_ecc_sts_corr_dropped
			ctrl_ecc_sts_sbe_count          => CONNECTED_TO_ctrl_ecc_sts_sbe_count,          --                          .ctrl_ecc_sts_sbe_count
			ctrl_ecc_sts_dbe_count          => CONNECTED_TO_ctrl_ecc_sts_dbe_count,          --                          .ctrl_ecc_sts_dbe_count
			ctrl_ecc_sts_corr_dropped_count => CONNECTED_TO_ctrl_ecc_sts_corr_dropped_count, --                          .ctrl_ecc_sts_corr_dropped_count
			ctrl_ecc_sts_err_addr           => CONNECTED_TO_ctrl_ecc_sts_err_addr,           --                          .ctrl_ecc_sts_err_addr
			ctrl_ecc_sts_corr_dropped_addr  => CONNECTED_TO_ctrl_ecc_sts_corr_dropped_addr,  --                          .ctrl_ecc_sts_corr_dropped_addr
