...
module ed_synth_emif_fm_1 (
	...
	ed_synth_emif_fm_1_altera_emif_fm_274_vnxivpq emif_fm_1 (
		...
		.ctrl_ecc_readdataerror_0        (ctrl_ecc_readdataerror_0),        //  output,     width = 1,  ctrl_ecc_readdataerror_0.ctrl_ecc_readdataerror
		.ctrl_ecc_sts_intr               (ctrl_ecc_sts_intr),               //  output,     width = 1,           ctrl_ecc_status.ctrl_ecc_sts_intr
		.ctrl_ecc_sts_sbe_error          (ctrl_ecc_sts_sbe_error),          //  output,     width = 1,                          .ctrl_ecc_sts_sbe_error
		.ctrl_ecc_sts_dbe_error          (ctrl_ecc_sts_dbe_error),          //  output,     width = 1,                          .ctrl_ecc_sts_dbe_error
		.ctrl_ecc_sts_corr_dropped       (ctrl_ecc_sts_corr_dropped),       //  output,     width = 1,                          .ctrl_ecc_sts_corr_dropped
		.ctrl_ecc_sts_sbe_count          (ctrl_ecc_sts_sbe_count),          //  output,     width = 4,                          .ctrl_ecc_sts_sbe_count
		.ctrl_ecc_sts_dbe_count          (ctrl_ecc_sts_dbe_count),          //  output,     width = 4,                          .ctrl_ecc_sts_dbe_count
		.ctrl_ecc_sts_corr_dropped_count (ctrl_ecc_sts_corr_dropped_count), //  output,     width = 4,                          .ctrl_ecc_sts_corr_dropped_count
		.ctrl_ecc_sts_err_addr           (ctrl_ecc_sts_err_addr),           //  output,    width = 35,                          .ctrl_ecc_sts_err_addr
		.ctrl_ecc_sts_corr_dropped_addr  (ctrl_ecc_sts_corr_dropped_addr),  //  output,    width = 35,                          .ctrl_ecc_sts_corr_dropped_addr
