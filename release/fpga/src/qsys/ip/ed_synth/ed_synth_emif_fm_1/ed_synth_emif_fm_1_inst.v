	ed_synth_emif_fm_1 u0 (
		...
		.ctrl_ecc_readdataerror_0        (_connected_to_ctrl_ecc_readdataerror_0_),        //  output,     width = 1,  ctrl_ecc_readdataerror_0.ctrl_ecc_readdataerror
		.ctrl_ecc_sts_intr               (_connected_to_ctrl_ecc_sts_intr_),               //  output,     width = 1,           ctrl_ecc_status.ctrl_ecc_sts_intr
		.ctrl_ecc_sts_sbe_error          (_connected_to_ctrl_ecc_sts_sbe_error_),          //  output,     width = 1,                          .ctrl_ecc_sts_sbe_error
		.ctrl_ecc_sts_dbe_error          (_connected_to_ctrl_ecc_sts_dbe_error_),          //  output,     width = 1,                          .ctrl_ecc_sts_dbe_error
		.ctrl_ecc_sts_corr_dropped       (_connected_to_ctrl_ecc_sts_corr_dropped_),       //  output,     width = 1,                          .ctrl_ecc_sts_corr_dropped
		.ctrl_ecc_sts_sbe_count          (_connected_to_ctrl_ecc_sts_sbe_count_),          //  output,     width = 4,                          .ctrl_ecc_sts_sbe_count
		.ctrl_ecc_sts_dbe_count          (_connected_to_ctrl_ecc_sts_dbe_count_),          //  output,     width = 4,                          .ctrl_ecc_sts_dbe_count
		.ctrl_ecc_sts_corr_dropped_count (_connected_to_ctrl_ecc_sts_corr_dropped_count_), //  output,     width = 4,                          .ctrl_ecc_sts_corr_dropped_count
		.ctrl_ecc_sts_err_addr           (_connected_to_ctrl_ecc_sts_err_addr_),           //  output,    width = 35,                          .ctrl_ecc_sts_err_addr
		.ctrl_ecc_sts_corr_dropped_addr  (_connected_to_ctrl_ecc_sts_corr_dropped_addr_),  //  output,    width = 35,                          .ctrl_ecc_sts_corr_dropped_addr
