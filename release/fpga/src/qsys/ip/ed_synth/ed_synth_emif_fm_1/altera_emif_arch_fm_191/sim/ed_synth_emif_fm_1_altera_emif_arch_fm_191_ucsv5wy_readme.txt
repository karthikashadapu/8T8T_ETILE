...
---------------------
 ...
 19. Controller Avalon Streaming command interface 0
 20. Controller Avalon Streaming write data interface 0
 21. Controller Avalon Streaming read data interface 0
 22. Controller ECC interface 0
 23. EMIF calibration component interface
 24. EMIF calibration component clock input interface
...
--------------------
   ...
   SYS_INFO_UNIQUE_ID                                : ed_synth_emif_fm_1_emif_fm_1
   ...
   PHY_MEM_CLK_FREQ_MHZ                              : 1000.0
   PHY_REF_CLK_FREQ_MHZ                              : 125.0
   ...
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_5                   : 1000.0
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_5                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_6                   : 1000.0
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_6                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_7                   : 1000.0
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_7                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_8                   : 1000.0
   ...
   PHY_DDR4_MEM_CLK_FREQ_MHZ                         : 1000.0
   PHY_DDR4_DEFAULT_REF_CLK_FREQ                     : false
   PHY_DDR4_USER_REF_CLK_FREQ_MHZ                    : 125.0
   ...
   PHY_DDR4_REF_CLK_FREQ_MHZ                         : 125.0
   ...
   CTRL_ECC_READDATAERROR_EN                         : true
   CTRL_ECC_STATUS_EN                                : true
   ...
   CTRL_DDR4_ECC_READDATAERROR_EN                    : true
   CTRL_DDR4_ECC_STATUS_EN                           : true
