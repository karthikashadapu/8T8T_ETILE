module ed_synth_emif_fm_1 (
		...
		output wire          ctrl_ecc_readdataerror_0,        //  ctrl_ecc_readdataerror_0.ctrl_ecc_readdataerror,          Signal is asserted high by the controller ECC logic to indicate that the read data has an uncorrectable error. The signal has the same timing as the read data valid signal of the Controller Avalon Memory-Mapped interface.
		output wire [0:0]    ctrl_ecc_sts_intr,               //           ctrl_ecc_status.ctrl_ecc_sts_intr,               ECC interrupt status - '1' indicates interrupt occurred; for devices supporting ping-pong PHY, status from two interfaces are concatenated as a double-width port - interface 0 at LSB, interface 1 at MSB
		output wire [0:0]    ctrl_ecc_sts_sbe_error,          //                          .ctrl_ecc_sts_sbe_error,          '1' indicates SBE occurred; for devices supporting ping-pong PHY, status from two interfaces are concatenated as a double-width port - interface 0 at LSB, interface 1 at MSB
		output wire [0:0]    ctrl_ecc_sts_dbe_error,          //                          .ctrl_ecc_sts_dbe_error,          '1' indicates DBE occurred; for devices supporting ping-pong PHY, status from two interfaces are concatenated as a double-width port - interface 0 at LSB, interface 1 at MSB
		output wire [0:0]    ctrl_ecc_sts_corr_dropped,       //                          .ctrl_ecc_sts_corr_dropped,       Correction command dropped status, '1' indicates correction command dropped; for devices supporting ping-pong PHY, status from two interfaces are concatenated as a double-width port - interface 0 at LSB, interface 1 at MSB
		output wire [3:0]    ctrl_ecc_sts_sbe_count,          //                          .ctrl_ecc_sts_sbe_count,          Number of times SBE error occurred; for devices supporting ping-pong PHY, results from two interfaces are concatenated as a double-width port - interface 0 at LSB, interface 1 at MSB
		output wire [3:0]    ctrl_ecc_sts_dbe_count,          //                          .ctrl_ecc_sts_dbe_count,          Number of times DBE error occurred; for devices supporting ping-pong PHY, results from two interfaces are concatenated as a double-width port - interface 0 at LSB, interface 1 at MSB
		output wire [3:0]    ctrl_ecc_sts_corr_dropped_count, //                          .ctrl_ecc_sts_corr_dropped_count, Number of times correction command dropped; for devices supporting ping-pong PHY, results from two interfaces are concatenated as a double-width port - interface 0 at LSB, interface 1 at MSB
		output wire [34:0]   ctrl_ecc_sts_err_addr,           //                          .ctrl_ecc_sts_err_addr,           Address of the most recent SBE or DBE; for devices supporting ping-pong PHY, addresses from two interfaces are concatenated as a double-width port - interface 0 at LSB, interface 1 at MSB
		output wire [34:0]   ctrl_ecc_sts_corr_dropped_addr,  //                          .ctrl_ecc_sts_corr_dropped_addr,  Address of the most recent correction command dropped; for devices supporting ping-pong PHY, addresses from two interfaces are concatenated as a double-width port - interface 0 at LSB, interface 1 at MSB
