...
# ----------------------------------------
# If reset_bridge_dsp is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 linux 2025.11.21.14:06:11
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "reset_bridge_dsp.reset_bridge_dsp"
}
...
append ELAB_OPTIONS [subst [reset_bridge_dsp::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [reset_bridge_dsp::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [reset_bridge_dsp::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [reset_bridge_dsp::normalize_path "$file"]
  set normalized_dest [reset_bridge_dsp::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [reset_bridge_dsp::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [reset_bridge_dsp::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [reset_bridge_dsp::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [reset_bridge_dsp::get_design_files "$QSYS_SIMDIR"]]
