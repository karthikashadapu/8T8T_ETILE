...
# ----------------------------------------
# If ecpri_oran_top_mm_bridge_0 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 linux 2025.11.21.14:06:17
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ecpri_oran_top_mm_bridge_0.ecpri_oran_top_mm_bridge_0"
}
...
append ELAB_OPTIONS [subst [ecpri_oran_top_mm_bridge_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [ecpri_oran_top_mm_bridge_0::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [ecpri_oran_top_mm_bridge_0::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [ecpri_oran_top_mm_bridge_0::normalize_path "$file"]
  set normalized_dest [ecpri_oran_top_mm_bridge_0::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [ecpri_oran_top_mm_bridge_0::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [ecpri_oran_top_mm_bridge_0::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [ecpri_oran_top_mm_bridge_0::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [ecpri_oran_top_mm_bridge_0::get_design_files "$QSYS_SIMDIR"]]
