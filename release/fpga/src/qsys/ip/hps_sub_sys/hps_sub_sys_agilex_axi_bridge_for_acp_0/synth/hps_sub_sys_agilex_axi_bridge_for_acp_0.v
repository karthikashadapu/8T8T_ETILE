// hps_sub_sys_agilex_axi_bridge_for_acp_0.v
...
module hps_sub_sys_agilex_axi_bridge_for_acp_0 #(
	...
	agilex_axi_bridge_for_acp #(
		...
		.axm_m0_araddr   (axm_m0_araddr),                        //  output,   width = 37,        m0.araddr
		...
		.axm_m0_awaddr   (axm_m0_awaddr),                        //  output,   width = 37,          .awaddr
		...
		.axs_s0_araddr   (axs_s0_araddr),                        //   input,   width = 37,        s0.araddr
		...
		.axs_s0_awaddr   (axs_s0_awaddr),                        //   input,   width = 37,          .awaddr
