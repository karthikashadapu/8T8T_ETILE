...
// SystemVerilog created from duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale
...
module duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale (
