...
// SystemVerilog created from duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_im
...
module duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_im (
    ...
    reg [4:0] redist1_u1_rnd_add_BitSelect_for_a_tessel1_0_b_1_q;
    reg [0:0] redist2_u0_rnd_add_BitSelect_for_a_tessel1_1_b_1_q;
    reg [4:0] redist3_u0_rnd_add_BitSelect_for_a_tessel1_0_b_1_q;
    ...
    // u0_rnd_add_BitSelect_for_b_BitJoin_for_b_q_const(CONSTANT,129)
    ...
    // u1_rnd_add_BitSelect_for_a_tessel0_0(BITSELECT,73)@0
    assign u1_rnd_add_BitSelect_for_a_tessel0_0_b = $unsigned(u1_rnd_trunc_q[19:0]);

    // u1_rnd_add_BitSelect_for_a_BitJoin_for_b(BITJOIN,74)@0
    ...
    // u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const(CONSTANT,136)
    assign u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q = $unsigned(6'b000000);

    // u1_rnd_add_BitSelect_for_a_tessel1_1(BITSELECT,76)@0
    assign u1_rnd_add_BitSelect_for_a_tessel1_1_b = $unsigned(u1_rnd_trunc_q[24:24]);

    // redist0_u1_rnd_add_BitSelect_for_a_tessel1_1_b_1(DELAY,163)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u1_rnd_add_BitSelect_for_a_tessel1_0(BITSELECT,75)@0
    assign u1_rnd_add_BitSelect_for_a_tessel1_0_b = $unsigned(u1_rnd_trunc_q[24:20]);

    // redist1_u1_rnd_add_BitSelect_for_a_tessel1_0_b_1(DELAY,164)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u1_rnd_add_BitSelect_for_a_BitJoin_for_c(BITJOIN,77)@1
    ...
    // redist4_u1_rnd_add_p1_of_2_q_1(DELAY,167)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // redist2_u0_rnd_add_BitSelect_for_a_tessel1_1_b_1(DELAY,165)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // redist3_u0_rnd_add_BitSelect_for_a_tessel1_0_b_1(DELAY,166)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // redist5_u0_rnd_add_p1_of_2_q_1(DELAY,168)
    always @ (posedge clk)
    begin
        if (areset)
        begin
