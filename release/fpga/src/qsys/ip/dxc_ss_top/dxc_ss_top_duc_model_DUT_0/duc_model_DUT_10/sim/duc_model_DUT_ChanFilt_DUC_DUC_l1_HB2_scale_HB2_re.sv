...
// SystemVerilog created from duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_scale_HB2_re
...
module duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_scale_HB2_re (
    input wire [0:0] xIn_v,
    input wire [7:0] xIn_c,
    input wire [35:0] xIn_0,
    input wire [35:0] xIn_1,
    input wire [35:0] xIn_2,
    input wire [35:0] xIn_3,
    ...
    wire [5:0] u2_rnd_add_p2_of_2_a;
    wire [5:0] u2_rnd_add_p2_of_2_b;
    logic [5:0] u2_rnd_add_p2_of_2_o;
    wire [0:0] u2_rnd_add_p2_of_2_cin;
    wire [3:0] u2_rnd_add_p2_of_2_q;
    ...
    wire [5:0] u3_rnd_add_p2_of_2_a;
    wire [5:0] u3_rnd_add_p2_of_2_b;
    logic [5:0] u3_rnd_add_p2_of_2_o;
    wire [0:0] u3_rnd_add_p2_of_2_cin;
    wire [3:0] u3_rnd_add_p2_of_2_q;
    ...
    reg [2:0] redist1_u3_rnd_add_BitSelect_for_a_tessel1_0_b_1_q;
    reg [0:0] redist2_u2_rnd_add_BitSelect_for_a_tessel1_1_b_1_q;
    reg [2:0] redist3_u2_rnd_add_BitSelect_for_a_tessel1_0_b_1_q;
    reg [0:0] redist4_u1_rnd_add_BitSelect_for_a_tessel1_1_b_1_q;
    reg [2:0] redist5_u1_rnd_add_BitSelect_for_a_tessel1_0_b_1_q;
    reg [0:0] redist6_u0_rnd_add_BitSelect_for_a_tessel1_1_b_1_q;
    reg [2:0] redist7_u0_rnd_add_BitSelect_for_a_tessel1_0_b_1_q;
    ...
    wire [36:0] u2_shiftsel_q;
    wire [36:0] u2_shiftsel_qint;
    wire [36:0] u3_shiftsel_q;
    wire [36:0] u3_shiftsel_qint;
    wire [23:0] u0_rnd_add_BitJoin_for_q_q;
    wire [23:0] u1_rnd_add_BitJoin_for_q_q;
    wire [23:0] u2_rnd_add_BitJoin_for_q_q;
    wire [23:0] u3_rnd_add_BitJoin_for_q_q;
    wire [3:0] u3_rnd_add_BitSelect_for_a_BitJoin_for_c_q;
    wire [3:0] u2_rnd_add_BitSelect_for_a_BitJoin_for_c_q;
    ...
    wire [22:0] u2_rnd_trunc_q;
    wire [36:0] u2_rnd_trunc_qint;
    wire [22:0] u3_rnd_trunc_q;
    wire [36:0] u3_rnd_trunc_qint;
    wire [22:0] u0_rnd_shift_q;
    wire [23:0] u0_rnd_shift_qint;
    wire [22:0] u1_rnd_shift_q;
    wire [23:0] u1_rnd_shift_qint;
    wire [22:0] u2_rnd_shift_q;
    wire [23:0] u2_rnd_shift_qint;
    wire [22:0] u3_rnd_shift_q;
    wire [23:0] u3_rnd_shift_qint;
    ...
    // u0_rnd_add_BitSelect_for_b_BitJoin_for_b_q_const(CONSTANT,227)
    ...
    assign u3_shiftsel_q = u3_shiftsel_qint[36:0];

    // u3_rnd_trunc(BITSHIFT,29)@0
    assign u3_rnd_trunc_qint = u3_shiftsel_q;
    assign u3_rnd_trunc_q = u3_rnd_trunc_qint[36:14];

    // u3_rnd_add_BitSelect_for_a_tessel0_0(BITSELECT,167)@0
    assign u3_rnd_add_BitSelect_for_a_tessel0_0_b = $unsigned(u3_rnd_trunc_q[19:0]);

    // u3_rnd_add_BitSelect_for_a_BitJoin_for_b(BITJOIN,168)@0
    ...
    // u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const(CONSTANT,232)
    assign u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q = $unsigned(4'b0000);

    // u3_rnd_add_BitSelect_for_a_tessel1_1(BITSELECT,170)@0
    assign u3_rnd_add_BitSelect_for_a_tessel1_1_b = $unsigned(u3_rnd_trunc_q[22:22]);

    // redist0_u3_rnd_add_BitSelect_for_a_tessel1_1_b_1(DELAY,305)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u3_rnd_add_BitSelect_for_a_tessel1_0(BITSELECT,169)@0
    assign u3_rnd_add_BitSelect_for_a_tessel1_0_b = $unsigned(u3_rnd_trunc_q[22:20]);

    // redist1_u3_rnd_add_BitSelect_for_a_tessel1_0_b_1(DELAY,306)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u3_rnd_add_BitSelect_for_a_BitJoin_for_c(BITJOIN,171)@1
    ...
    assign u3_rnd_add_p2_of_2_a = $unsigned({ {{1{u3_rnd_add_BitSelect_for_a_BitJoin_for_c_q[3]}}, u3_rnd_add_BitSelect_for_a_BitJoin_for_c_q}, 1'b1 });
    assign u3_rnd_add_p2_of_2_b = $unsigned({ {{1{u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q[3]}}, u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q}, u3_rnd_add_p2_of_2_cin[0] });
    always @ (posedge clk)
    begin
        if (areset)
        begin
            u3_rnd_add_p2_of_2_o <= 6'b0;
        end
        else
        begin
    ...
    assign u3_rnd_add_p2_of_2_q = u3_rnd_add_p2_of_2_o[4:1];

    // redist8_u3_rnd_add_p1_of_2_q_1(DELAY,313)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    assign u3_rnd_shift_q = u3_rnd_shift_qint[23:1];

    // u2_shiftsel(BITSHIFT,8)@0
    assign u2_shiftsel_qint = { xIn_2, 1'b0 };
    assign u2_shiftsel_q = u2_shiftsel_qint[36:0];

    // u2_rnd_trunc(BITSHIFT,24)@0
    assign u2_rnd_trunc_qint = u2_shiftsel_q;
    assign u2_rnd_trunc_q = u2_rnd_trunc_qint[36:14];

    // u2_rnd_add_BitSelect_for_a_tessel0_0(BITSELECT,137)@0
    assign u2_rnd_add_BitSelect_for_a_tessel0_0_b = $unsigned(u2_rnd_trunc_q[19:0]);

    // u2_rnd_add_BitSelect_for_a_BitJoin_for_b(BITJOIN,138)@0
    ...
    // u2_rnd_add_BitSelect_for_a_tessel1_1(BITSELECT,140)@0
    assign u2_rnd_add_BitSelect_for_a_tessel1_1_b = $unsigned(u2_rnd_trunc_q[22:22]);

    // redist2_u2_rnd_add_BitSelect_for_a_tessel1_1_b_1(DELAY,307)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u2_rnd_add_BitSelect_for_a_tessel1_0(BITSELECT,139)@0
    assign u2_rnd_add_BitSelect_for_a_tessel1_0_b = $unsigned(u2_rnd_trunc_q[22:20]);

    // redist3_u2_rnd_add_BitSelect_for_a_tessel1_0_b_1(DELAY,308)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u2_rnd_add_BitSelect_for_a_BitJoin_for_c(BITJOIN,141)@1
    ...
    assign u2_rnd_add_p2_of_2_a = $unsigned({ {{1{u2_rnd_add_BitSelect_for_a_BitJoin_for_c_q[3]}}, u2_rnd_add_BitSelect_for_a_BitJoin_for_c_q}, 1'b1 });
    assign u2_rnd_add_p2_of_2_b = $unsigned({ {{1{u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q[3]}}, u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q}, u2_rnd_add_p2_of_2_cin[0] });
    always @ (posedge clk)
    begin
        if (areset)
        begin
            u2_rnd_add_p2_of_2_o <= 6'b0;
        end
        else
        begin
    ...
    assign u2_rnd_add_p2_of_2_q = u2_rnd_add_p2_of_2_o[4:1];

    // redist9_u2_rnd_add_p1_of_2_q_1(DELAY,314)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    assign u2_rnd_shift_q = u2_rnd_shift_qint[23:1];
    ...
    // u1_rnd_add_BitSelect_for_a_tessel0_0(BITSELECT,107)@0
    assign u1_rnd_add_BitSelect_for_a_tessel0_0_b = $unsigned(u1_rnd_trunc_q[19:0]);

    // u1_rnd_add_BitSelect_for_a_BitJoin_for_b(BITJOIN,108)@0
    ...
    // u1_rnd_add_BitSelect_for_a_tessel1_1(BITSELECT,110)@0
    assign u1_rnd_add_BitSelect_for_a_tessel1_1_b = $unsigned(u1_rnd_trunc_q[22:22]);

    // redist4_u1_rnd_add_BitSelect_for_a_tessel1_1_b_1(DELAY,309)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u1_rnd_add_BitSelect_for_a_tessel1_0(BITSELECT,109)@0
    assign u1_rnd_add_BitSelect_for_a_tessel1_0_b = $unsigned(u1_rnd_trunc_q[22:20]);

    // redist5_u1_rnd_add_BitSelect_for_a_tessel1_0_b_1(DELAY,310)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u1_rnd_add_BitSelect_for_a_BitJoin_for_c(BITJOIN,111)@1
    ...
    // redist10_u1_rnd_add_p1_of_2_q_1(DELAY,315)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // redist6_u0_rnd_add_BitSelect_for_a_tessel1_1_b_1(DELAY,311)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // redist7_u0_rnd_add_BitSelect_for_a_tessel1_0_b_1(DELAY,312)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // redist11_u0_rnd_add_p1_of_2_q_1(DELAY,316)
    always @ (posedge clk)
    begin
        if (areset)
        begin
