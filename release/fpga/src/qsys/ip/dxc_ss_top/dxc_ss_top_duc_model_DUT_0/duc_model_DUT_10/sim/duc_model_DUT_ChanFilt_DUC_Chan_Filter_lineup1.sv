...
// SystemVerilog created from duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1
...
module duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1 (
    ...
    input wire [7:0] in_4_Config_CC1_tpl,
    ...
    wire [15:0] Filter_Reconfig_cunroll_x_out_1_imag_Out1_tpl;
    wire [15:0] Filter_Reconfig_cunroll_x_out_1_real_Out1_tpl;
    ...
    duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Filter_Reconfig theFilter_Reconfig_cunroll_x (
        .in_1_imag_In1_tpl(in_1_imag_d_tpl),
        .in_1_real_In1_tpl(in_1_real_d_tpl),
        .in_2_In3_tpl(in_2_v_tpl),
        .in_3_In6_tpl(in_3_c_tpl),
        .in_4_BW_CC1_tpl(in_4_Config_CC1_tpl),
        .out_1_imag_Out1_tpl(Filter_Reconfig_cunroll_x_out_1_imag_Out1_tpl),
        .out_1_real_Out1_tpl(Filter_Reconfig_cunroll_x_out_1_real_Out1_tpl),
    ...
    duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter theChan_Filter_cunroll_x (
        .busIn_writedata(busIn_writedata),
        .busIn_address(busIn_address),
        .busIn_write(busIn_write),
        .busIn_read(busIn_read),
        .in_1_imag_din_tpl(Filter_Reconfig_cunroll_x_out_1_imag_Out1_tpl),
        .in_1_real_din_tpl(Filter_Reconfig_cunroll_x_out_1_real_Out1_tpl),
        .in_2_vin_tpl(Filter_Reconfig_cunroll_x_out_2_Out4_tpl),
        .in_3_chin_tpl(Filter_Reconfig_cunroll_x_out_3_Out6_tpl),
        .in_4_CoefBank_tpl(Filter_Reconfig_cunroll_x_out_4_CoefBankSel_tpl),
