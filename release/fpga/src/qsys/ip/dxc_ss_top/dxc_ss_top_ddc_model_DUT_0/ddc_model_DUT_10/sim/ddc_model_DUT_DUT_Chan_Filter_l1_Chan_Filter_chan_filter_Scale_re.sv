...
// SystemVerilog created from ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scale_re
...
module ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scale_re (
    input wire [0:0] xIn_v,
    input wire [7:0] xIn_c,
    input wire [40:0] xIn_0,
    ...
    wire [9:0] u0_rnd_add_p2_of_2_a;
    wire [9:0] u0_rnd_add_p2_of_2_b;
    logic [9:0] u0_rnd_add_p2_of_2_o;
    wire [0:0] u0_rnd_add_p2_of_2_cin;
    wire [7:0] u0_rnd_add_p2_of_2_q;
    wire [19:0] u0_rnd_add_BitSelect_for_b_BitJoin_for_b_q_const_q;
    wire [7:0] u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q;
    reg [0:0] redist0_u0_rnd_add_BitSelect_for_a_tessel1_1_b_1_q;
    reg [6:0] redist1_u0_rnd_add_BitSelect_for_a_tessel1_0_b_1_q;
    ...
    wire [40:0] u0_shiftsel_q;
    wire [40:0] u0_shiftsel_qint;
    wire [27:0] u0_rnd_add_BitJoin_for_q_q;
    wire [7:0] u0_rnd_add_BitSelect_for_a_BitJoin_for_c_q;
    wire [26:0] u0_rnd_trunc_q;
    wire [40:0] u0_rnd_trunc_qint;
    wire [26:0] u0_rnd_shift_q;
    wire [27:0] u0_rnd_shift_qint;
    wire [19:0] u0_rnd_add_BitSelect_for_a_tessel0_0_b;
    wire [6:0] u0_rnd_add_BitSelect_for_a_tessel1_0_b;
    ...
    // u0_rnd_add_BitSelect_for_b_BitJoin_for_b_q_const(CONSTANT,78)
    ...
    assign u0_shiftsel_q = u0_shiftsel_qint[40:0];

    // u0_rnd_trunc(BITSHIFT,8)@0
    assign u0_rnd_trunc_qint = u0_shiftsel_q;
    assign u0_rnd_trunc_q = u0_rnd_trunc_qint[40:14];
    ...
    // u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const(CONSTANT,87)
    assign u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q = $unsigned(8'b00000000);

    // u0_rnd_add_BitSelect_for_a_tessel1_1(BITSELECT,26)@0
    assign u0_rnd_add_BitSelect_for_a_tessel1_1_b = $unsigned(u0_rnd_trunc_q[26:26]);

    // redist0_u0_rnd_add_BitSelect_for_a_tessel1_1_b_1(DELAY,88)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    assign u0_rnd_add_BitSelect_for_a_tessel1_0_b = $unsigned(u0_rnd_trunc_q[26:20]);

    // redist1_u0_rnd_add_BitSelect_for_a_tessel1_0_b_1(DELAY,89)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    assign u0_rnd_add_p2_of_2_a = $unsigned({ {{1{u0_rnd_add_BitSelect_for_a_BitJoin_for_c_q[7]}}, u0_rnd_add_BitSelect_for_a_BitJoin_for_c_q}, 1'b1 });
    assign u0_rnd_add_p2_of_2_b = $unsigned({ {{1{u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q[7]}}, u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q}, u0_rnd_add_p2_of_2_cin[0] });
    always @ (posedge clk)
    begin
        if (areset)
        begin
            u0_rnd_add_p2_of_2_o <= 10'b0;
        end
        else
        begin
    ...
    assign u0_rnd_add_p2_of_2_q = u0_rnd_add_p2_of_2_o[8:1];

    // redist2_u0_rnd_add_p1_of_2_q_1(DELAY,90)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    assign u0_rnd_shift_q = u0_rnd_shift_qint[27:1];

    // redist4_xIn_c_2(DELAY,92)
    always @ (posedge clk)
    begin
        if (areset)
        begin
