...
// SystemVerilog created from ddc_model_DUT_DUT_DDC_l1_x_HB2
...
module ddc_model_DUT_DUT_DDC_l1_x_HB2 (
    ...
    wire [0:0] GND_q;
    wire [36:0] HB2_im_xOut_0;
    wire [36:0] HB2_im_xOut_1;
    wire [0:0] HB2_im_xOut_v;
    wire [7:0] HB2_im_xOut_c;
    wire [36:0] HB2_re_xOut_0;
    wire [36:0] HB2_re_xOut_1;
    ...
    // HB2_im(BLACKBOX,2)
    ddc_model_DUT_DUT_DDC_l1_x_HB2_HB2_im theHB2_im (
    ...
    ddc_model_DUT_DUT_DDC_l1_x_HB2_scale_HB2_im thescale_HB2_im (
        .xIn_0(HB2_im_xOut_0),
        .xIn_1(HB2_im_xOut_1),
        .xIn_v(HB2_im_xOut_v),
        .xIn_c(HB2_im_xOut_c),
    ...
    // HB2_re(BLACKBOX,3)
    ddc_model_DUT_DUT_DDC_l1_x_HB2_HB2_re theHB2_re (
    ...
    ddc_model_DUT_DUT_DDC_l1_x_HB2_scale_HB2_re thescale_HB2_re (
        .xIn_0(HB2_re_xOut_0),
        .xIn_1(HB2_re_xOut_1),
        .xIn_v(HB2_re_xOut_v),
        .xIn_c(HB2_re_xOut_c),
