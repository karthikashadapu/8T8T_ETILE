...
# ----------------------------------------
# If clk_bridge_csr is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 linux 2025.11.21.14:06:02
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clk_bridge_csr.clk_bridge_csr"
}
...
append ELAB_OPTIONS [subst [clk_bridge_csr::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [clk_bridge_csr::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [clk_bridge_csr::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [clk_bridge_csr::normalize_path "$file"]
  set normalized_dest [clk_bridge_csr::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [clk_bridge_csr::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [clk_bridge_csr::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [clk_bridge_csr::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [clk_bridge_csr::get_design_files "$QSYS_SIMDIR"]]
