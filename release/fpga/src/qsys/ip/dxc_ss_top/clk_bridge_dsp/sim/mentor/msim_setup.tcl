...
# ----------------------------------------
# If clk_bridge_dsp is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 linux 2025.11.21.14:05:54
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clk_bridge_dsp.clk_bridge_dsp"
}
...
append ELAB_OPTIONS [subst [clk_bridge_dsp::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [clk_bridge_dsp::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [clk_bridge_dsp::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [clk_bridge_dsp::normalize_path "$file"]
  set normalized_dest [clk_bridge_dsp::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [clk_bridge_dsp::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [clk_bridge_dsp::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [clk_bridge_dsp::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [clk_bridge_dsp::get_design_files "$QSYS_SIMDIR"]]
