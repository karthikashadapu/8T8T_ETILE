	component tx_dma_read_master is
		generic (
		...
		port (
			...
			src_empty            : out std_logic_vector(3 downto 0);                      -- empty
	...
	end component tx_dma_read_master;

	u0 : component tx_dma_read_master
		generic map (
		...
		port map (
			...
			src_sop              => CONNECTED_TO_src_sop,              --                 .startofpacket
			src_eop              => CONNECTED_TO_src_eop,              --                 .endofpacket
