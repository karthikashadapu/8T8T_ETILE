	tx_dma_read_master #(
		...
		.master_address       (_connected_to_master_address_),       //  output,   width = 37, Data_Read_Master.address
		...
		.master_readdata      (_connected_to_master_readdata_),      //   input,  width = 128,                 .readdata
		...
		.src_data             (_connected_to_src_data_),             //  output,  width = 128,      Data_Source.data
		.src_valid            (_connected_to_src_valid_),            //  output,    width = 1,                 .valid
		.src_ready            (_connected_to_src_ready_),            //   input,    width = 1,                 .ready
		.src_sop              (_connected_to_src_sop_),              //  output,    width = 1,                 .startofpacket
		.src_eop              (_connected_to_src_eop_),              //  output,    width = 1,                 .endofpacket
		.src_empty            (_connected_to_src_empty_),            //  output,    width = 4,                 .empty
