   ...
   return $result
      ...
      set j204c_txphy_clk_lsrc [lsearch -exact $jesd204_clock_target_list j204c_txphy_clk]
		...
		if {$j204c_pll_refclk_ext && $j204c_pll_refclk_lsrc == -1} {
			create_clock -name "j204c_pll_refclk"   -period 	4.069ns 			[get_ports j204c_pll_refclk]
		}
		...
		if {$j204c_txlink_clk_ext && $j204c_txlink_clk_lsrc == -1} {
			create_clock -name "j204c_txlink_clk"   -period 	16.276ns 			[get_ports j204c_txlink_clk]
		}
		...
		if {$j204c_rxlink_clk_ext && $j204c_rxlink_clk_lsrc == -1} {
			create_clock -name "j204c_rxlink_clk"   -period 	16.276ns      		[get_ports j204c_rxlink_clk]
		}
		if {$j204c_rx_avs_clk_ext && $j204c_rx_avs_clk_lsrc == -1} {
			...
			if {$j204c_txframe_clk_ext && $j204c_txframe_clk_lsrc == -1} {
				create_clock -name "j204c_txframe_clk" -period	8.138ns 	[get_ports j204c_txframe_clk]
			}
			if {$j204c_rxframe_clk_ext && $j204c_rxframe_clk_lsrc == -1} {
				create_clock -name "j204c_rxframe_clk"  -period 8.138ns     [get_ports j204c_rxframe_clk]
			}
