	component rx_dma_write_master is
		generic (
			DATA_WIDTH                     : integer := 128;
			LENGTH_WIDTH                   : integer := 14;
			FIFO_DEPTH                     : integer := 256;
			STRIDE_ENABLE                  : integer := 0;
			BURST_ENABLE                   : integer := 1;
			WRITE_RESPONSE_ENABLE          : integer := 1;
			PACKET_ENABLE                  : integer := 1;
			ERROR_ENABLE                   : integer := 1;
			ERROR_WIDTH                    : integer := 6;
			BYTE_ENABLE_WIDTH              : integer := 16;
			BYTE_ENABLE_WIDTH_LOG2         : integer := 4;
			NO_BYTEENABLES                 : integer := 0;
			ADDRESS_WIDTH                  : integer := 37;
			FIFO_DEPTH_LOG2                : integer := 8;
			SYMBOL_WIDTH                   : integer := 8;
			NUMBER_OF_SYMBOLS              : integer := 16;
			NUMBER_OF_SYMBOLS_LOG2         : integer := 4;
			MAX_BURST_COUNT_WIDTH          : integer := 5;
			UNALIGNED_ACCESSES_ENABLE      : integer := 1;
			ONLY_FULL_ACCESS_ENABLE        : integer := 0;
			BURST_WRAPPING_SUPPORT         : integer := 1;
			PROGRAMMABLE_BURST_ENABLE      : integer := 0;
			MAX_BURST_COUNT                : integer := 16;
			FIFO_SPEED_OPTIMIZATION        : integer := 1;
			STRIDE_WIDTH                   : integer := 1;
			ACTUAL_BYTES_TRANSFERRED_WIDTH : integer := 15
		);
		port (
			clk                       : in  std_logic                      := 'X';             -- clk
			reset                     : in  std_logic                      := 'X';             -- reset
			master_address            : out std_logic_vector(36 downto 0);                     -- address
			master_write              : out std_logic;                                         -- write
			master_byteenable         : out std_logic_vector(15 downto 0);                     -- byteenable
			master_writedata          : out std_logic_vector(127 downto 0);                    -- writedata
			...
			snk_data                  : in  std_logic_vector(127 downto 0) := (others => 'X'); -- data
			...
			snk_empty                 : in  std_logic_vector(3 downto 0)   := (others => 'X'); -- empty
	...
	end component rx_dma_write_master;

	u0 : component rx_dma_write_master
		generic map (
		...
		port map (
			...
			master_response           => CONNECTED_TO_master_response,           --                  .response
			master_writeresponsevalid => CONNECTED_TO_master_writeresponsevalid, --                  .writeresponsevalid
			...
			snk_sop                   => CONNECTED_TO_snk_sop,                   --                  .startofpacket
			snk_eop                   => CONNECTED_TO_snk_eop,                   --                  .endofpacket
			snk_empty                 => CONNECTED_TO_snk_empty,                 --                  .empty
			snk_error                 => CONNECTED_TO_snk_error,                 --                  .error
