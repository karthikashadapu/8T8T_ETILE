	rx_dma_write_master #(
		...
		.master_address            (_connected_to_master_address_),            //  output,   width = 37, Data_Write_Master.address
		.master_write              (_connected_to_master_write_),              //  output,    width = 1,                  .write
		.master_byteenable         (_connected_to_master_byteenable_),         //  output,   width = 16,                  .byteenable
		.master_writedata          (_connected_to_master_writedata_),          //  output,  width = 128,                  .writedata
		.master_waitrequest        (_connected_to_master_waitrequest_),        //   input,    width = 1,                  .waitrequest
		.master_burstcount         (_connected_to_master_burstcount_),         //  output,    width = 5,                  .burstcount
		...
		.snk_data                  (_connected_to_snk_data_),                  //   input,  width = 128,         Data_Sink.data
		.snk_valid                 (_connected_to_snk_valid_),                 //   input,    width = 1,                  .valid
		.snk_ready                 (_connected_to_snk_ready_),                 //  output,    width = 1,                  .ready
		.snk_sop                   (_connected_to_snk_sop_),                   //   input,    width = 1,                  .startofpacket
		.snk_eop                   (_connected_to_snk_eop_),                   //   input,    width = 1,                  .endofpacket
		.snk_empty                 (_connected_to_snk_empty_),                 //   input,    width = 4,                  .empty
		.snk_error                 (_connected_to_snk_error_),                 //   input,    width = 6,                  .error
