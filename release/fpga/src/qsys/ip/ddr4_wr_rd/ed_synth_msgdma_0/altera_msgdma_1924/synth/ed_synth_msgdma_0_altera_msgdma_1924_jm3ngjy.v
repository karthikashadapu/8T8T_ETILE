// ed_synth_msgdma_0_altera_msgdma_1924_jm3ngjy.v
...
`timescale 1 ps / 1 ps
module ed_synth_msgdma_0_altera_msgdma_1924_jm3ngjy (
	...
	dispatcher #(
		...
		.DATA_FIFO_DEPTH_DERIVED       (4),
		.MAX_BYTE_DERIVED              (20),
		.TRANSFER_TYPE_DERIVED         (1),
		.BURST_ENABLE                  (1),
		.MAX_BURST_COUNT_DERIVED       (5),
		...
		.PACKET_ENABLE                 (0),
		.DESCRIPTOR_FIFO_DEPTH_DERIVED (5)
	) dispatcher_internal (
	...
	write_master #(
		...
		.master_burstcount         (mm_write_burstcount),                            //  output,    width = 7,                  .burstcount
