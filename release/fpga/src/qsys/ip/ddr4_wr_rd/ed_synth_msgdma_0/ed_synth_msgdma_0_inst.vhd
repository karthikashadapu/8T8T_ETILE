	component ed_synth_msgdma_0 is
		port (
			...
			mm_write_burstcount          : out std_logic_vector(6 downto 0);                      -- burstcount
	...
	end component ed_synth_msgdma_0;

	u0 : component ed_synth_msgdma_0
		port map (
