	ddr4_wr_rd_address_span_extender_2 #(
		...
		.avs_s0_address       (_connected_to_avs_s0_address_),       //   input,   width = 21,  windowed_slave.address
		...
		.avs_s0_burstcount    (_connected_to_avs_s0_burstcount_),    //   input,    width = 7,                .burstcount
		.avm_m0_address       (_connected_to_avm_m0_address_),       //  output,   width = 32, expanded_master.address
		...
		.avm_m0_burstcount    (_connected_to_avm_m0_burstcount_),    //  output,    width = 7,                .burstcount
