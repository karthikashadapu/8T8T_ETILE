// ddr4_wr_rd_address_span_extender_2.v
...
module ddr4_wr_rd_address_span_extender_2 #(
	...
	ddr4_wr_rd_address_span_extender_2_altera_address_span_extender_1920_eieo4qq #(
		.DATA_WIDTH           (128),
		.BYTEENABLE_WIDTH     (16),
		...
		.avs_s0_address       (avs_s0_address),       //   input,   width = 21,  windowed_slave.address
		...
		.avs_s0_burstcount    (avs_s0_burstcount),    //   input,    width = 7,                .burstcount
		.avm_m0_address       (avm_m0_address),       //  output,   width = 32, expanded_master.address
		...
		.avm_m0_burstcount    (avm_m0_burstcount),    //  output,    width = 7,                .burstcount
