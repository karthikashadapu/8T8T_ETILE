module ddr4_wr_rd_address_span_extender_2 #(
		parameter SYNC_RESET = 0
	) (
		input  wire         clk,                  //           clock.clk
		input  wire         reset,                //           reset.reset
		input  wire [20:0]  avs_s0_address,       //  windowed_slave.address
		...
		input  wire [6:0]   avs_s0_burstcount,    //                .burstcount
		output wire [31:0]  avm_m0_address,       // expanded_master.address
		...
		output wire [6:0]   avm_m0_burstcount,    //                .burstcount
