...
# ----------------------------------------
# If phipps_peak_h2f_lw_bridge is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 linux 2025.11.21.14:05:27
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "phipps_peak_h2f_lw_bridge.phipps_peak_h2f_lw_bridge"
}
...
append ELAB_OPTIONS [subst [phipps_peak_h2f_lw_bridge::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [phipps_peak_h2f_lw_bridge::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [phipps_peak_h2f_lw_bridge::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [phipps_peak_h2f_lw_bridge::normalize_path "$file"]
  set normalized_dest [phipps_peak_h2f_lw_bridge::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [phipps_peak_h2f_lw_bridge::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [phipps_peak_h2f_lw_bridge::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [phipps_peak_h2f_lw_bridge::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [phipps_peak_h2f_lw_bridge::get_design_files "$QSYS_SIMDIR"]]
