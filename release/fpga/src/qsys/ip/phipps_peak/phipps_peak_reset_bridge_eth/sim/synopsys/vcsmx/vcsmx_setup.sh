...
TOP_LEVEL_NAME="phipps_peak_reset_bridge_eth.phipps_peak_reset_bridge_eth"
QSYS_SIMDIR="./../../"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [phipps_peak_reset_bridge_eth::get_elab_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [phipps_peak_reset_bridge_eth::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [phipps_peak_reset_bridge_eth::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
