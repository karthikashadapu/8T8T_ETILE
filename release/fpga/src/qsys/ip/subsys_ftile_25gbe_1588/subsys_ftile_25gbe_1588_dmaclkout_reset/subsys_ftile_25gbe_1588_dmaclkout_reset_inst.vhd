	component subsys_ftile_25gbe_1588_dmaclkout_reset is
		port (
			clk         : in  std_logic := 'X'; -- clk
			in_reset_n  : in  std_logic := 'X'; -- reset_n
			out_reset_n : out std_logic         -- reset_n
		);
	end component subsys_ftile_25gbe_1588_dmaclkout_reset;

	u0 : component subsys_ftile_25gbe_1588_dmaclkout_reset
		port map (
