...
# ----------------------------------------
# If lphy_ss_reset_xran_dl is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 linux 2025.11.21.14:06:49
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "lphy_ss_reset_xran_dl.lphy_ss_reset_xran_dl"
}
...
append ELAB_OPTIONS [subst [lphy_ss_reset_xran_dl::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [lphy_ss_reset_xran_dl::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [lphy_ss_reset_xran_dl::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [lphy_ss_reset_xran_dl::normalize_path "$file"]
  set normalized_dest [lphy_ss_reset_xran_dl::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [lphy_ss_reset_xran_dl::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [lphy_ss_reset_xran_dl::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [lphy_ss_reset_xran_dl::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [lphy_ss_reset_xran_dl::get_design_files "$QSYS_SIMDIR"]]
