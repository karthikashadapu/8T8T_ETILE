...
// SystemVerilog created from LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMATION1_Stage1_Filt_DEC_by_3_stage1_Scale1
...
module LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMA0000C_by_3_stage1_Scale1 (
    ...
    reg [23:0] redist0_u0_rnd_shift_q_1_q;
    ...
    wire [23:0] u0_rnd_trunc_q;
    wire [36:0] u0_rnd_trunc_qint;
    wire [24:0] u0_rnd_add_a;
    wire [24:0] u0_rnd_add_b;
    logic [24:0] u0_rnd_add_o;
    wire [24:0] u0_rnd_add_q;
    wire [23:0] u0_rnd_shift_q;
    wire [24:0] u0_rnd_shift_qint;
    ...
    assign u0_rnd_trunc_q = u0_rnd_trunc_qint[36:13];

    // u0_rnd_add(ADD,14)@0
    assign u0_rnd_add_a = $unsigned({{1{u0_rnd_trunc_q[23]}}, u0_rnd_trunc_q});
    assign u0_rnd_add_b = $unsigned({{23{u0_rnd_bias_q[1]}}, u0_rnd_bias_q});
    assign u0_rnd_add_o = $unsigned($signed(u0_rnd_add_a) + $signed(u0_rnd_add_b));
    assign u0_rnd_add_q = u0_rnd_add_o[24:0];

    // u0_rnd_shift(BITSHIFT,15)@0
    assign u0_rnd_shift_qint = u0_rnd_add_q;
    assign u0_rnd_shift_q = u0_rnd_shift_qint[24:1];
    ...
    // u0_high(COMPARE,9)@1
    assign u0_high_a = $unsigned({{10{u0_highconst_q[15]}}, u0_highconst_q});
    assign u0_high_b = $unsigned({{2{redist0_u0_rnd_shift_q_1_q[23]}}, redist0_u0_rnd_shift_q_1_q});
    ...
    // u0_low(COMPARE,8)@1
    assign u0_low_a = $unsigned({{2{redist0_u0_rnd_shift_q_1_q[23]}}, redist0_u0_rnd_shift_q_1_q});
    assign u0_low_b = $unsigned({{10{u0_lowconst_q[15]}}, u0_lowconst_q});
