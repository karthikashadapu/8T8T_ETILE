...
// SystemVerilog created from LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMATION1_Stage5_Filt_DEC_by_2_stage5_DecimatingFIR1
...
module LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMA0000tage5_DecimatingFIR1 (
    ...
    reg [6:0] u0_m0_wo0_wi0_r0_ra0_count1_lutreg_q;
    wire [2:0] u0_m0_wo0_wi0_r0_ra0_count1_inner_q;
    (* preserve_syn_only *) reg signed [2:0] u0_m0_wo0_wi0_r0_ra0_count1_inner_i;
    wire [5:0] u0_m0_wo0_wi0_r0_ra0_count1_q;
    (* preserve_syn_only *) reg [5:0] u0_m0_wo0_wi0_r0_ra0_count1_i;
    (* preserve_syn_only *) reg u0_m0_wo0_wi0_r0_ra0_count1_eq;
    wire [7:0] u0_m0_wo0_wi0_r0_ra0_add_0_0_a;
    wire [7:0] u0_m0_wo0_wi0_r0_ra0_add_0_0_b;
    logic [7:0] u0_m0_wo0_wi0_r0_ra0_add_0_0_o;
    wire [7:0] u0_m0_wo0_wi0_r0_ra0_add_0_0_q;
    ...
    reg [6:0] u0_m0_wo0_wi0_r0_ra0_count1_lut_q;
    ...
    // d_in0_m0_wi0_wo0_assign_id1_q_11(DELAY,55)@10 + 1
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                begin
                    u0_m0_wo0_run_enable_c = $signed(u0_m0_wo0_run_enable_c) - $signed(-7'd35);
                end
                else
                begin
    ...
    // d_u0_m0_wo0_memread_q_14(DELAY,57)@13 + 1
    always @ (posedge clk)
    begin
        if (0)
        begin
    ...
    begin
        ...
        begin
            u0_m0_wo0_compute_delay_0 <= $unsigned(d_u0_m0_wo0_memread_q_14_q);
            u0_m0_wo0_compute_delay_1 <= u0_m0_wo0_compute_delay_0;
            u0_m0_wo0_compute_q <= u0_m0_wo0_compute_delay_1;
        end
    end

    // d_u0_m0_wo0_compute_q_18(DELAY,58)@14 + 4
    always @ (posedge clk)
    begin
        if (0)
        begin
        ...
        begin
            ...
            d_u0_m0_wo0_compute_q_18_q <= d_u0_m0_wo0_compute_q_18_delay_2;
        end
    end

    // d_u0_m0_wo0_compute_q_19(DELAY,59)@18 + 1
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u0_m0_wo0_aseq(SEQUENCE,42)@19 + 1
    always @ (posedge clk)
    begin
        ...
        begin
            ...
            begin
                ...
                begin
                    u0_m0_wo0_aseq_c = $signed(u0_m0_wo0_aseq_c) + $signed(8'd35);
                end
                else
                begin
    ...
    // d_u0_m0_wo0_compute_q_20(DELAY,60)@19 + 1
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u0_m0_wo0_ca0_inner(COUNTER,33)@14
    ...
    begin
        ...
        begin
            ...
            begin
                u0_m0_wo0_ca0_i <= $unsigned(u0_m0_wo0_ca0_i) + $unsigned(4'd8);
            end
            else
            begin
    ...
    // u0_m0_wo0_wi0_r0_ra0_count1_inner(COUNTER,24)@13
    ...
    begin
        ...
        begin
            ...
            begin
                u0_m0_wo0_wi0_r0_ra0_count1_i <= $unsigned(u0_m0_wo0_wi0_r0_ra0_count1_i) + $unsigned(6'd20);
            end
            else
            begin
                u0_m0_wo0_wi0_r0_ra0_count1_i <= $unsigned(u0_m0_wo0_wi0_r0_ra0_count1_i) + $unsigned(6'd1);
            end
        end
    end
    assign u0_m0_wo0_wi0_r0_ra0_count1_q = u0_m0_wo0_wi0_r0_ra0_count1_i[5:0];
    ...
    begin
        ...
        unique case (u0_m0_wo0_wi0_r0_ra0_count1_q)
            6'b000000 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0000000;
            6'b000001 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0000100;
            6'b000010 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0001000;
            6'b000011 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0001100;
            6'b000100 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0010000;
            6'b000101 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0010100;
            6'b000110 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0011000;
            6'b000111 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0011100;
            6'b001000 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0100000;
            6'b001001 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0001000;
            6'b001010 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0001100;
            6'b001011 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0010000;
            6'b001100 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0010100;
            6'b001101 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0011000;
            6'b001110 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0011100;
            6'b001111 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0100000;
            6'b010000 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0100100;
            6'b010001 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0000000;
            6'b010010 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0010000;
            6'b010011 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0010100;
            6'b010100 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0011000;
            6'b010101 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0011100;
            6'b010110 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0100000;
            6'b010111 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0100100;
            6'b011000 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0000000;
            6'b011001 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0000100;
            6'b011010 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0001000;
            6'b011011 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0011000;
            6'b011100 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0011100;
            6'b011101 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0100000;
            6'b011110 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0100100;
            6'b011111 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0000000;
            6'b100000 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0000100;
            6'b100001 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0001000;
            6'b100010 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0001100;
            6'b100011 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0010000;
            6'b100100 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0100000;
            6'b100101 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0100100;
            6'b100110 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0000000;
            6'b100111 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0000100;
            6'b101000 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0001000;
            6'b101001 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0001100;
            6'b101010 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0010000;
            6'b101011 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0010100;
            6'b101100 : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0011000;
            default : u0_m0_wo0_wi0_r0_ra0_count1_lut_q = 7'b0000000;
        endcase
    ...
    begin
        if (areset)
        begin
            u0_m0_wo0_wi0_r0_ra0_count1_lutreg_q <= $unsigned(7'b0000000);
        end
        else if (u0_m0_wo0_memread_q == 1'b1)
        begin
    ...
    // u0_m0_wo0_wi0_r0_ra0_add_0_0(ADD,27)@13 + 1
    assign u0_m0_wo0_wi0_r0_ra0_add_0_0_a = $unsigned({{5{u0_m0_wo0_wi0_r0_ra0_count0_q[2]}}, u0_m0_wo0_wi0_r0_ra0_count0_q});
    assign u0_m0_wo0_wi0_r0_ra0_add_0_0_b = $unsigned({{1{u0_m0_wo0_wi0_r0_ra0_count1_lutreg_q[6]}}, u0_m0_wo0_wi0_r0_ra0_count1_lutreg_q});
    always @ (posedge clk)
    begin
        if (0)
        begin
    ...
    assign u0_m0_wo0_wi0_r0_ra0_add_0_0_q = u0_m0_wo0_wi0_r0_ra0_add_0_0_o[7:0];

    // u0_m0_wo0_wi0_r0_readReg0(DELAY,32)@14
    always @ (posedge clk)
    begin
        if (0)
        begin
    ...
    // d_xIn_0_14_offset(CONSTANT,64)
    assign d_xIn_0_14_offset_q = $unsigned(2'b11);

    // d_xIn_0_14_rdcnt(ADD,65)@10 + 1
    ...
    // d_xIn_0_14_wraddr(COUNTER,63)@10 + 1
    // low=0, high=3, step=1, init=0
    always @ (posedge clk)
    begin
        if (0)
    ...
    // d_xIn_0_14_mem(DUALMEM,62)@10 + 2
    ...
    // d_in0_m0_wi0_wo0_assign_id1_q_14(DELAY,56)@11 + 3
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    // u0_m0_wo0_wi0_r0_wa0(COUNTER,29)@14
    // low=0, high=39, step=1, init=32
    always @ (posedge clk)
    begin
        if (areset)
        begin
            u0_m0_wo0_wi0_r0_wa0_i <= 6'd32;
            u0_m0_wo0_wi0_r0_wa0_eq <= 1'b0;
        end
        else if (d_in0_m0_wi0_wo0_assign_id1_q_14_q == 1'b1)
        begin
            if (u0_m0_wo0_wi0_r0_wa0_i == 6'd38)
            begin
            ...
            begin
                u0_m0_wo0_wi0_r0_wa0_i <= $unsigned(u0_m0_wo0_wi0_r0_wa0_i) + $unsigned(6'd25);
            end
            else
            begin
    ...
    // u0_m0_wo0_mtree_mult1_0_cma(CHAINMULTADD,53)@15 + 5
    ...
    begin
        ...
        begin
            ...
            u0_m0_wo0_mtree_mult1_0_cma_ch[0] <= u0_m0_wo0_ca0_q[2:0];
        end
    end
    ...
    // u0_m0_wo0_oseq(SEQUENCE,44)@18 + 1
    always @ (posedge clk)
    begin
        reg [7:0] u0_m0_wo0_oseq_c;
        if (areset)
        begin
            u0_m0_wo0_oseq_c = 8'b00100000;
        ...
        begin
            ...
            begin
                ...
                begin
                    u0_m0_wo0_oseq_c = $signed(u0_m0_wo0_oseq_c) + $signed(8'd35);
                end
                else
                begin
    ...
    // d_out0_m0_wo0_assign_id3_q_21(DELAY,61)@20 + 1
    always @ (posedge clk)
    begin
        if (0)
        begin
