...
// SystemVerilog created from LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_gain
...
module LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_gain (
    ...
    wire [15:0] Convert_imag_rnd_x_replace_constant_q;
    wire [15:0] Convert_imag_rnd_x_replace_round_select_in;
    wire [15:0] Convert_imag_rnd_x_replace_round_select_b;
    wire [15:0] Convert_imag_rnd_x_replace_keep_select_b;
    wire [0:0] Convert_imag_rnd_x_replace_comp_q;
    wire [16:0] Convert_imag_rnd_x_replace_hi_select_in;
    wire [0:0] Convert_imag_rnd_x_replace_hi_select_b;
    wire [15:0] Convert_imag_rnd_x_replace_lo_select_in;
    ...
    wire [17:0] Convert_imag_rnd_x_replace_add_a;
    wire [17:0] Convert_imag_rnd_x_replace_add_b;
    logic [17:0] Convert_imag_rnd_x_replace_add_o;
    wire [16:0] Convert_imag_rnd_x_replace_add_q;
    wire [15:0] Convert_real_rnd_x_replace_round_select_in;
    wire [15:0] Convert_real_rnd_x_replace_round_select_b;
    wire [15:0] Convert_real_rnd_x_replace_keep_select_b;
    wire [0:0] Convert_real_rnd_x_replace_comp_q;
    wire [16:0] Convert_real_rnd_x_replace_hi_select_in;
    wire [0:0] Convert_real_rnd_x_replace_hi_select_b;
    wire [15:0] Convert_real_rnd_x_replace_lo_select_in;
    ...
    wire [17:0] Convert_real_rnd_x_replace_add_a;
    wire [17:0] Convert_real_rnd_x_replace_add_b;
    logic [17:0] Convert_real_rnd_x_replace_add_o;
    wire [16:0] Convert_real_rnd_x_replace_add_q;
    ...
    reg [15:0] redist0_Convert_real_rnd_x_replace_keep_select_b_1_q;
    reg [15:0] redist1_Convert_imag_rnd_x_replace_keep_select_b_1_q;
    ...
    assign Convert_imag_rnd_x_replace_hi_select_in = $unsigned(Mult_imagMult1_x_Mult_imagAdd_x_Mult_imagMult2_x_merged_cma_q[16:0]);
    assign Convert_imag_rnd_x_replace_hi_select_b = $unsigned(Convert_imag_rnd_x_replace_hi_select_in[16:16]);

    // Convert_imag_rnd_x_replace_lo_select(BITSELECT,19)@6
    assign Convert_imag_rnd_x_replace_lo_select_in = $unsigned(Mult_imagMult1_x_Mult_imagAdd_x_Mult_imagMult2_x_merged_cma_q[15:0]);
    assign Convert_imag_rnd_x_replace_lo_select_b = $unsigned(Convert_imag_rnd_x_replace_lo_select_in[15:15]);

    // Convert_imag_rnd_x_replace_constant(CONSTANT,14)
    assign Convert_imag_rnd_x_replace_constant_q = $unsigned(16'b1000000000000000);

    // Convert_imag_rnd_x_replace_round_select(BITSELECT,15)@6
    assign Convert_imag_rnd_x_replace_round_select_in = $unsigned(Mult_imagMult1_x_Mult_imagAdd_x_Mult_imagMult2_x_merged_cma_q[15:0]);
    assign Convert_imag_rnd_x_replace_round_select_b = $unsigned(Convert_imag_rnd_x_replace_round_select_in[15:0]);
    ...
    assign Convert_imag_rnd_x_replace_keep_select_b = $unsigned(Mult_imagMult1_x_Mult_imagAdd_x_Mult_imagMult2_x_merged_cma_q[31:16]);
    ...
    assign Convert_imag_rnd_x_replace_add_a = $unsigned({{2{redist1_Convert_imag_rnd_x_replace_keep_select_b_1_q[15]}}, redist1_Convert_imag_rnd_x_replace_keep_select_b_1_q});
    assign Convert_imag_rnd_x_replace_add_b = $unsigned({17'b00000000000000000, Convert_imag_rnd_x_replace_mux_q});
    ...
    assign Convert_imag_rnd_x_replace_add_q = Convert_imag_rnd_x_replace_add_o[16:0];
    ...
    assign Convert_real_rnd_x_replace_hi_select_in = $unsigned(Mult_realMult1_x_Mult_realSub_x_Mult_realMult2_x_merged_cma_q[16:0]);
    assign Convert_real_rnd_x_replace_hi_select_b = $unsigned(Convert_real_rnd_x_replace_hi_select_in[16:16]);

    // Convert_real_rnd_x_replace_lo_select(BITSELECT,27)@6
    assign Convert_real_rnd_x_replace_lo_select_in = $unsigned(Mult_realMult1_x_Mult_realSub_x_Mult_realMult2_x_merged_cma_q[15:0]);
    assign Convert_real_rnd_x_replace_lo_select_b = $unsigned(Convert_real_rnd_x_replace_lo_select_in[15:15]);

    // Convert_real_rnd_x_replace_round_select(BITSELECT,23)@6
    assign Convert_real_rnd_x_replace_round_select_in = $unsigned(Mult_realMult1_x_Mult_realSub_x_Mult_realMult2_x_merged_cma_q[15:0]);
    assign Convert_real_rnd_x_replace_round_select_b = $unsigned(Convert_real_rnd_x_replace_round_select_in[15:0]);
    ...
    assign Convert_real_rnd_x_replace_keep_select_b = $unsigned(Mult_realMult1_x_Mult_realSub_x_Mult_realMult2_x_merged_cma_q[31:16]);
    ...
    assign Convert_real_rnd_x_replace_add_a = $unsigned({{2{redist0_Convert_real_rnd_x_replace_keep_select_b_1_q[15]}}, redist0_Convert_real_rnd_x_replace_keep_select_b_1_q});
    assign Convert_real_rnd_x_replace_add_b = $unsigned({17'b00000000000000000, Convert_real_rnd_x_replace_mux_q});
    ...
    assign Convert_real_rnd_x_replace_add_q = Convert_real_rnd_x_replace_add_o[16:0];
