...
// SystemVerilog created from LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMATION1_Stage3_Filt_DEC_by_2_stage3_Scale1
...
module LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMA0000C_by_2_stage3_Scale1 (
    ...
    reg [22:0] redist0_u0_rnd_shift_q_1_q;
    ...
    reg [15:0] u0_mux_q;
    reg [0:0] u0_mux_v;
    wire [35:0] u0_shiftsel_q;
    wire [35:0] u0_shiftsel_qint;
    wire [22:0] u0_rnd_trunc_q;
    wire [35:0] u0_rnd_trunc_qint;
    wire [23:0] u0_rnd_add_a;
    wire [23:0] u0_rnd_add_b;
    logic [23:0] u0_rnd_add_o;
    wire [23:0] u0_rnd_add_q;
    ...
    assign u0_shiftsel_q = u0_shiftsel_qint[35:0];

    // u0_rnd_trunc(BITSHIFT,13)@0
    assign u0_rnd_trunc_qint = u0_shiftsel_q;
    assign u0_rnd_trunc_q = u0_rnd_trunc_qint[35:13];

    // u0_rnd_add(ADD,14)@0
    assign u0_rnd_add_a = $unsigned({{1{u0_rnd_trunc_q[22]}}, u0_rnd_trunc_q});
    assign u0_rnd_add_b = $unsigned({{22{u0_rnd_bias_q[1]}}, u0_rnd_bias_q});
    assign u0_rnd_add_o = $unsigned($signed(u0_rnd_add_a) + $signed(u0_rnd_add_b));
    assign u0_rnd_add_q = u0_rnd_add_o[23:0];
    ...
    // u0_high(COMPARE,9)@1
    assign u0_high_a = $unsigned({{9{u0_highconst_q[15]}}, u0_highconst_q});
    assign u0_high_b = $unsigned({{2{redist0_u0_rnd_shift_q_1_q[22]}}, redist0_u0_rnd_shift_q_1_q});
    ...
    // u0_low(COMPARE,8)@1
    assign u0_low_a = $unsigned({{2{redist0_u0_rnd_shift_q_1_q[22]}}, redist0_u0_rnd_shift_q_1_q});
    assign u0_low_b = $unsigned({{9{u0_lowconst_q[15]}}, u0_lowconst_q});
