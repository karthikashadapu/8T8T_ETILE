	component ext_hps_m_master is
		...
		port (
			...
			avs_s0_address       : in  std_logic_vector(29 downto 0) := (others => 'X'); -- address
			...
			avm_m0_address       : out std_logic_vector(36 downto 0);                    -- address
	...
	end component ext_hps_m_master;

	u0 : component ext_hps_m_master
		generic map (
