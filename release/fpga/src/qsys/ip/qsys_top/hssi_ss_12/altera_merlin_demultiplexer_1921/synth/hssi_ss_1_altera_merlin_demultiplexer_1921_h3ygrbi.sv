...
//   output_name:         hssi_ss_1_altera_merlin_demultiplexer_1921_h3ygrbi
//   ST_DATA_W:           132
//   ST_CHANNEL_W:        71
//   NUM_OUTPUTS:         71
//   VALID_WIDTH:         1
...
module hssi_ss_1_altera_merlin_demultiplexer_1921_h3ygrbi
(
    // -------------------
    // Sink
    // -------------------
    ...
    input  [71-1 : 0]   sink_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src0_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src1_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src2_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src3_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src4_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src5_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src6_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src7_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src8_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src9_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src10_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src11_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src12_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src13_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src14_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src15_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src16_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src17_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src18_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src19_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src20_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src21_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src22_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src23_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src24_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src25_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src26_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src27_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src28_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src29_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src30_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src31_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src32_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src33_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src34_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src35_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src36_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src37_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src38_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src39_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src40_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src41_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src42_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src43_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src44_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src45_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src46_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src47_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src48_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src49_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src50_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src51_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src52_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src53_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src54_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src55_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src56_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src57_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src58_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src59_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src60_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src61_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src62_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src63_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src64_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src65_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src66_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src67_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src68_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src69_channel, // ST_CHANNEL_W=71
    ...
    output reg [71-1 : 0] src70_channel, // ST_CHANNEL_W=71
