...
module hssi_ss_f_dr #(
    ...
    input                                  i_p0_pio_ehip_tx_rst_ack_n,
    input                                  i_p0_pio_ehip_rx_rst_ack_n,
    input       [20-1:0]           i_xcvr_ready                 ,
    input       [20-1:0]           i_tx_pma_ready               ,
    input       [20-1:0]           i_rx_pma_ready               ,
    output      [20-1:0]           o_load_recipe_error          ,
    output      [20-1:0]           o_xcvr_cal_error             ,
    input       [20-1:0]           i_hotplug_paused_fm          ,
    output      [20-1:0]           o_hotplug_disable_fm         ,
    output      [20-1:0]           o_hotplug_lpbk_en_fm         ,
    // nios recon20-1g, user-facing side
    ...
    wire p16_pio_axi_st_bridge_rst_n;   // PIO_0 from NIOS
    wire p16_pio_ehip_tx_rst_n;         // PIO_1 from NIOS
    wire p16_pio_ehip_rx_rst_n;         // PIO_2 from NIOS
    wire p16_pio_ereset_n;              // PIO_3 from NIOS
    wire p16_pio_ehip_tx_rst_ack_n;         // tx reset ack from EHIP 
    wire p16_pio_ehip_rx_rst_ack_n;         // rx reset ack from EHIPPIO_6 from NIOS
    wire p17_pio_axi_st_bridge_rst_n;   // PIO_0 from NIOS
    wire p17_pio_ehip_tx_rst_n;         // PIO_1 from NIOS
    wire p17_pio_ehip_rx_rst_n;         // PIO_2 from NIOS
    wire p17_pio_ereset_n;              // PIO_3 from NIOS
    wire p17_pio_ehip_tx_rst_ack_n;         // tx reset ack from EHIP 
    wire p17_pio_ehip_rx_rst_ack_n;         // rx reset ack from EHIPPIO_6 from NIOS
    wire p18_pio_axi_st_bridge_rst_n;   // PIO_0 from NIOS
    wire p18_pio_ehip_tx_rst_n;         // PIO_1 from NIOS
    wire p18_pio_ehip_rx_rst_n;         // PIO_2 from NIOS
    wire p18_pio_ereset_n;              // PIO_3 from NIOS
    wire p18_pio_ehip_tx_rst_ack_n;         // tx reset ack from EHIP 
    wire p18_pio_ehip_rx_rst_ack_n;         // rx reset ack from EHIPPIO_6 from NIOS
    wire p19_pio_axi_st_bridge_rst_n;   // PIO_0 from NIOS
    wire p19_pio_ehip_tx_rst_n;         // PIO_1 from NIOS
    wire p19_pio_ehip_rx_rst_n;         // PIO_2 from NIOS
    wire p19_pio_ereset_n;              // PIO_3 from NIOS
    wire p19_pio_ehip_tx_rst_ack_n;         // tx reset ack from EHIP 
    wire p19_pio_ehip_rx_rst_ack_n;         // rx reset ack from EHIPPIO_6 from NIOS
    wire sim_mode;
    wire sim_fast_en;
    ...
    generate
        if(DISABLE_DR_CPU == 0) begin : internal_cpu
            hssi_ss_f_dr_cpu TRAINING_CPU (
                ...
                .cpu_p0_port_params_export (i_p0_port_params                           ),
                ...
                .cpu_p1_port_params_export (i_p1_port_params                           ),
                ...
                .cpu_p2_port_params_export (i_p2_port_params                           ),
                ...
                .cpu_p3_port_params_export (i_p3_port_params                           ),
                ...
                .cpu_p4_port_params_export (i_p4_port_params                           ),
                ...
                .cpu_p5_port_params_export (i_p5_port_params                           ),
                ...
                .cpu_p6_port_params_export (i_p6_port_params                           ),
                ...
                .cpu_p7_port_params_export (i_p7_port_params                           ),
                ...
                .cpu_p8_port_params_export (i_p8_port_params                           ),
                ...
                .cpu_p9_port_params_export (i_p9_port_params                           ),
                ...
                .cpu_p10_port_params_export (i_p10_port_params                           ),
                ...
                .cpu_p11_port_params_export (i_p11_port_params                           ),
                ...
                .cpu_p12_port_params_export (i_p12_port_params                           ),
                ...
                .cpu_p13_port_params_export (i_p13_port_params                           ),
                ...
                .cpu_p14_port_params_export (i_p14_port_params                           ),
                ...
                .cpu_p15_port_params_export (i_p15_port_params                           ),
                ...
                .cpu_p16_port_params_export (i_p16_port_params                           ),
                .cpu_p16_reset_pio_export({o_p16_pio_ereset_n, o_p16_pio_ehip_rx_rst_n, 
                                                   o_p16_pio_ehip_tx_rst_n, o_p16_pio_axi_st_bridge_rst_n}),   // PIO_0 from NIOS
                .cpu_p17_port_params_export (i_p17_port_params                           ),
                .cpu_p17_reset_pio_export({o_p17_pio_ereset_n, o_p17_pio_ehip_rx_rst_n, 
                                                   o_p17_pio_ehip_tx_rst_n, o_p17_pio_axi_st_bridge_rst_n}),   // PIO_0 from NIOS
                .cpu_p18_port_params_export (i_p18_port_params                           ),
                .cpu_p18_reset_pio_export({o_p18_pio_ereset_n, o_p18_pio_ehip_rx_rst_n, 
                                                   o_p18_pio_ehip_tx_rst_n, o_p18_pio_axi_st_bridge_rst_n}),   // PIO_0 from NIOS
                .cpu_p19_port_params_export (i_p19_port_params                           ),
                .cpu_p19_reset_pio_export({o_p19_pio_ereset_n, o_p19_pio_ehip_rx_rst_n, 
                                                   o_p19_pio_ehip_tx_rst_n, o_p19_pio_axi_st_bridge_rst_n}),   // PIO_0 from NIOS
                .cpu_p0_reset_pio_ack_export({1'b1, i_p0_pio_ehip_rx_rst_ack_n, 
                                                   i_p0_pio_ehip_tx_rst_ack_n, 1'b1}),   // PIO_0 from NIOS
                .cpu_p1_reset_pio_ack_export (4'b0),
                .cpu_p2_reset_pio_ack_export (4'b0),
                .cpu_p3_reset_pio_ack_export (4'b0),
                .cpu_p4_reset_pio_ack_export (4'b0),
                .cpu_p5_reset_pio_ack_export (4'b0),
                .cpu_p6_reset_pio_ack_export (4'b0),
                .cpu_p7_reset_pio_ack_export (4'b0),
                .cpu_p8_reset_pio_ack_export (4'b0),
                .cpu_p9_reset_pio_ack_export (4'b0),
                .cpu_p10_reset_pio_ack_export (4'b0),
                .cpu_p11_reset_pio_ack_export (4'b0),
                .cpu_p12_reset_pio_ack_export (4'b0),
                .cpu_p13_reset_pio_ack_export (4'b0),
                .cpu_p14_reset_pio_ack_export (4'b0),
                .cpu_p15_reset_pio_ack_export (4'b0),
                .cpu_p16_reset_pio_ack_export (4'b0),
                .cpu_p17_reset_pio_ack_export (4'b0),
                .cpu_p18_reset_pio_ack_export (4'b0),
                .cpu_p19_reset_pio_ack_export (4'b0),
                //
                     //
