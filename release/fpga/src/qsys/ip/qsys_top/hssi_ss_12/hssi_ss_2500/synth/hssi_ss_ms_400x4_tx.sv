...
module hssi_ss_ms_400x4_tx #(
    ...
    output reg	[4-1:0]					o_axi_st_tx_tready,
						
    input		[4-1:0]					i_axi_st_tx_tvalid,
    input		[4-1:0][AXI_DW-1:0]  	i_axi_st_tx_tdata,
    input		[4-1:0][NO_OF_BYTES-1:0]i_axi_st_tx_tkeep,
    input		[4-1:0]					i_axi_st_tx_tlast,
    input		[4-1:0][TID-1:0]  		i_axi_st_tx_oid,  //order id
    input		[TUSER-1:0]  			i_axi_st_tx_tuser,
    ...
    output reg  [NUM_SEG-1:0][NO_OF_BYTES-1:0]  	o_axi_st_tx_tkeep_seg,
...
`pragma questa_oem_00 ""
`endif