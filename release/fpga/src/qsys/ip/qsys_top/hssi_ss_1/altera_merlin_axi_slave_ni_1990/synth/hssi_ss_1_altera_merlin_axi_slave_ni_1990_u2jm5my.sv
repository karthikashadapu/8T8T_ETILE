...
module hssi_ss_1_altera_merlin_axi_slave_ni_1990_u2jm5my
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    hssi_ss_1_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1990_g5vpzvq #(
        .SYMBOLS_PER_BEAT    (1),
