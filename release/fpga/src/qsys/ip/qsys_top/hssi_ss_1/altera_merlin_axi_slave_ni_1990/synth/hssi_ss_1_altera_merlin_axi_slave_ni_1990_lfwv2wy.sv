...
module hssi_ss_1_altera_merlin_axi_slave_ni_1990_lfwv2wy
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    hssi_ss_1_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1990_mpmc3jy #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    hssi_ss_1_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1990_34hahza #(
      .SYMBOLS_PER_BEAT (1),
    ...
    hssi_ss_1_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1990_imnjiba #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       hssi_ss_1_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1990_iioeqlq #(
             .SYMBOLS_PER_BEAT (1),
