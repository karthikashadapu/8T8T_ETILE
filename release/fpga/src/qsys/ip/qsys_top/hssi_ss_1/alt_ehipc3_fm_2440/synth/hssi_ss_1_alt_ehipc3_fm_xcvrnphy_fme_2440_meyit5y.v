// hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_meyit5y.v

// Generated using ACDS version 24.1 115

`timescale 1 ps / 1 ps
module hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_meyit5y #(
		...
		parameter hssi_ehip_lane_ehip_clk_sel                                      = "shared_clock",
		parameter hssi_ehip_lane_ehip_dist_clk_sel                                 = 0,
		parameter hssi_ehip_lane_ehip_mode                                         = "ehip_mac_ptp",
		...
		parameter hssi_ehip_lane_powermode_ac_mac                                  = "mac_on_1_lane_ptp",
		parameter hssi_ehip_lane_powermode_ac_misc                                 = "misc_on",
		parameter hssi_ehip_lane_powermode_ac_pcs                                  = "pcs_on_1_lane_rsfec",
		parameter hssi_ehip_lane_powermode_ac_pld                                  = "pld_on_1_lane_ptp",
		...
		parameter hssi_ehip_lane_ptp_tx_timestamp_method                           = "ptp_1step",
		...
		parameter hssi_rsfec_func_mode                                             = "elane_frac",
		parameter hssi_rsfec_hwcfg_ena                                             = "false",
		parameter hssi_rsfec_hwcfg_mode                                            = 0,
		parameter hssi_rsfec_lane_func_mode0                                       = "lane_mode_elane0",
		parameter hssi_rsfec_lane_func_mode1                                       = "lane_mode_elane1",
		parameter hssi_rsfec_lane_func_mode2                                       = "lane_mode_elane2",
		parameter hssi_rsfec_lane_func_mode3                                       = "lane_mode_elane3",
		parameter hssi_rsfec_operation_mode                                        = "oper_frac",
		...
		parameter hssi_rsfec_tx_data_source_sel0                                   = "elane_tx_data0",
		parameter hssi_rsfec_tx_data_source_sel1                                   = "elane_tx_data1",
		parameter hssi_rsfec_tx_data_source_sel2                                   = "elane_tx_data2",
		parameter hssi_rsfec_tx_data_source_sel3                                   = "elane_tx_data3",
		...
		parameter hssi_xcvr_cfg_rx_bit_counter_rollover                            = 5248,
	...
	generate
		...
		if (hssi_ehip_lane_ehip_clk_sel != "shared_clock")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_ehip_lane_ehip_mode != "ehip_mac_ptp")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_ehip_lane_powermode_ac_mac != "mac_on_1_lane_ptp")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_ehip_lane_powermode_ac_pcs != "pcs_on_1_lane_rsfec")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_ehip_lane_powermode_ac_pld != "pld_on_1_lane_ptp")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_ehip_lane_ptp_tx_timestamp_method != "ptp_1step")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_rsfec_func_mode != "elane_frac")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_rsfec_lane_func_mode0 != "lane_mode_elane0")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_rsfec_lane_func_mode1 != "lane_mode_elane1")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_rsfec_lane_func_mode2 != "lane_mode_elane2")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_rsfec_lane_func_mode3 != "lane_mode_elane3")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_rsfec_operation_mode != "oper_frac")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_rsfec_tx_data_source_sel0 != "elane_tx_data0")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_rsfec_tx_data_source_sel1 != "elane_tx_data1")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_rsfec_tx_data_source_sel2 != "elane_tx_data2")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_rsfec_tx_data_source_sel3 != "elane_tx_data3")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (hssi_xcvr_cfg_rx_bit_counter_rollover != 5248)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
	...
	hssi_ss_1_xcvrnphy_fme_411_tprk4ty #(
		...
		.hssi_ehip_lane_ehip_clk_sel                                      ("shared_clock"),
		.hssi_ehip_lane_ehip_dist_clk_sel                                 (0),
		.hssi_ehip_lane_ehip_mode                                         ("ehip_mac_ptp"),
		...
		.hssi_ehip_lane_powermode_ac_mac                                  ("mac_on_1_lane_ptp"),
		.hssi_ehip_lane_powermode_ac_misc                                 ("misc_on"),
		.hssi_ehip_lane_powermode_ac_pcs                                  ("pcs_on_1_lane_rsfec"),
		.hssi_ehip_lane_powermode_ac_pld                                  ("pld_on_1_lane_ptp"),
		.hssi_ehip_lane_powermode_dc                                      ("powerup_dc"),
		.hssi_ehip_lane_ptp_debug                                         ("0"),
		.hssi_ehip_lane_ptp_timestamp_format                              ("v2"),
		.hssi_ehip_lane_ptp_tx_timestamp_method                           ("ptp_1step"),
		...
		.hssi_rsfec_func_mode                                             ("elane_frac"),
		.hssi_rsfec_hwcfg_ena                                             ("false"),
		.hssi_rsfec_hwcfg_mode                                            (0),
		.hssi_rsfec_lane_func_mode0                                       ("lane_mode_elane0"),
		.hssi_rsfec_lane_func_mode1                                       ("lane_mode_elane1"),
		.hssi_rsfec_lane_func_mode2                                       ("lane_mode_elane2"),
		.hssi_rsfec_lane_func_mode3                                       ("lane_mode_elane3"),
		.hssi_rsfec_operation_mode                                        ("oper_frac"),
		...
		.hssi_rsfec_tx_data_source_sel0                                   ("elane_tx_data0"),
		.hssi_rsfec_tx_data_source_sel1                                   ("elane_tx_data1"),
		.hssi_rsfec_tx_data_source_sel2                                   ("elane_tx_data2"),
		.hssi_rsfec_tx_data_source_sel3                                   ("elane_tx_data3"),
		...
		.hssi_xcvr_cfg_rx_bit_counter_rollover                            (5248),
		...
		.tx_dl_async_pulse                          (tx_dl_async_pulse),                          //  output,    width = 4,                          tx_dl_async_pulse.tx_dl_async_pulse
		.rx_dl_async_pulse                          (rx_dl_async_pulse),                          //  output,    width = 4,                          rx_dl_async_pulse.rx_dl_async_pulse
		.latency_sclk                               (latency_sclk),                               //   input,    width = 4,                               latency_sclk.latency_sclk
		.tx_dl_measure_sel                          (tx_dl_measure_sel),                          //   input,    width = 4,                          tx_dl_measure_sel.tx_dl_measure_sel
		.rx_dl_measure_sel                          (rx_dl_measure_sel),                          //   input,    width = 4,                          rx_dl_measure_sel.rx_dl_measure_sel
		.rx_fifo_latency_adj_ena                    (rx_fifo_latency_adj_ena),                    //   input,    width = 4,                    rx_fifo_latency_adj_ena.rx_fifo_latency_adj_ena
