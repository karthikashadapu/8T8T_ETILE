...
module alt_ehipc3_fm_hard_dev3xca
       ...
       if (( (core_variant == 0) ||
           ...
           ((ENABLE_RSFEC == 0) && (ENABLE_RSFEC_MODE == 0))
            ...
            `ifdef ALTERA_RESERVED_QIS
                hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_phvzi3a altera_xcvr_native_inst (
            `else
                hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_meyit5y altera_xcvr_native_inst (
            `endif
    ...
    generate
        if (((core_variant == 3) && (active_channel == 0)) &&
            ...
            assign ptp_ch_fr_clk = enable_external_aib_clocking ? i_aib_2x_clk :
            	...
            	`ifdef ALTERA_RESERVED_QIS
                	hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_evw27uq nphy_ptp (
            	`else
                	hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_cfk7b7a nphy_ptp  (
            	`endif
...
//            );
		    ...
		    // PTP_CH[0] - lower PTP channel PLL OFF.
	            `ifdef ALTERA_RESERVED_QIS
	               	hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_tmgf3fy nphy_ptp0 (
	            `else
	               	hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_xsjhyoi nphy_ptp0 (
	            `endif
		    ...
		    // PTP_CH[1] - upper PTP channel PLL ON.
	            `ifdef ALTERA_RESERVED_QIS
	               	hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_evw27uq nphy_ptp1 (
	            `else
	               	hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_cfk7b7a nphy_ptp1 (
	            `endif
	                .aib_ehip_rx_ehip_clk                       (o_ehip_clk),                       //   input,    width = 2,                       aib_ehip_rx_ehip_clk.aib_ehip_rx_ehip_clk
	                .aib_ehip_rx_ehip_fr_clk                    (o_ehip_dist_fr_rx_clk),                    //   input,    width = 2,                    aib_ehip_rx_ehip_fr_clk.aib_ehip_rx_ehip_fr_clk
	                .aib_ehip_rx_fec_fr_clk                     (o_fec_dist_fr_rx_clk),                     //   input,    width = 2,                     aib_ehip_rx_fec_fr_clk.aib_ehip_rx_fec_fr_clk
		    ...
		    // PTP_CH[0] - lower PTP channel PLL ON.
	           `ifdef ALTERA_RESERVED_QIS
	               	hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_evw27uq nphy_ptp0 (
	           `else
	               	hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_cfk7b7a nphy_ptp0 (
	           `endif
	                .aib_ehip_rx_ehip_clk                       (o_ehip_clk),                       //   input,    width = 2,                       aib_ehip_rx_ehip_clk.aib_ehip_rx_ehip_clk
	                .aib_ehip_rx_ehip_fr_clk                    (o_ehip_dist_fr_rx_clk),                    //   input,    width = 2,                    aib_ehip_rx_ehip_fr_clk.aib_ehip_rx_ehip_fr_clk
	                .aib_ehip_rx_fec_fr_clk                     (o_fec_dist_fr_rx_clk),                     //   input,    width = 2,                     aib_ehip_rx_fec_fr_clk.aib_ehip_rx_fec_fr_clk
		    ...
		    // PTP_CH[1] - upper PTP channel PLL OFF.
	           `ifdef ALTERA_RESERVED_QIS
	               	hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_tmgf3fy nphy_ptp1 (
	           `else
	               	hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_xsjhyoi nphy_ptp1 (
	           `endif
	                .aib_ehip_rx_ehip_clk                       (o_ehip_clk),                       //   input,    width = 2,                       aib_ehip_rx_ehip_clk.aib_ehip_rx_ehip_clk
	                .aib_ehip_rx_ehip_fr_clk                    (o_ehip_dist_fr_rx_clk),                    //   input,    width = 2,                    aib_ehip_rx_ehip_fr_clk.aib_ehip_rx_ehip_fr_clk
	                .aib_ehip_rx_fec_fr_clk                     (o_fec_dist_fr_rx_clk),                     //   input,    width = 2,                     aib_ehip_rx_fec_fr_clk.aib_ehip_rx_fec_fr_clk
...
// When EHIP_LOCATION_1/3, select PTP_CH[0] to turnoff the PLL.
// ---------------------------------------------------------------------------------------------------------------------------------
//           hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_evw27uq 
//			 nphy_ptp 
//			   (
...
//				);
            ...
            if(ECORE_5432_TIEOFF) begin
		   // PTP_CH[0] - lower PTP channel PLL OFF.
	           hssi_ss_1_alt_ehipc3_fm_xcvrnphy_fme_2440_tmgf3fy
				 nphy_ptp0
				   (
