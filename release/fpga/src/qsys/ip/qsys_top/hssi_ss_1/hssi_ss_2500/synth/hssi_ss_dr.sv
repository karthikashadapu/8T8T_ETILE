...
module hssi_ss_dr #(
    ...
    output                                 o_p1_pio_axi_st_bridge_rst_n,
    output                                 o_p1_pio_ehip_tx_rst_n,
    output                                 o_p1_pio_ehip_rx_rst_n,
    output                                 o_p1_pio_ereset_n,
    output                                 o_p2_pio_axi_st_bridge_rst_n,
    output                                 o_p2_pio_ehip_tx_rst_n,
    output                                 o_p2_pio_ehip_rx_rst_n,
    output                                 o_p2_pio_ereset_n,
    output                                 o_p3_pio_axi_st_bridge_rst_n,
    output                                 o_p3_pio_ehip_tx_rst_n,
    output                                 o_p3_pio_ehip_rx_rst_n,
    output                                 o_p3_pio_ereset_n,
    ...
    wire [1:0] o_cpu_p0_base_profile = 2'd1;
    ...
    wire [1:0] o_cpu_p1_base_profile = 2'd1;
    ...
    wire [1:0] o_cpu_p2_base_profile = 2'd1;
    ...
    wire [1:0] o_cpu_p3_base_profile = 2'd1;
    ...
    generate
        if(DISABLE_DR_CPU == 0) begin : internal_cpu
            hssi_ss_dr_cpu TRAINING_CPU (
                ...
                .cpu_qhip_num_channels_export  (32'd27                                       ),
                .cpu_xcvr_channel_enable_export(16'd15                             ),
                     //
