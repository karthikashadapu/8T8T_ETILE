...
if { ! [timing_netlist_exist] } {
   ...
   source "$script_dir/emif_hps_altera_emif_arch_fm_191_ectfhsq_report_timing_core.tcl"
   if { ! [timing_netlist_exist] } {
...
emif_hps_altera_emif_arch_fm_191_ectfhsq_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_emif_hps_altera_emif_arch_fm_191_ectfhsq_corename}"
   } else {
      set fbasename "${::GLOBAL_emif_hps_altera_emif_arch_fm_191_ectfhsq_corename}_${inst_id}"
   }
   ...
   emif_hps_altera_emif_arch_fm_191_ectfhsq_perform_core_analysis $opcname $inst pins var summary


   set summary [lsort -command emif_hps_altera_emif_arch_fm_191_ectfhsq_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_emif_hps_altera_emif_arch_fm_191_ectfhsq_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ emif_hps_altera_emif_arch_fm_191_ectfhsq_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ emif_hps_altera_emif_arch_fm_191_ectfhsq_round_3dp $hold]
      }
