// agilex_hps_intel_agilex_hps_2400_3oimhkq.v
...
`timescale 1 ps / 1 ps
module agilex_hps_intel_agilex_hps_2400_3oimhkq (
	...
	agilex_hps_intel_agilex_interface_generator_191_2rgoewq #(
		.F2S_DATA_WIDTH      (512),
		.F2S_ADDRESS_WIDTH   (37),
		.S2F_DATA_WIDTH      (128),
		...
		.h2f_mpu_fpga_eventi     (h2f_mpu_fpga_eventi),     //   input,     width = 1,    h2f_mpu_events.fpga_eventi
		.h2f_mpu_fpga_evento     (h2f_mpu_fpga_evento),     //  output,     width = 1,                  .fpga_evento
		.h2f_mpu_fpga_standbywfe (h2f_mpu_fpga_standbywfe), //  output,     width = 4,                  .fpga_standbywfe
		.h2f_mpu_fpga_standbywfi (h2f_mpu_fpga_standbywfi), //  output,     width = 4,                  .fpga_standbywfi
		.f2h_stm_hwevents        (f2h_stm_hwevents),        //   input,    width = 44, f2h_stm_hw_events.stm_hwevents
		.h2f_cs_ntrst            (h2f_cs_ntrst),            //   input,     width = 1,            h2f_cs.ntrst
		.h2f_cs_tck              (h2f_cs_tck),              //   input,     width = 1,                  .tck
		.h2f_cs_tdi              (h2f_cs_tdi),              //   input,     width = 1,                  .tdi
		.h2f_cs_tdo              (h2f_cs_tdo),              //  output,     width = 1,                  .tdo
		.h2f_cs_tdoen            (h2f_cs_tdoen),            //  output,     width = 1,                  .tdoen
		.h2f_cs_tms              (h2f_cs_tms),              //   input,     width = 1,                  .tms
		...
		.f2h_AWDOMAIN            (f2h_AWDOMAIN),            //   input,     width = 2,                  .awdomain
		.f2h_AWBAR               (f2h_AWBAR),               //   input,     width = 2,                  .awbar
		.f2h_ARDOMAIN            (f2h_ARDOMAIN),            //   input,     width = 2,                  .ardomain
		.f2h_ARBAR               (f2h_ARBAR),               //   input,     width = 2,                  .arbar
		.f2h_ARSNOOP             (f2h_ARSNOOP),             //   input,     width = 4,                  .arsnoop
		.f2h_AWSNOOP             (f2h_AWSNOOP),             //   input,     width = 3,                  .awsnoop
		.f2h_AWID                (f2h_AWID),                //   input,     width = 5,                  .awid
		.f2h_AWADDR              (f2h_AWADDR),              //   input,    width = 37,                  .awaddr
		...
		.f2h_ARADDR              (f2h_ARADDR),              //   input,    width = 37,                  .araddr
