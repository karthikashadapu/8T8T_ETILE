...
module agilex_hps_intel_agilex_interface_generator_191_2rgoewq #(
	parameter F2S_DATA_WIDTH = 512 ,
	parameter F2S_ADDRESS_WIDTH = 37 ,
...
// h2f_mpu_events
 ,input wire [1 - 1 : 0 ] h2f_mpu_fpga_eventi
 ,output wire [1 - 1 : 0 ] h2f_mpu_fpga_evento
 ,output wire [4 - 1 : 0 ] h2f_mpu_fpga_standbywfe
 ,output wire [4 - 1 : 0 ] h2f_mpu_fpga_standbywfi
// f2h_stm_hw_events
 ,input wire [44 - 1 : 0 ] f2h_stm_hwevents
// h2f_cs
 ,input wire [1 - 1 : 0 ] h2f_cs_ntrst
 ,input wire [1 - 1 : 0 ] h2f_cs_tck
 ,input wire [1 - 1 : 0 ] h2f_cs_tdi
 ,output wire [1 - 1 : 0 ] h2f_cs_tdo
 ,output wire [1 - 1 : 0 ] h2f_cs_tdoen
 ,input wire [1 - 1 : 0 ] h2f_cs_tms
// hps_emif
...
// f2h_axi_slave
 ...
 ,input wire [2 - 1 : 0 ] f2h_AWDOMAIN
 ,input wire [2 - 1 : 0 ] f2h_AWBAR
 ,input wire [2 - 1 : 0 ] f2h_ARDOMAIN
 ,input wire [2 - 1 : 0 ] f2h_ARBAR
 ,input wire [4 - 1 : 0 ] f2h_ARSNOOP
 ,input wire [3 - 1 : 0 ] f2h_AWSNOOP
 ,input wire [5 - 1 : 0 ] f2h_AWID
 ,input wire [37 - 1 : 0 ] f2h_AWADDR
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_EMAC1_TX_CLK_obuf(
    .i(EMAC1_TX_CLK_out),
    .o(EMAC1_TX_CLK),
    .oe(1'b1)
);
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_EMAC1_TXD0_obuf(
    .i(EMAC1_TXD0_out),
    .o(EMAC1_TXD0),
    .oe(1'b1)
);
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_EMAC1_TXD1_obuf(
    .i(EMAC1_TXD1_out),
    .o(EMAC1_TXD1),
    .oe(1'b1)
);
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_EMAC1_TXD2_obuf(
    .i(EMAC1_TXD2_out),
    .o(EMAC1_TXD2),
    .oe(1'b1)
);
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_EMAC1_TXD3_obuf(
    .i(EMAC1_TXD3_out),
    .o(EMAC1_TXD3),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_EMAC1_RX_CTL_ibuf(
    .i(EMAC1_RX_CTL),
    .o(EMAC1_RX_CTL_in)
);

wire [0:0] EMAC1_TX_CTL_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_EMAC1_TX_CTL_obuf(
    .i(EMAC1_TX_CTL_out),
    .o(EMAC1_TX_CTL),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_EMAC1_RX_CLK_ibuf(
    .i(EMAC1_RX_CLK),
    .o(EMAC1_RX_CLK_in)
);

wire [0:0] EMAC1_RXD0_in;
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_EMAC1_RXD0_ibuf(
    .i(EMAC1_RXD0),
    .o(EMAC1_RXD0_in)
);

wire [0:0] EMAC1_RXD1_in;
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_EMAC1_RXD1_ibuf(
    .i(EMAC1_RXD1),
    .o(EMAC1_RXD1_in)
);

wire [0:0] EMAC1_RXD2_in;
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_EMAC1_RXD2_ibuf(
    .i(EMAC1_RXD2),
    .o(EMAC1_RXD2_in)
);

wire [0:0] EMAC1_RXD3_in;
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_EMAC1_RXD3_ibuf(
    .i(EMAC1_RXD3),
    .o(EMAC1_RXD3_in)
);

wire [0:0] EMAC1_MDIO_in;
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_EMAC1_MDIO_ibuf(
    .i(EMAC1_MDIO),
    .o(EMAC1_MDIO_in)
);

wire [0:0] EMAC1_MDIO_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_EMAC1_MDIO_obuf(
    .i(EMAC1_MDIO_out),
    .o(EMAC1_MDIO),
    .oe(1'b1)
);
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_EMAC1_MDC_obuf(
    .i(EMAC1_MDC_out),
    .o(EMAC1_MDC),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_SDMMC_D4_ibuf(
    .i(SDMMC_D4),
    .o(SDMMC_D4_in)
);

wire [0:0] SDMMC_D4_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SDMMC_D4_obuf(
    .i(SDMMC_D4_out),
    .o(SDMMC_D4),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_SDMMC_D5_ibuf(
    .i(SDMMC_D5),
    .o(SDMMC_D5_in)
);

wire [0:0] SDMMC_D5_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SDMMC_D5_obuf(
    .i(SDMMC_D5_out),
    .o(SDMMC_D5),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_SDMMC_D6_ibuf(
    .i(SDMMC_D6),
    .o(SDMMC_D6_in)
);

wire [0:0] SDMMC_D6_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SDMMC_D6_obuf(
    .i(SDMMC_D6_out),
    .o(SDMMC_D6),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_SDMMC_D7_ibuf(
    .i(SDMMC_D7),
    .o(SDMMC_D7_in)
);

wire [0:0] SDMMC_D7_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SDMMC_D7_obuf(
    .i(SDMMC_D7_out),
    .o(SDMMC_D7),
    .oe(1'b1)
);
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SPIM0_CLK_obuf(
    .i(SPIM0_CLK_out),
    .o(SPIM0_CLK),
    .oe(1'b1)
);
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SPIM0_MOSI_obuf(
    .i(SPIM0_MOSI_out),
    .o(SPIM0_MOSI),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_SPIM0_MISO_ibuf(
    .i(SPIM0_MISO),
    .o(SPIM0_MISO_in)
);

wire [0:0] SPIM0_SS0_N_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SPIM0_SS0_N_obuf(
    .i(SPIM0_SS0_N_out),
    .o(SPIM0_SS0_N),
    .oe(1'b1)
);
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SPIM1_CLK_obuf(
    .i(SPIM1_CLK_out),
    .o(SPIM1_CLK),
    .oe(1'b1)
);
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SPIM1_MOSI_obuf(
    .i(SPIM1_MOSI_out),
    .o(SPIM1_MOSI),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_SPIM1_MISO_ibuf(
    .i(SPIM1_MISO),
    .o(SPIM1_MISO_in)
);

wire [0:0] SPIM1_SS0_N_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SPIM1_SS0_N_obuf(
    .i(SPIM1_SS0_N_out),
    .o(SPIM1_SS0_N),
    .oe(1'b1)
);
...
tennm_io_obuf #(.buffer_usage("HSSI")) hps_SPIM1_SS1_N_obuf(
    .i(SPIM1_SS1_N_out),
    .o(SPIM1_SS1_N),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_UART1_RX_ibuf(
    .i(UART1_RX),
    .o(UART1_RX_in)
);

wire [0:0] UART1_TX_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_UART1_TX_obuf(
    .i(UART1_TX_out),
    .o(UART1_TX),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_I2C1_SDA_ibuf(
    .i(I2C1_SDA),
    .o(I2C1_SDA_in)
);

wire [0:0] I2C1_SDA_out;
tennm_io_obuf #(.open_drain_output("true"),
          .buffer_usage("HSSI")) hps_I2C1_SDA_obuf(
    .i(1'b0),
    .o(I2C1_SDA),
    .oe(I2C1_SDA_out)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_I2C1_SCL_ibuf(
    .i(I2C1_SCL),
    .o(I2C1_SCL_in)
);
...
tennm_io_obuf #(.open_drain_output("true"),
          .buffer_usage("HSSI")) hps_I2C1_SCL_obuf(
    .i(1'b0),
    .o(I2C1_SCL),
    .oe(I2C1_SCL_out)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_hps_osc_clk_ibuf(
    .i(hps_osc_clk),
    .o(hps_osc_clk_in)
);

wire [0:0] gpio0_io11_in;
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_gpio0_io11_ibuf(
    .i(gpio0_io11),
    .o(gpio0_io11_in)
);

wire [0:0] gpio0_io11_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_gpio0_io11_obuf(
    .i(gpio0_io11_out),
    .o(gpio0_io11),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_gpio0_io12_ibuf(
    .i(gpio0_io12),
    .o(gpio0_io12_in)
);

wire [0:0] gpio0_io12_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_gpio0_io12_obuf(
    .i(gpio0_io12_out),
    .o(gpio0_io12),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_gpio0_io13_ibuf(
    .i(gpio0_io13),
    .o(gpio0_io13_in)
);

wire [0:0] gpio0_io13_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_gpio0_io13_obuf(
    .i(gpio0_io13_out),
    .o(gpio0_io13),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_gpio0_io14_ibuf(
    .i(gpio0_io14),
    .o(gpio0_io14_in)
);

wire [0:0] gpio0_io14_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_gpio0_io14_obuf(
    .i(gpio0_io14_out),
    .o(gpio0_io14),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_gpio0_io15_ibuf(
    .i(gpio0_io15),
    .o(gpio0_io15_in)
);

wire [0:0] gpio0_io15_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_gpio0_io15_obuf(
    .i(gpio0_io15_out),
    .o(gpio0_io15),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_gpio0_io16_ibuf(
    .i(gpio0_io16),
    .o(gpio0_io16_in)
);

wire [0:0] gpio0_io16_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_gpio0_io16_obuf(
    .i(gpio0_io16_out),
    .o(gpio0_io16),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_gpio0_io17_ibuf(
    .i(gpio0_io17),
    .o(gpio0_io17_in)
);

wire [0:0] gpio0_io17_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_gpio0_io17_obuf(
    .i(gpio0_io17_out),
    .o(gpio0_io17),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_gpio0_io18_ibuf(
    .i(gpio0_io18),
    .o(gpio0_io18_in)
);

wire [0:0] gpio0_io18_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_gpio0_io18_obuf(
    .i(gpio0_io18_out),
    .o(gpio0_io18),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_gpio1_io16_ibuf(
    .i(gpio1_io16),
    .o(gpio1_io16_in)
);

wire [0:0] gpio1_io16_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_gpio1_io16_obuf(
    .i(gpio1_io16_out),
    .o(gpio1_io16),
    .oe(1'b1)
);
...
tennm_io_ibuf #(.buffer_usage("HSSI")) hps_gpio1_io17_ibuf(
    .i(gpio1_io17),
    .o(gpio1_io17_in)
);

wire [0:0] gpio1_io17_out;
tennm_io_obuf #(.buffer_usage("HSSI")) hps_gpio1_io17_obuf(
    .i(gpio1_io17_out),
    .o(gpio1_io17),
    .oe(1'b1)
);
...
,.fpga_standbywfe({
    h2f_mpu_fpga_standbywfe[3:0] // 3:0
  })
,.HPS_IOB_19_I({
...
,.fpga_standbywfi({
    h2f_mpu_fpga_standbywfi[3:0] // 3:0
  })
,.HPS_IOA_10_O({
