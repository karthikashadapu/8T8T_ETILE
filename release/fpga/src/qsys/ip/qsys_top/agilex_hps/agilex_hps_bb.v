module agilex_hps (
		...
		input  wire          h2f_mpu_fpga_eventi,     //    h2f_mpu_events.fpga_eventi
		output wire          h2f_mpu_fpga_evento,     //                  .fpga_evento
		output wire [3:0]    h2f_mpu_fpga_standbywfe, //                  .fpga_standbywfe
		output wire [3:0]    h2f_mpu_fpga_standbywfi, //                  .fpga_standbywfi
		input  wire [43:0]   f2h_stm_hwevents,        // f2h_stm_hw_events.stm_hwevents
		input  wire          h2f_cs_ntrst,            //            h2f_cs.ntrst
		input  wire          h2f_cs_tck,              //                  .tck
		input  wire          h2f_cs_tdi,              //                  .tdi
		output wire          h2f_cs_tdo,              //                  .tdo
		output wire          h2f_cs_tdoen,            //                  .tdoen
		input  wire          h2f_cs_tms,              //                  .tms
		...
		input  wire [36:0]   f2h_AWADDR,              //                  .awaddr
		...
		input  wire [36:0]   f2h_ARADDR,              //                  .araddr
		...
		input  wire [1:0]    f2h_AWDOMAIN,            //                  .awdomain
		input  wire [1:0]    f2h_AWBAR,               //                  .awbar
		input  wire [1:0]    f2h_ARDOMAIN,            //                  .ardomain
		input  wire [1:0]    f2h_ARBAR,               //                  .arbar
		input  wire [3:0]    f2h_ARSNOOP,             //                  .arsnoop
		input  wire [2:0]    f2h_AWSNOOP,             //                  .awsnoop
