	agilex_hps u0 (
		...
		.h2f_mpu_fpga_eventi     (_connected_to_h2f_mpu_fpga_eventi_),     //   input,     width = 1,    h2f_mpu_events.fpga_eventi
		.h2f_mpu_fpga_evento     (_connected_to_h2f_mpu_fpga_evento_),     //  output,     width = 1,                  .fpga_evento
		.h2f_mpu_fpga_standbywfe (_connected_to_h2f_mpu_fpga_standbywfe_), //  output,     width = 4,                  .fpga_standbywfe
		.h2f_mpu_fpga_standbywfi (_connected_to_h2f_mpu_fpga_standbywfi_), //  output,     width = 4,                  .fpga_standbywfi
		.f2h_stm_hwevents        (_connected_to_f2h_stm_hwevents_),        //   input,    width = 44, f2h_stm_hw_events.stm_hwevents
		.h2f_cs_ntrst            (_connected_to_h2f_cs_ntrst_),            //   input,     width = 1,            h2f_cs.ntrst
		.h2f_cs_tck              (_connected_to_h2f_cs_tck_),              //   input,     width = 1,                  .tck
		.h2f_cs_tdi              (_connected_to_h2f_cs_tdi_),              //   input,     width = 1,                  .tdi
		.h2f_cs_tdo              (_connected_to_h2f_cs_tdo_),              //  output,     width = 1,                  .tdo
		.h2f_cs_tdoen            (_connected_to_h2f_cs_tdoen_),            //  output,     width = 1,                  .tdoen
		.h2f_cs_tms              (_connected_to_h2f_cs_tms_),              //   input,     width = 1,                  .tms
		...
		.f2h_AWADDR              (_connected_to_f2h_AWADDR_),              //   input,    width = 37,                  .awaddr
		...
		.f2h_ARADDR              (_connected_to_f2h_ARADDR_),              //   input,    width = 37,                  .araddr
		...
		.f2h_AWDOMAIN            (_connected_to_f2h_AWDOMAIN_),            //   input,     width = 2,                  .awdomain
		.f2h_AWBAR               (_connected_to_f2h_AWBAR_),               //   input,     width = 2,                  .awbar
		.f2h_ARDOMAIN            (_connected_to_f2h_ARDOMAIN_),            //   input,     width = 2,                  .ardomain
		.f2h_ARBAR               (_connected_to_f2h_ARBAR_),               //   input,     width = 2,                  .arbar
		.f2h_ARSNOOP             (_connected_to_f2h_ARSNOOP_),             //   input,     width = 4,                  .arsnoop
		.f2h_AWSNOOP             (_connected_to_f2h_AWSNOOP_),             //   input,     width = 3,                  .awsnoop
