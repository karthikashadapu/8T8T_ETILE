// hssi_ss_1_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1932_m4p5hhq.v

// Generated using ACDS version 24.1 115

`timescale 1 ps / 1 ps
module hssi_ss_1_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1932_m4p5hhq #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 105,
	...
	hssi_ss_1_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),           //   input,  width = 105,          .data
		...
		.out_data          (out_data),          //  output,  width = 105,          .data
