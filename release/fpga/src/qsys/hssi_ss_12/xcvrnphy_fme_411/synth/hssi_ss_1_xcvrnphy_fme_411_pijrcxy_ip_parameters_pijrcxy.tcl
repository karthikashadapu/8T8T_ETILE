...
set ::GLOBAL_corename hssi_ss_1_xcvrnphy_fme_411_pijrcxy
# -------------------------------- #
# --- Default Profile settings --- #
# -------------------------------- #
dict set native_phy_ip_params pma_tx_data_rate_profile0 "10312.5"
dict set native_phy_ip_params pma_rx_data_rate_profile0 "10312.5"
dict set native_phy_ip_params duplex_mode_profile0 "duplex"
dict set native_phy_ip_params protocol_mode_profile0 "teng"
