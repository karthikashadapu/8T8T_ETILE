...
//   output_name:         hssi_ss_1_altera_merlin_demultiplexer_1921_4w3mi4i
//   ST_DATA_W:           132
//   ST_CHANNEL_W:        88
//   NUM_OUTPUTS:         88
//   VALID_WIDTH:         1
...
module hssi_ss_1_altera_merlin_demultiplexer_1921_4w3mi4i
(
    // -------------------
    // Sink
    // -------------------
    ...
    input  [88-1 : 0]   sink_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src0_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src1_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src2_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src3_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src4_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src5_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src6_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src7_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src8_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src9_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src10_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src11_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src12_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src13_channel, // ST_CHANNEL_W=88
    ...
    output reg [88-1 : 0] src14_channel, // ST_CHANNEL_W=88
    output reg                      src14_startofpacket,
    output reg                      src14_endofpacket,
    input                           src14_ready,

    output reg                      src15_valid,
    output reg [132-1    : 0] src15_data, // ST_DATA_W=132
    output reg [88-1 : 0] src15_channel, // ST_CHANNEL_W=88
    output reg                      src15_startofpacket,
    output reg                      src15_endofpacket,
    input                           src15_ready,

    output reg                      src16_valid,
    output reg [132-1    : 0] src16_data, // ST_DATA_W=132
    output reg [88-1 : 0] src16_channel, // ST_CHANNEL_W=88
    output reg                      src16_startofpacket,
    output reg                      src16_endofpacket,
    input                           src16_ready,

    output reg                      src17_valid,
    output reg [132-1    : 0] src17_data, // ST_DATA_W=132
    output reg [88-1 : 0] src17_channel, // ST_CHANNEL_W=88
    output reg                      src17_startofpacket,
    output reg                      src17_endofpacket,
    input                           src17_ready,

    output reg                      src18_valid,
    output reg [132-1    : 0] src18_data, // ST_DATA_W=132
    output reg [88-1 : 0] src18_channel, // ST_CHANNEL_W=88
    output reg                      src18_startofpacket,
    output reg                      src18_endofpacket,
    input                           src18_ready,

    output reg                      src19_valid,
    output reg [132-1    : 0] src19_data, // ST_DATA_W=132
    output reg [88-1 : 0] src19_channel, // ST_CHANNEL_W=88
    output reg                      src19_startofpacket,
    output reg                      src19_endofpacket,
    input                           src19_ready,

    output reg                      src20_valid,
    output reg [132-1    : 0] src20_data, // ST_DATA_W=132
    output reg [88-1 : 0] src20_channel, // ST_CHANNEL_W=88
    output reg                      src20_startofpacket,
    output reg                      src20_endofpacket,
    input                           src20_ready,

    output reg                      src21_valid,
    output reg [132-1    : 0] src21_data, // ST_DATA_W=132
    output reg [88-1 : 0] src21_channel, // ST_CHANNEL_W=88
    output reg                      src21_startofpacket,
    output reg                      src21_endofpacket,
    input                           src21_ready,

    output reg                      src22_valid,
    output reg [132-1    : 0] src22_data, // ST_DATA_W=132
    output reg [88-1 : 0] src22_channel, // ST_CHANNEL_W=88
    output reg                      src22_startofpacket,
    output reg                      src22_endofpacket,
    input                           src22_ready,

    output reg                      src23_valid,
    output reg [132-1    : 0] src23_data, // ST_DATA_W=132
    output reg [88-1 : 0] src23_channel, // ST_CHANNEL_W=88
    output reg                      src23_startofpacket,
    output reg                      src23_endofpacket,
    input                           src23_ready,

    output reg                      src24_valid,
    output reg [132-1    : 0] src24_data, // ST_DATA_W=132
    output reg [88-1 : 0] src24_channel, // ST_CHANNEL_W=88
    output reg                      src24_startofpacket,
    output reg                      src24_endofpacket,
    input                           src24_ready,

    output reg                      src25_valid,
    output reg [132-1    : 0] src25_data, // ST_DATA_W=132
    output reg [88-1 : 0] src25_channel, // ST_CHANNEL_W=88
    output reg                      src25_startofpacket,
    output reg                      src25_endofpacket,
    input                           src25_ready,

    output reg                      src26_valid,
    output reg [132-1    : 0] src26_data, // ST_DATA_W=132
    output reg [88-1 : 0] src26_channel, // ST_CHANNEL_W=88
    output reg                      src26_startofpacket,
    output reg                      src26_endofpacket,
    input                           src26_ready,

    output reg                      src27_valid,
    output reg [132-1    : 0] src27_data, // ST_DATA_W=132
    output reg [88-1 : 0] src27_channel, // ST_CHANNEL_W=88
    output reg                      src27_startofpacket,
    output reg                      src27_endofpacket,
    input                           src27_ready,

    output reg                      src28_valid,
    output reg [132-1    : 0] src28_data, // ST_DATA_W=132
    output reg [88-1 : 0] src28_channel, // ST_CHANNEL_W=88
    output reg                      src28_startofpacket,
    output reg                      src28_endofpacket,
    input                           src28_ready,

    output reg                      src29_valid,
    output reg [132-1    : 0] src29_data, // ST_DATA_W=132
    output reg [88-1 : 0] src29_channel, // ST_CHANNEL_W=88
    output reg                      src29_startofpacket,
    output reg                      src29_endofpacket,
    input                           src29_ready,

    output reg                      src30_valid,
    output reg [132-1    : 0] src30_data, // ST_DATA_W=132
    output reg [88-1 : 0] src30_channel, // ST_CHANNEL_W=88
    output reg                      src30_startofpacket,
    output reg                      src30_endofpacket,
    input                           src30_ready,

    output reg                      src31_valid,
    output reg [132-1    : 0] src31_data, // ST_DATA_W=132
    output reg [88-1 : 0] src31_channel, // ST_CHANNEL_W=88
    output reg                      src31_startofpacket,
    output reg                      src31_endofpacket,
    input                           src31_ready,

    output reg                      src32_valid,
    output reg [132-1    : 0] src32_data, // ST_DATA_W=132
    output reg [88-1 : 0] src32_channel, // ST_CHANNEL_W=88
    output reg                      src32_startofpacket,
    output reg                      src32_endofpacket,
    input                           src32_ready,

    output reg                      src33_valid,
    output reg [132-1    : 0] src33_data, // ST_DATA_W=132
    output reg [88-1 : 0] src33_channel, // ST_CHANNEL_W=88
    output reg                      src33_startofpacket,
    output reg                      src33_endofpacket,
    input                           src33_ready,

    output reg                      src34_valid,
    output reg [132-1    : 0] src34_data, // ST_DATA_W=132
    output reg [88-1 : 0] src34_channel, // ST_CHANNEL_W=88
    output reg                      src34_startofpacket,
    output reg                      src34_endofpacket,
    input                           src34_ready,

    output reg                      src35_valid,
    output reg [132-1    : 0] src35_data, // ST_DATA_W=132
    output reg [88-1 : 0] src35_channel, // ST_CHANNEL_W=88
    output reg                      src35_startofpacket,
    output reg                      src35_endofpacket,
    input                           src35_ready,

    output reg                      src36_valid,
    output reg [132-1    : 0] src36_data, // ST_DATA_W=132
    output reg [88-1 : 0] src36_channel, // ST_CHANNEL_W=88
    output reg                      src36_startofpacket,
    output reg                      src36_endofpacket,
    input                           src36_ready,

    output reg                      src37_valid,
    output reg [132-1    : 0] src37_data, // ST_DATA_W=132
    output reg [88-1 : 0] src37_channel, // ST_CHANNEL_W=88
    output reg                      src37_startofpacket,
    output reg                      src37_endofpacket,
    input                           src37_ready,

    output reg                      src38_valid,
    output reg [132-1    : 0] src38_data, // ST_DATA_W=132
    output reg [88-1 : 0] src38_channel, // ST_CHANNEL_W=88
    output reg                      src38_startofpacket,
    output reg                      src38_endofpacket,
    input                           src38_ready,

    output reg                      src39_valid,
    output reg [132-1    : 0] src39_data, // ST_DATA_W=132
    output reg [88-1 : 0] src39_channel, // ST_CHANNEL_W=88
    output reg                      src39_startofpacket,
    output reg                      src39_endofpacket,
    input                           src39_ready,

    output reg                      src40_valid,
    output reg [132-1    : 0] src40_data, // ST_DATA_W=132
    output reg [88-1 : 0] src40_channel, // ST_CHANNEL_W=88
    output reg                      src40_startofpacket,
    output reg                      src40_endofpacket,
    input                           src40_ready,

    output reg                      src41_valid,
    output reg [132-1    : 0] src41_data, // ST_DATA_W=132
    output reg [88-1 : 0] src41_channel, // ST_CHANNEL_W=88
    output reg                      src41_startofpacket,
    output reg                      src41_endofpacket,
    input                           src41_ready,

    output reg                      src42_valid,
    output reg [132-1    : 0] src42_data, // ST_DATA_W=132
    output reg [88-1 : 0] src42_channel, // ST_CHANNEL_W=88
    output reg                      src42_startofpacket,
    output reg                      src42_endofpacket,
    input                           src42_ready,

    output reg                      src43_valid,
    output reg [132-1    : 0] src43_data, // ST_DATA_W=132
    output reg [88-1 : 0] src43_channel, // ST_CHANNEL_W=88
    output reg                      src43_startofpacket,
    output reg                      src43_endofpacket,
    input                           src43_ready,

    output reg                      src44_valid,
    output reg [132-1    : 0] src44_data, // ST_DATA_W=132
    output reg [88-1 : 0] src44_channel, // ST_CHANNEL_W=88
    output reg                      src44_startofpacket,
    output reg                      src44_endofpacket,
    input                           src44_ready,

    output reg                      src45_valid,
    output reg [132-1    : 0] src45_data, // ST_DATA_W=132
    output reg [88-1 : 0] src45_channel, // ST_CHANNEL_W=88
    output reg                      src45_startofpacket,
    output reg                      src45_endofpacket,
    input                           src45_ready,

    output reg                      src46_valid,
    output reg [132-1    : 0] src46_data, // ST_DATA_W=132
    output reg [88-1 : 0] src46_channel, // ST_CHANNEL_W=88
    output reg                      src46_startofpacket,
    output reg                      src46_endofpacket,
    input                           src46_ready,

    output reg                      src47_valid,
    output reg [132-1    : 0] src47_data, // ST_DATA_W=132
    output reg [88-1 : 0] src47_channel, // ST_CHANNEL_W=88
    output reg                      src47_startofpacket,
    output reg                      src47_endofpacket,
    input                           src47_ready,

    output reg                      src48_valid,
    output reg [132-1    : 0] src48_data, // ST_DATA_W=132
    output reg [88-1 : 0] src48_channel, // ST_CHANNEL_W=88
    output reg                      src48_startofpacket,
    output reg                      src48_endofpacket,
    input                           src48_ready,

    output reg                      src49_valid,
    output reg [132-1    : 0] src49_data, // ST_DATA_W=132
    output reg [88-1 : 0] src49_channel, // ST_CHANNEL_W=88
    output reg                      src49_startofpacket,
    output reg                      src49_endofpacket,
    input                           src49_ready,

    output reg                      src50_valid,
    output reg [132-1    : 0] src50_data, // ST_DATA_W=132
    output reg [88-1 : 0] src50_channel, // ST_CHANNEL_W=88
    output reg                      src50_startofpacket,
    output reg                      src50_endofpacket,
    input                           src50_ready,

    output reg                      src51_valid,
    output reg [132-1    : 0] src51_data, // ST_DATA_W=132
    output reg [88-1 : 0] src51_channel, // ST_CHANNEL_W=88
    output reg                      src51_startofpacket,
    output reg                      src51_endofpacket,
    input                           src51_ready,

    output reg                      src52_valid,
    output reg [132-1    : 0] src52_data, // ST_DATA_W=132
    output reg [88-1 : 0] src52_channel, // ST_CHANNEL_W=88
    output reg                      src52_startofpacket,
    output reg                      src52_endofpacket,
    input                           src52_ready,

    output reg                      src53_valid,
    output reg [132-1    : 0] src53_data, // ST_DATA_W=132
    output reg [88-1 : 0] src53_channel, // ST_CHANNEL_W=88
    output reg                      src53_startofpacket,
    output reg                      src53_endofpacket,
    input                           src53_ready,

    output reg                      src54_valid,
    output reg [132-1    : 0] src54_data, // ST_DATA_W=132
    output reg [88-1 : 0] src54_channel, // ST_CHANNEL_W=88
    output reg                      src54_startofpacket,
    output reg                      src54_endofpacket,
    input                           src54_ready,

    output reg                      src55_valid,
    output reg [132-1    : 0] src55_data, // ST_DATA_W=132
    output reg [88-1 : 0] src55_channel, // ST_CHANNEL_W=88
    output reg                      src55_startofpacket,
    output reg                      src55_endofpacket,
    input                           src55_ready,

    output reg                      src56_valid,
    output reg [132-1    : 0] src56_data, // ST_DATA_W=132
    output reg [88-1 : 0] src56_channel, // ST_CHANNEL_W=88
    output reg                      src56_startofpacket,
    output reg                      src56_endofpacket,
    input                           src56_ready,

    output reg                      src57_valid,
    output reg [132-1    : 0] src57_data, // ST_DATA_W=132
    output reg [88-1 : 0] src57_channel, // ST_CHANNEL_W=88
    output reg                      src57_startofpacket,
    output reg                      src57_endofpacket,
    input                           src57_ready,

    output reg                      src58_valid,
    output reg [132-1    : 0] src58_data, // ST_DATA_W=132
    output reg [88-1 : 0] src58_channel, // ST_CHANNEL_W=88
    output reg                      src58_startofpacket,
    output reg                      src58_endofpacket,
    input                           src58_ready,

    output reg                      src59_valid,
    output reg [132-1    : 0] src59_data, // ST_DATA_W=132
    output reg [88-1 : 0] src59_channel, // ST_CHANNEL_W=88
    output reg                      src59_startofpacket,
    output reg                      src59_endofpacket,
    input                           src59_ready,

    output reg                      src60_valid,
    output reg [132-1    : 0] src60_data, // ST_DATA_W=132
    output reg [88-1 : 0] src60_channel, // ST_CHANNEL_W=88
    output reg                      src60_startofpacket,
    output reg                      src60_endofpacket,
    input                           src60_ready,

    output reg                      src61_valid,
    output reg [132-1    : 0] src61_data, // ST_DATA_W=132
    output reg [88-1 : 0] src61_channel, // ST_CHANNEL_W=88
    output reg                      src61_startofpacket,
    output reg                      src61_endofpacket,
    input                           src61_ready,

    output reg                      src62_valid,
    output reg [132-1    : 0] src62_data, // ST_DATA_W=132
    output reg [88-1 : 0] src62_channel, // ST_CHANNEL_W=88
    output reg                      src62_startofpacket,
    output reg                      src62_endofpacket,
    input                           src62_ready,

    output reg                      src63_valid,
    output reg [132-1    : 0] src63_data, // ST_DATA_W=132
    output reg [88-1 : 0] src63_channel, // ST_CHANNEL_W=88
    output reg                      src63_startofpacket,
    output reg                      src63_endofpacket,
    input                           src63_ready,

    output reg                      src64_valid,
    output reg [132-1    : 0] src64_data, // ST_DATA_W=132
    output reg [88-1 : 0] src64_channel, // ST_CHANNEL_W=88
    output reg                      src64_startofpacket,
    output reg                      src64_endofpacket,
    input                           src64_ready,

    output reg                      src65_valid,
    output reg [132-1    : 0] src65_data, // ST_DATA_W=132
    output reg [88-1 : 0] src65_channel, // ST_CHANNEL_W=88
    output reg                      src65_startofpacket,
    output reg                      src65_endofpacket,
    input                           src65_ready,

    output reg                      src66_valid,
    output reg [132-1    : 0] src66_data, // ST_DATA_W=132
    output reg [88-1 : 0] src66_channel, // ST_CHANNEL_W=88
    output reg                      src66_startofpacket,
    output reg                      src66_endofpacket,
    input                           src66_ready,

    output reg                      src67_valid,
    output reg [132-1    : 0] src67_data, // ST_DATA_W=132
    output reg [88-1 : 0] src67_channel, // ST_CHANNEL_W=88
    output reg                      src67_startofpacket,
    output reg                      src67_endofpacket,
    input                           src67_ready,

    output reg                      src68_valid,
    output reg [132-1    : 0] src68_data, // ST_DATA_W=132
    output reg [88-1 : 0] src68_channel, // ST_CHANNEL_W=88
    output reg                      src68_startofpacket,
    output reg                      src68_endofpacket,
    input                           src68_ready,

    output reg                      src69_valid,
    output reg [132-1    : 0] src69_data, // ST_DATA_W=132
    output reg [88-1 : 0] src69_channel, // ST_CHANNEL_W=88
    output reg                      src69_startofpacket,
    output reg                      src69_endofpacket,
    input                           src69_ready,

    output reg                      src70_valid,
    output reg [132-1    : 0] src70_data, // ST_DATA_W=132
    output reg [88-1 : 0] src70_channel, // ST_CHANNEL_W=88
    output reg                      src70_startofpacket,
    output reg                      src70_endofpacket,
    input                           src70_ready,

    output reg                      src71_valid,
    output reg [132-1    : 0] src71_data, // ST_DATA_W=132
    output reg [88-1 : 0] src71_channel, // ST_CHANNEL_W=88
    output reg                      src71_startofpacket,
    output reg                      src71_endofpacket,
    input                           src71_ready,

    output reg                      src72_valid,
    output reg [132-1    : 0] src72_data, // ST_DATA_W=132
    output reg [88-1 : 0] src72_channel, // ST_CHANNEL_W=88
    output reg                      src72_startofpacket,
    output reg                      src72_endofpacket,
    input                           src72_ready,

    output reg                      src73_valid,
    output reg [132-1    : 0] src73_data, // ST_DATA_W=132
    output reg [88-1 : 0] src73_channel, // ST_CHANNEL_W=88
    output reg                      src73_startofpacket,
    output reg                      src73_endofpacket,
    input                           src73_ready,

    output reg                      src74_valid,
    output reg [132-1    : 0] src74_data, // ST_DATA_W=132
    output reg [88-1 : 0] src74_channel, // ST_CHANNEL_W=88
    output reg                      src74_startofpacket,
    output reg                      src74_endofpacket,
    input                           src74_ready,

    output reg                      src75_valid,
    output reg [132-1    : 0] src75_data, // ST_DATA_W=132
    output reg [88-1 : 0] src75_channel, // ST_CHANNEL_W=88
    output reg                      src75_startofpacket,
    output reg                      src75_endofpacket,
    input                           src75_ready,

    output reg                      src76_valid,
    output reg [132-1    : 0] src76_data, // ST_DATA_W=132
    output reg [88-1 : 0] src76_channel, // ST_CHANNEL_W=88
    output reg                      src76_startofpacket,
    output reg                      src76_endofpacket,
    input                           src76_ready,

    output reg                      src77_valid,
    output reg [132-1    : 0] src77_data, // ST_DATA_W=132
    output reg [88-1 : 0] src77_channel, // ST_CHANNEL_W=88
    output reg                      src77_startofpacket,
    output reg                      src77_endofpacket,
    input                           src77_ready,

    output reg                      src78_valid,
    output reg [132-1    : 0] src78_data, // ST_DATA_W=132
    output reg [88-1 : 0] src78_channel, // ST_CHANNEL_W=88
    output reg                      src78_startofpacket,
    output reg                      src78_endofpacket,
    input                           src78_ready,

    output reg                      src79_valid,
    output reg [132-1    : 0] src79_data, // ST_DATA_W=132
    output reg [88-1 : 0] src79_channel, // ST_CHANNEL_W=88
    output reg                      src79_startofpacket,
    output reg                      src79_endofpacket,
    input                           src79_ready,

    output reg                      src80_valid,
    output reg [132-1    : 0] src80_data, // ST_DATA_W=132
    output reg [88-1 : 0] src80_channel, // ST_CHANNEL_W=88
    output reg                      src80_startofpacket,
    output reg                      src80_endofpacket,
    input                           src80_ready,

    output reg                      src81_valid,
    output reg [132-1    : 0] src81_data, // ST_DATA_W=132
    output reg [88-1 : 0] src81_channel, // ST_CHANNEL_W=88
    output reg                      src81_startofpacket,
    output reg                      src81_endofpacket,
    input                           src81_ready,

    output reg                      src82_valid,
    output reg [132-1    : 0] src82_data, // ST_DATA_W=132
    output reg [88-1 : 0] src82_channel, // ST_CHANNEL_W=88
    output reg                      src82_startofpacket,
    output reg                      src82_endofpacket,
    input                           src82_ready,

    output reg                      src83_valid,
    output reg [132-1    : 0] src83_data, // ST_DATA_W=132
    output reg [88-1 : 0] src83_channel, // ST_CHANNEL_W=88
    output reg                      src83_startofpacket,
    output reg                      src83_endofpacket,
    input                           src83_ready,

    output reg                      src84_valid,
    output reg [132-1    : 0] src84_data, // ST_DATA_W=132
    output reg [88-1 : 0] src84_channel, // ST_CHANNEL_W=88
    output reg                      src84_startofpacket,
    output reg                      src84_endofpacket,
    input                           src84_ready,

    output reg                      src85_valid,
    output reg [132-1    : 0] src85_data, // ST_DATA_W=132
    output reg [88-1 : 0] src85_channel, // ST_CHANNEL_W=88
    output reg                      src85_startofpacket,
    output reg                      src85_endofpacket,
    input                           src85_ready,

    output reg                      src86_valid,
    output reg [132-1    : 0] src86_data, // ST_DATA_W=132
    output reg [88-1 : 0] src86_channel, // ST_CHANNEL_W=88
    output reg                      src86_startofpacket,
    output reg                      src86_endofpacket,
    input                           src86_ready,

    output reg                      src87_valid,
    output reg [132-1    : 0] src87_data, // ST_DATA_W=132
    output reg [88-1 : 0] src87_channel, // ST_CHANNEL_W=88
