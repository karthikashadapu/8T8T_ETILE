...
# ----------------------------------------
# If dma_subsystem is one of several IP cores in your
...
# ----------------------------------------
# ACDS 24.1 115 linux 2025.10.16.14:54:28
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "dma_subsystem.dma_subsystem"
}
...
append ELAB_OPTIONS [subst [dma_subsystem::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [dma_subsystem::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [dma_subsystem::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [dma_subsystem::normalize_path "$file"]
  set normalized_dest [dma_subsystem::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [dma_subsystem::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [dma_subsystem::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [dma_subsystem::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [dma_subsystem::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
