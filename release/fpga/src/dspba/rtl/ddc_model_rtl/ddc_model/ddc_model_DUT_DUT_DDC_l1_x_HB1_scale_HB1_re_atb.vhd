...
-- VHDL created from ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_re
...
entity ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_re_atb is
end;

architecture normal of ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_re_atb is

component ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_re is
    port (
...
component ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_re_stm is
    port (
...
dut : ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_re port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_re_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
