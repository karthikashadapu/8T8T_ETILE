...
if {! [file exists $base_dir/ddc_model_DUT_DUT_DDC_l1_x]} {
    file delete -force $base_dir/ddc_model_DUT_DUT_DDC_l1_x
}

project new $base_dir ddc_model_DUT_DUT_DDC_l1_x
...
do "$base_dir/ddc_model/ddc_model_DUT_DUT_DDC_l1_x_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ddc_model/ddc_model_DUT_DUT_DDC_l1_x_atb.vhd}
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_DDC_l1_x_atb.vhd vhdl
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_DDC_l1_x_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ddc_model_DUT_DUT_DDC_l1_x_atb $ll
    do $base_dir/ddc_model/ddc_model_DUT_DUT_DDC_l1_x_atb.wav.do
