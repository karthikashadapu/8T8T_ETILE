...
entity ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re_atb is
end;

architecture normal of ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re_atb is

component ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re is
    port (
...
component ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re_stm is
    port (
...
dut : ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re port map (
    in_2_dv_tpl_stm,
    in_3_dc_tpl_stm,
    in_1_d_tpl_stm,
...
sim : ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re_stm port map (
    in_2_dv_tpl_stm,
    in_3_dc_tpl_stm,
    in_1_d_tpl_stm,
    in_4_CoefBank_tpl_stm,
