...
if {! [file exists $base_dir/ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im]} {
    file delete -force $base_dir/ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im
}

project new $base_dir ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im
...
do "$base_dir/ddc_model/ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ddc_model/ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im_atb.vhd}
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im_atb.vhd vhdl
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im_atb $ll
    do $base_dir/ddc_model/ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im_atb.wav.do
