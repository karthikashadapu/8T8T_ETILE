...
if {! [file exists $base_dir/ddc_model_DUT_DUT_COMPLEX_MIXER1_ComplexMixer_Scale]} {
    file delete -force $base_dir/ddc_model_DUT_DUT_COMPLEX_MIXER1_ComplexMixer_Scale
}

project new $base_dir ddc_model_DUT_DUT_COMPLEX_MIXER1_ComplexMixer_Scale
...
do "$base_dir/ddc_model/ddc_model_DUT_DUT_COMPLEX_MIXER1_ComplexMixer_Scale_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ddc_model/ddc_model_DUT_DUT_COMPLEX_MIXER1_ComplexMixer_Scale_atb.vhd}
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_COMPLEX_MIXER1_ComplexMixer_Scale_atb.vhd vhdl
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_COMPLEX_MIXER1_ComplexMixer_Scale_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ddc_model_DUT_DUT_COMPLEX_MIXER1_ComplexMixer_Scale_atb $ll
    do $base_dir/ddc_model/ddc_model_DUT_DUT_COMPLEX_MIXER1_ComplexMixer_Scale_atb.wav.do
