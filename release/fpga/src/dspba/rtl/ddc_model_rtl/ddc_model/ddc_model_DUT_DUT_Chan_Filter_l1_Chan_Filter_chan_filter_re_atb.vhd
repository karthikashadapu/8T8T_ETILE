...
entity ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_re_atb is
end;

architecture normal of ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_re_atb is

component ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_re is
    port (
...
component ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_re_stm is
    port (
...
dut : ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_re port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    bankIn_0_stm,
...
sim : ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_re_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    bankIn_0_stm,
