...
if {! [file exists $base_dir/ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re1]} {
    file delete -force $base_dir/ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re1
}

project new $base_dir ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re1
...
do "$base_dir/ddc_model/ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re1_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ddc_model/ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re1_atb.vhd}
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re1_atb.vhd vhdl
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re1_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_q0_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_4_q1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_4_q1_tpl $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re1_atb $ll
    do $base_dir/ddc_model/ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re1_atb.wav.do
