...
entity ddc_model_DUT_DUT_COMPLEX_MIXER1_Complex_NCO_atb is
end;

architecture normal of ddc_model_DUT_DUT_COMPLEX_MIXER1_Complex_NCO_atb is

component ddc_model_DUT_DUT_COMPLEX_MIXER1_Complex_NCO is
    port (
...
component ddc_model_DUT_DUT_COMPLEX_MIXER1_Complex_NCO_stm is
    port (
...
dut : ddc_model_DUT_DUT_COMPLEX_MIXER1_Complex_NCO port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_p_0_stm,
    xIn_p_1_stm,
...
sim : ddc_model_DUT_DUT_COMPLEX_MIXER1_Complex_NCO_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_p_0_stm,
    xIn_p_1_stm,
