...
if {! [file exists $base_dir/ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig]} {
    file delete -force $base_dir/ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig
}

project new $base_dir ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig
...
do "$base_dir/ddc_model/ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ddc_model/ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig_atb.vhd}
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig_atb.vhd vhdl
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_real_d1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_real_d1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_imag_d1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_imag_d1_tpl $cyclenum
            }
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig_atb $ll
    do $base_dir/ddc_model/ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig_atb.wav.do
