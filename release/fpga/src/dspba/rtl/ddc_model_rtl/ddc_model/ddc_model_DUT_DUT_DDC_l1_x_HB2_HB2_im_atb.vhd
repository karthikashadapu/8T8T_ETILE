...
-- VHDL created from ddc_model_DUT_DUT_DDC_l1_x_HB2_HB2_im
...
entity ddc_model_DUT_DUT_DDC_l1_x_HB2_HB2_im_atb is
end;

architecture normal of ddc_model_DUT_DUT_DDC_l1_x_HB2_HB2_im_atb is

component ddc_model_DUT_DUT_DDC_l1_x_HB2_HB2_im is
    port (
        ...
        xOut_1 : out std_logic_vector(36 downto 0);  -- sfix37
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component ddc_model_DUT_DUT_DDC_l1_x_HB2_HB2_im_stm is
    port (
        ...
        xOut_1_stm : out std_logic_vector(36 downto 0);
        clk : out std_logic;
...
signal xOut_1_stm : STD_LOGIC_VECTOR (36 downto 0);
...
signal xOut_1_dut : STD_LOGIC_VECTOR (36 downto 0);
...
checkxOut : process (clk, areset, xOut_0_dut, xOut_0_stm, xOut_1_dut, xOut_1_stm)
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ((xOut_v_dut = "1")) THEN
            ...
            END IF;
        END IF;
        IF (mismatch_xOut_v = TRUE or mismatch_xOut_c = TRUE or mismatch_xOut_0 = TRUE or mismatch_xOut_1 = TRUE) THEN
            ok := FALSE;
        END IF;
        IF (ok = FALSE) THEN
...
dut : ddc_model_DUT_DUT_DDC_l1_x_HB2_HB2_im port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
...
sim : ddc_model_DUT_DUT_DDC_l1_x_HB2_HB2_im_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
