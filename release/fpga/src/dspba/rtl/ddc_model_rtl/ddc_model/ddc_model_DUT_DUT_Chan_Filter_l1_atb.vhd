...
-- VHDL created from ddc_model_DUT_DUT_Chan_Filter_l1
...
entity ddc_model_DUT_DUT_Chan_Filter_l1_atb is
end;

architecture normal of ddc_model_DUT_DUT_Chan_Filter_l1_atb is

component ddc_model_DUT_DUT_Chan_Filter_l1 is
    port (
        ...
        in_4_BW_c1_tpl : in std_logic_vector(7 downto 0);  -- ufix8
...
component ddc_model_DUT_DUT_Chan_Filter_l1_stm is
    port (
        ...
        in_4_BW_c1_tpl_stm : out std_logic_vector(7 downto 0);
...
signal in_4_BW_c1_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
...
signal in_4_BW_c1_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
...
-- General Purpose data in real output
checkin_4_BW_c1_tpl : process (clk, areset, in_4_BW_c1_tpl_dut, in_4_BW_c1_tpl_stm)
begin
END PROCESS;


dut : ddc_model_DUT_DUT_Chan_Filter_l1 port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
...
sim : ddc_model_DUT_DUT_Chan_Filter_l1_stm port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
