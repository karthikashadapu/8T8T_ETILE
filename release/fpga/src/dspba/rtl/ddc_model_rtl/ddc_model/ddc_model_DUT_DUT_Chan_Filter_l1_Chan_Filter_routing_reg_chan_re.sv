...
// SystemVerilog created from ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re
...
module ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_routing_reg_chan_re (
