...
if {! [file exists $base_dir/ddc_model_DUT_DUT_COMPLEX_MIXER1]} {
    file delete -force $base_dir/ddc_model_DUT_DUT_COMPLEX_MIXER1
}

project new $base_dir ddc_model_DUT_DUT_COMPLEX_MIXER1
...
do "$base_dir/ddc_model/ddc_model_DUT_DUT_COMPLEX_MIXER1_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ddc_model/ddc_model_DUT_DUT_COMPLEX_MIXER1_atb.vhd}
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_COMPLEX_MIXER1_atb.vhd vhdl
project addfile $base_dir/ddc_model/ddc_model_DUT_DUT_COMPLEX_MIXER1_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_0_imag_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_0_imag_q0_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_0_real_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_0_real_q0_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_1_imag_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_1_imag_q0_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_1_real_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_1_real_q0_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_2_imag_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_2_imag_q0_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_2_real_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_2_real_q0_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_3_imag_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_3_imag_q0_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_3_real_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_3_real_q0_tpl $cyclenum
            }
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ddc_model_DUT_DUT_COMPLEX_MIXER1_atb $ll
    do $base_dir/ddc_model/ddc_model_DUT_DUT_COMPLEX_MIXER1_atb.wav.do
