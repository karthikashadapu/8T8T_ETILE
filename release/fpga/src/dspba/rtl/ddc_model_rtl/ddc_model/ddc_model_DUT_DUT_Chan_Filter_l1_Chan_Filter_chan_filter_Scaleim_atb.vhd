...
-- VHDL created from ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scaleim
...
entity ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scaleim_atb is
end;

architecture normal of ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scaleim_atb is

component ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scaleim is
    port (
...
component ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scaleim_stm is
    port (
...
dut : ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scaleim port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scaleim_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
