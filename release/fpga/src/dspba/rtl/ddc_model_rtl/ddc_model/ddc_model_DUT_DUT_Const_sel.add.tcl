# This is the Quartus file list for 'ddc_model_DUT_DUT_Const_sel'
...
set_global_assignment -name SYSTEMVERILOG_FILE ../../rtl/ddc_model_rtl/ddc_model/ddc_model_DUT_DUT_Const_sel.sv
