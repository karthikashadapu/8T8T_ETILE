...
// SystemVerilog created from ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scaleim
...
module ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scaleim (
