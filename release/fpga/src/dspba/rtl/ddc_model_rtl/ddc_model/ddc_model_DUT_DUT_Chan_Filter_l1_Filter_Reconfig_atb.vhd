...
-- VHDL created from ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig
...
entity ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig_atb is
end;

architecture normal of ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig_atb is

component ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig is
    port (
        ...
        in_4_BWconfig_C1_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        out_2_Out4_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_3_Out6_tpl : out std_logic_vector(7 downto 0);  -- ufix8
        out_1_real_d1_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en14
        out_1_imag_d1_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en14
...
component ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig_stm is
    port (
        ...
        in_4_BWconfig_C1_tpl_stm : out std_logic_vector(7 downto 0);
        out_2_Out4_tpl_stm : out std_logic_vector(0 downto 0);
        out_3_Out6_tpl_stm : out std_logic_vector(7 downto 0);
        out_1_real_d1_tpl_stm : out std_logic_vector(15 downto 0);
        out_1_imag_d1_tpl_stm : out std_logic_vector(15 downto 0);
...
signal in_4_BWconfig_C1_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal out_2_Out4_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_3_Out6_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal out_1_real_d1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal out_1_imag_d1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
...
signal in_4_BWconfig_C1_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal out_2_Out4_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_3_Out6_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal out_1_real_d1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal out_1_imag_d1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
...
checkChannelIn_cunroll_x : process (clk, areset, in_1_real_In1_tpl_dut, in_1_real_In1_tpl_stm, in_1_imag_In1_tpl_dut, in_1_imag_In1_tpl_stm, in_4_BWconfig_C1_tpl_dut, in_4_BWconfig_C1_tpl_stm)
begin
END PROCESS;


-- Channelized data out check
checkChannelOut_cunroll_x : process (clk, areset, out_1_real_d1_tpl_dut, out_1_real_d1_tpl_stm, out_1_imag_d1_tpl_dut, out_1_imag_d1_tpl_stm, out_4_CoefBankSel_tpl_dut, out_4_CoefBankSel_tpl_stm)
variable mismatch_out_2_Out4_tpl : BOOLEAN := FALSE;
variable mismatch_out_3_Out6_tpl : BOOLEAN := FALSE;
variable mismatch_out_1_real_d1_tpl : BOOLEAN := FALSE;
variable mismatch_out_1_imag_d1_tpl : BOOLEAN := FALSE;
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        mismatch_out_1_real_d1_tpl := FALSE;
        mismatch_out_1_imag_d1_tpl := FALSE;
        ...
        IF ((out_2_Out4_tpl_dut = "1")) THEN
            ...
            END IF;
            IF ( (out_1_real_d1_tpl_dut /= out_1_real_d1_tpl_stm)) THEN
                mismatch_out_1_real_d1_tpl := TRUE;
                report "mismatch in out_1_real_d1_tpl signal" severity Warning;
            END IF;
            IF ( (out_1_imag_d1_tpl_dut /= out_1_imag_d1_tpl_stm)) THEN
                mismatch_out_1_imag_d1_tpl := TRUE;
                report "mismatch in out_1_imag_d1_tpl signal" severity Warning;
            END IF;
            ...
            END IF;
        END IF;
        IF (mismatch_out_2_Out4_tpl = TRUE or mismatch_out_3_Out6_tpl = TRUE or mismatch_out_1_real_d1_tpl = TRUE or mismatch_out_1_imag_d1_tpl = TRUE or mismatch_out_4_CoefBankSel_tpl = TRUE) THEN
            ok := FALSE;
        END IF;
        IF (ok = FALSE) THEN
...
dut : ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig port map (
    in_2_v_tpl_stm,
    in_3_c_tpl_stm,
    in_1_real_In1_tpl_stm,
    in_1_imag_In1_tpl_stm,
    in_4_BWconfig_C1_tpl_stm,
    out_2_Out4_tpl_dut,
    out_3_Out6_tpl_dut,
    out_1_real_d1_tpl_dut,
    out_1_imag_d1_tpl_dut,
    out_4_CoefBankSel_tpl_dut,
        clk,
        areset
);

sim : ddc_model_DUT_DUT_Chan_Filter_l1_Filter_Reconfig_stm port map (
    in_2_v_tpl_stm,
    in_3_c_tpl_stm,
    in_1_real_In1_tpl_stm,
    in_1_imag_In1_tpl_stm,
    ...
    out_2_Out4_tpl_stm,
    out_3_Out6_tpl_stm,
    out_1_real_d1_tpl_stm,
    out_1_imag_d1_tpl_stm,
