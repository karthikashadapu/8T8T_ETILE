...
-- VHDL created from ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scale_re
...
entity ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scale_re_atb is
end;

architecture normal of ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scale_re_atb is

component ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scale_re is
    port (
        xIn_v : in std_logic_vector(0 downto 0);  -- sfix1
        xIn_c : in std_logic_vector(7 downto 0);  -- sfix8
        xIn_0 : in std_logic_vector(40 downto 0);  -- sfix41
...
component ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scale_re_stm is
    port (
        xIn_v_stm : out std_logic_vector(0 downto 0);
        xIn_c_stm : out std_logic_vector(7 downto 0);
        xIn_0_stm : out std_logic_vector(40 downto 0);
...
signal xIn_0_stm : STD_LOGIC_VECTOR (40 downto 0);
...
signal xIn_0_dut : STD_LOGIC_VECTOR (40 downto 0);
...
dut : ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scale_re port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_chan_filter_Scale_re_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
