...
-- VHDL created from ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter
...
entity ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_atb is
end;

architecture normal of ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_atb is

component ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter is
    port (
        ...
        in_1_imag_d1_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en14
        in_1_real_d1_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en14
        in_2_v_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_3_c_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_4_bank_tpl : in std_logic_vector(0 downto 0);  -- ufix1
...
component ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_stm is
    port (
        ...
        in_1_imag_d1_tpl_stm : out std_logic_vector(15 downto 0);
        in_1_real_d1_tpl_stm : out std_logic_vector(15 downto 0);
        in_2_v_tpl_stm : out std_logic_vector(0 downto 0);
        in_3_c_tpl_stm : out std_logic_vector(7 downto 0);
        in_4_bank_tpl_stm : out std_logic_vector(0 downto 0);
...
signal in_1_imag_d1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_1_real_d1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_2_v_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_3_c_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal in_4_bank_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
...
signal in_1_imag_d1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_1_real_d1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_2_v_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_3_c_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal in_4_bank_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
...
checkin_1_imag_d1_tpl : process (clk, areset, in_1_imag_d1_tpl_dut, in_1_imag_d1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_1_real_d1_tpl : process (clk, areset, in_1_real_d1_tpl_dut, in_1_real_d1_tpl_stm)
begin
END PROCESS;
...
-- General Purpose data in real output
checkin_4_bank_tpl : process (clk, areset, in_4_bank_tpl_dut, in_4_bank_tpl_stm)
begin
END PROCESS;


dut : ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
    ...
    busOut_readdata_dut,
    in_1_imag_d1_tpl_stm,
    in_1_real_d1_tpl_stm,
    in_2_v_tpl_stm,
    in_3_c_tpl_stm,
    in_4_bank_tpl_stm,
...
sim : ddc_model_DUT_DUT_Chan_Filter_l1_Chan_Filter_stm port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
