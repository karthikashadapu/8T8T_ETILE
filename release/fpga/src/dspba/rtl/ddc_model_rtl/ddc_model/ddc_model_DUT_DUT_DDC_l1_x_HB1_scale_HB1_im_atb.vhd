...
-- VHDL created from ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im
...
entity ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im_atb is
end;

architecture normal of ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im_atb is

component ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im is
    port (
...
component ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im_stm is
    port (
...
dut : ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : ddc_model_DUT_DUT_DDC_l1_x_HB1_scale_HB1_im_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
