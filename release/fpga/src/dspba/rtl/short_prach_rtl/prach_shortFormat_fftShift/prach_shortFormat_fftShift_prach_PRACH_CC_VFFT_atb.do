...
if {! [file exists $base_dir/prach_shortFormat_fftShift_prach_PRACH_CC_VFFT]} {
    file delete -force $base_dir/prach_shortFormat_fftShift_prach_PRACH_CC_VFFT
}

project new $base_dir prach_shortFormat_fftShift_prach_PRACH_CC_VFFT
...
do "$base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_VFFT_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_VFFT_atb.vhd}
project addfile $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_VFFT_atb.vhd vhdl
project addfile $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_VFFT_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_3_qsize_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_qsize_tpl $cyclenum
            }
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps prach_shortFormat_fftShift_prach_PRACH_CC_VFFT_atb $ll
    do $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_VFFT_atb.wav.do
