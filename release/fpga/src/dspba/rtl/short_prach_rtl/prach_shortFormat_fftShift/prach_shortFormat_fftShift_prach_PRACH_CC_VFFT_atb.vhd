...
entity prach_shortFormat_fftShift_prach_PRACH_CC_VFFT_atb is
end;

architecture normal of prach_shortFormat_fftShift_prach_PRACH_CC_VFFT_atb is

component prach_shortFormat_fftShift_prach_PRACH_CC_VFFT is
    port (
        ...
        in_5_BWby10_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_6_TimeReference_tpl : in std_logic_vector(28 downto 0);  -- ufix29
        ...
        out_4_real_q_tpl : out std_logic_vector(28 downto 0);  -- sfix29_en15
        out_4_imag_q_tpl : out std_logic_vector(28 downto 0);  -- sfix29_en15
...
component prach_shortFormat_fftShift_prach_PRACH_CC_VFFT_stm is
    port (
...
signal in_5_BWby10_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal in_6_TimeReference_tpl_stm : STD_LOGIC_VECTOR (28 downto 0);
...
signal in_5_BWby10_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal in_6_TimeReference_tpl_dut : STD_LOGIC_VECTOR (28 downto 0);
...
checkChannelIn_cunroll_x : process (clk, areset, in_3_size_tpl_dut, in_3_size_tpl_stm, in_4_real_d_tpl_dut, in_4_real_d_tpl_stm, in_4_imag_d_tpl_dut, in_4_imag_d_tpl_stm, in_5_BWby10_tpl_dut, in_5_BWby10_tpl_stm, in_6_TimeReference_tpl_dut, in_6_TimeReference_tpl_stm)
begin
END PROCESS;


-- Channelized data out check
checkChannelOut1_cunroll_x : process (clk, areset, out_3_qsize_tpl_dut, out_3_qsize_tpl_stm, out_4_real_q_tpl_dut, out_4_real_q_tpl_stm, out_4_imag_q_tpl_dut, out_4_imag_q_tpl_stm, out_5_qBWby10_tpl_dut, out_5_qBWby10_tpl_stm, out_6_Tref_tpl_dut, out_6_Tref_tpl_stm)
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ((out_1_qv_tpl_dut = "1")) THEN
            ...
            END IF;
        END IF;
        IF (mismatch_out_1_qv_tpl = TRUE or mismatch_out_2_qc_tpl = TRUE or mismatch_out_3_qsize_tpl = TRUE or mismatch_out_4_real_q_tpl = TRUE or mismatch_out_4_imag_q_tpl = TRUE or mismatch_out_5_qBWby10_tpl = TRUE or mismatch_out_6_Tref_tpl = TRUE) THEN
            ok := FALSE;
        END IF;
        IF (ok = FALSE) THEN
...
dut : prach_shortFormat_fftShift_prach_PRACH_CC_VFFT port map (
    in_1_v_tpl_stm,
    in_2_c_tpl_stm,
    in_3_size_tpl_stm,
    in_4_real_d_tpl_stm,
...
sim : prach_shortFormat_fftShift_prach_PRACH_CC_VFFT_stm port map (
    in_1_v_tpl_stm,
    in_2_c_tpl_stm,
    in_3_size_tpl_stm,
    in_4_real_d_tpl_stm,
