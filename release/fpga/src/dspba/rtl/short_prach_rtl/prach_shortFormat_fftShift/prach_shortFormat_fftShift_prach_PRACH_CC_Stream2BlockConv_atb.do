...
if {! [file exists $base_dir/prach_shortFormat_fftShift_prach_PRACH_CC_Stream2BlockConv]} {
    file delete -force $base_dir/prach_shortFormat_fftShift_prach_PRACH_CC_Stream2BlockConv
}

project new $base_dir prach_shortFormat_fftShift_prach_PRACH_CC_Stream2BlockConv
...
do "$base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_Stream2BlockConv_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_Stream2BlockConv_atb.vhd}
project addfile $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_Stream2BlockConv_atb.vhd vhdl
project addfile $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_Stream2BlockConv_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_3_qFFTSize_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_qFFTSize_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_4_real_q_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_4_real_q_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_4_imag_q_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_4_imag_q_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_5_qBWby10_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_5_qBWby10_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_6_Tref_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_6_Tref_tpl $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps prach_shortFormat_fftShift_prach_PRACH_CC_Stream2BlockConv_atb $ll
    do $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_Stream2BlockConv_atb.wav.do
