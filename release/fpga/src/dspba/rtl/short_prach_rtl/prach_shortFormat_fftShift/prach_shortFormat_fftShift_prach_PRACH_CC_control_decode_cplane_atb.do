...
if {! [file exists $base_dir/prach_shortFormat_fftShift_prach_PRACH_CC_control_decode_cplane]} {
    file delete -force $base_dir/prach_shortFormat_fftShift_prach_PRACH_CC_control_decode_cplane
}

project new $base_dir prach_shortFormat_fftShift_prach_PRACH_CC_control_decode_cplane
...
do "$base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_control_decode_cplane_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_control_decode_cplane_atb.vhd}
project addfile $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_control_decode_cplane_atb.vhd vhdl
project addfile $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_control_decode_cplane_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps prach_shortFormat_fftShift_prach_PRACH_CC_control_decode_cplane_atb $ll
    do $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_control_decode_cplane_atb.wav.do
