...
if {! [file exists $base_dir/prach_shortFormat_fftShift_prach_PRACH_CC_gain]} {
    file delete -force $base_dir/prach_shortFormat_fftShift_prach_PRACH_CC_gain
}

project new $base_dir prach_shortFormat_fftShift_prach_PRACH_CC_gain
...
do "$base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_gain_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_gain_atb.vhd}
project addfile $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_gain_atb.vhd vhdl
project addfile $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_gain_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps prach_shortFormat_fftShift_prach_PRACH_CC_gain_atb $ll
    do $base_dir/prach_shortFormat_fftShift/prach_shortFormat_fftShift_prach_PRACH_CC_gain_atb.wav.do
