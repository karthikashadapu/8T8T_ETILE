...
-- VHDL created from prach_shortFormat_fftShift_prach_PRACH_CC_RemoveCP
...
entity prach_shortFormat_fftShift_prach_PRACH_CC_RemoveCP_atb is
end;

architecture normal of prach_shortFormat_fftShift_prach_PRACH_CC_RemoveCP_atb is

component prach_shortFormat_fftShift_prach_PRACH_CC_RemoveCP is
    port (
        in_2_vin_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_3_chin_tpl : in std_logic_vector(7 downto 0);  -- sfix8
        ...
        in_4_CPLen_tpl : in std_logic_vector(25 downto 0);  -- ufix26
        in_5_FFTSize_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        in_6_NumberOfFFTs_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        in_7_SOP_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_8_BW_x_10_x_tpl : in std_logic_vector(7 downto 0);  -- ufix8
...
component prach_shortFormat_fftShift_prach_PRACH_CC_RemoveCP_stm is
    port (
        ...
        in_4_CPLen_tpl_stm : out std_logic_vector(25 downto 0);
        in_5_FFTSize_tpl_stm : out std_logic_vector(3 downto 0);
        in_6_NumberOfFFTs_tpl_stm : out std_logic_vector(3 downto 0);
        in_7_SOP_tpl_stm : out std_logic_vector(0 downto 0);
        in_8_BW_x_10_x_tpl_stm : out std_logic_vector(7 downto 0);
...
signal in_4_CPLen_tpl_stm : STD_LOGIC_VECTOR (25 downto 0);
signal in_5_FFTSize_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal in_6_NumberOfFFTs_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal in_7_SOP_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_8_BW_x_10_x_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
...
signal in_4_CPLen_tpl_dut : STD_LOGIC_VECTOR (25 downto 0);
signal in_5_FFTSize_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal in_6_NumberOfFFTs_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal in_7_SOP_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_8_BW_x_10_x_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
...
checkChannelIn_cunroll_x : process (clk, areset, in_1_real_din_tpl_dut, in_1_real_din_tpl_stm, in_1_imag_din_tpl_dut, in_1_imag_din_tpl_stm, in_4_CPLen_tpl_dut, in_4_CPLen_tpl_stm, in_5_FFTSize_tpl_dut, in_5_FFTSize_tpl_stm, in_6_NumberOfFFTs_tpl_dut, in_6_NumberOfFFTs_tpl_stm, in_7_SOP_tpl_dut, in_7_SOP_tpl_stm, in_8_BW_x_10_x_tpl_dut, in_8_BW_x_10_x_tpl_stm, in_9_TimeReference_tpl_dut, in_9_TimeReference_tpl_stm)
begin
END PROCESS;


-- Channelized data out check
checkChannelOut_cunroll_x : process (clk, areset, out_3_real_dout_tpl_dut, out_3_real_dout_tpl_stm, out_3_imag_dout_tpl_dut, out_3_imag_dout_tpl_stm, out_4_qFFTSize_tpl_dut, out_4_qFFTSize_tpl_stm, out_5_qSOP_tpl_dut, out_5_qSOP_tpl_stm, out_6_qBWby10_tpl_dut, out_6_qBWby10_tpl_stm, out_7_T_ref_tpl_dut, out_7_T_ref_tpl_stm)
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ((out_1_vout_tpl_dut = "1")) THEN
            ...
            END IF;
        END IF;
        IF (mismatch_out_1_vout_tpl = TRUE or mismatch_out_2_cout_tpl = TRUE or mismatch_out_3_real_dout_tpl = TRUE or mismatch_out_3_imag_dout_tpl = TRUE or mismatch_out_4_qFFTSize_tpl = TRUE or mismatch_out_5_qSOP_tpl = TRUE or mismatch_out_6_qBWby10_tpl = TRUE or mismatch_out_7_T_ref_tpl = TRUE) THEN
            ok := FALSE;
        END IF;
        IF (ok = FALSE) THEN
...
dut : prach_shortFormat_fftShift_prach_PRACH_CC_RemoveCP port map (
    in_2_vin_tpl_stm,
    in_3_chin_tpl_stm,
    in_1_real_din_tpl_stm,
    in_1_imag_din_tpl_stm,
    in_4_CPLen_tpl_stm,
    in_5_FFTSize_tpl_stm,
    in_6_NumberOfFFTs_tpl_stm,
    in_7_SOP_tpl_stm,
    in_8_BW_x_10_x_tpl_stm,
...
sim : prach_shortFormat_fftShift_prach_PRACH_CC_RemoveCP_stm port map (
    in_2_vin_tpl_stm,
    in_3_chin_tpl_stm,
    in_1_real_din_tpl_stm,
    in_1_imag_din_tpl_stm,
