...
entity streamtoblock_fft_DUT_S2B_FFT_PC_atb is
end;

architecture normal of streamtoblock_fft_DUT_S2B_FFT_PC_atb is

component streamtoblock_fft_DUT_S2B_FFT_PC is
    port (
        ...
        in_1_rx_vin1_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_2_rx_chin1_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_3_imag_rx_din1_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en14
        in_3_real_rx_din1_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en14
        in_4_fft_in1_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        in_5_cp_in1_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_6_nprb1_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_7_hcs_bypass_l1_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_8_fft_gain_l1_tpl : in std_logic_vector(15 downto 0);  -- ufix16_en14
        in_9_fft_gain_im_l1_tpl : in std_logic_vector(15 downto 0);  -- ufix16_en14
        in_10_fft_shift_l1_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        in_11_time_ref_in1_tpl : in std_logic_vector(63 downto 0);  -- ufix64
        in_12_DC_SC_EN_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_13_CP_EN1_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_14_ripple_comp_en_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_15_rc_bw_sel_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_16_sym_metadata_in_tpl : in std_logic_vector(63 downto 0);  -- ufix64
        in_17_sym_metadata_in_valid_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        ...
        out_1_rx_valid_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_2_rx_chout_tpl : out std_logic_vector(7 downto 0);  -- ufix8
        out_3_imag_rx_dout_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en11
        out_3_real_rx_dout_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en11
        out_4_rx_time_out_tpl : out std_logic_vector(63 downto 0);  -- ufix64
        out_5_td_fft_in_v_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_6_td_fft_in_chout_tpl : out std_logic_vector(7 downto 0);  -- ufix8
        ...
        out_11_fd_data_v_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_12_fd_data_c_tpl : out std_logic_vector(7 downto 0);  -- ufix8
        out_13_imag_fd_data_q_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en12
        out_13_real_fd_data_q_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en12
        out_14_eAxCout_tpl : out std_logic_vector(1 downto 0);  -- ufix2
        out_15_symmetadataout_tpl : out std_logic_vector(63 downto 0);  -- ufix64
        out_16_eop_eAxC_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_17_eop_sym_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_18_sop_eAxC_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_19_sop_sym_tpl : out std_logic_vector(0 downto 0);  -- ufix1
...
component streamtoblock_fft_DUT_S2B_FFT_PC_stm is
    port (
...
signal in_1_rx_vin1_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_2_rx_chin1_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal in_3_imag_rx_din1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_3_real_rx_din1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_4_fft_in1_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal in_5_cp_in1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_6_nprb1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_7_hcs_bypass_l1_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_8_fft_gain_l1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_9_fft_gain_im_l1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_10_fft_shift_l1_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal in_11_time_ref_in1_tpl_stm : STD_LOGIC_VECTOR (63 downto 0);
signal in_12_DC_SC_EN_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_13_CP_EN1_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_14_ripple_comp_en_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_15_rc_bw_sel_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_16_sym_metadata_in_tpl_stm : STD_LOGIC_VECTOR (63 downto 0);
signal in_17_sym_metadata_in_valid_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
...
signal out_1_rx_valid_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_2_rx_chout_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_imag_rx_dout_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal out_3_real_rx_dout_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
...
signal out_6_td_fft_in_chout_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
...
signal out_11_fd_data_v_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_12_fd_data_c_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal out_13_imag_fd_data_q_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal out_13_real_fd_data_q_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal out_14_eAxCout_tpl_stm : STD_LOGIC_VECTOR (1 downto 0);
signal out_15_symmetadataout_tpl_stm : STD_LOGIC_VECTOR (63 downto 0);
signal out_16_eop_eAxC_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_17_eop_sym_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_18_sop_eAxC_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_19_sop_sym_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
...
signal in_1_rx_vin1_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_2_rx_chin1_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal in_3_imag_rx_din1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_3_real_rx_din1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_4_fft_in1_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal in_5_cp_in1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_6_nprb1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_7_hcs_bypass_l1_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_8_fft_gain_l1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_9_fft_gain_im_l1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_10_fft_shift_l1_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal in_11_time_ref_in1_tpl_dut : STD_LOGIC_VECTOR (63 downto 0);
signal in_12_DC_SC_EN_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_13_CP_EN1_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_14_ripple_comp_en_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_15_rc_bw_sel_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_16_sym_metadata_in_tpl_dut : STD_LOGIC_VECTOR (63 downto 0);
signal in_17_sym_metadata_in_valid_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
...
signal out_1_rx_valid_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_2_rx_chout_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_imag_rx_dout_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal out_3_real_rx_dout_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
...
signal out_6_td_fft_in_chout_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
...
signal out_11_fd_data_v_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_12_fd_data_c_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal out_13_imag_fd_data_q_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal out_13_real_fd_data_q_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal out_14_eAxCout_tpl_dut : STD_LOGIC_VECTOR (1 downto 0);
signal out_15_symmetadataout_tpl_dut : STD_LOGIC_VECTOR (63 downto 0);
signal out_16_eop_eAxC_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_17_eop_sym_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_18_sop_eAxC_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_19_sop_sym_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
...
checkin_1_rx_vin1_tpl : process (clk, areset, in_1_rx_vin1_tpl_dut, in_1_rx_vin1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_2_rx_chin1_tpl : process (clk, areset, in_2_rx_chin1_tpl_dut, in_2_rx_chin1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_3_imag_rx_din1_tpl : process (clk, areset, in_3_imag_rx_din1_tpl_dut, in_3_imag_rx_din1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_3_real_rx_din1_tpl : process (clk, areset, in_3_real_rx_din1_tpl_dut, in_3_real_rx_din1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_4_fft_in1_tpl : process (clk, areset, in_4_fft_in1_tpl_dut, in_4_fft_in1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_5_cp_in1_tpl : process (clk, areset, in_5_cp_in1_tpl_dut, in_5_cp_in1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_6_nprb1_tpl : process (clk, areset, in_6_nprb1_tpl_dut, in_6_nprb1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_7_hcs_bypass_l1_tpl : process (clk, areset, in_7_hcs_bypass_l1_tpl_dut, in_7_hcs_bypass_l1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_8_fft_gain_l1_tpl : process (clk, areset, in_8_fft_gain_l1_tpl_dut, in_8_fft_gain_l1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_9_fft_gain_im_l1_tpl : process (clk, areset, in_9_fft_gain_im_l1_tpl_dut, in_9_fft_gain_im_l1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_10_fft_shift_l1_tpl : process (clk, areset, in_10_fft_shift_l1_tpl_dut, in_10_fft_shift_l1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_11_time_ref_in1_tpl : process (clk, areset, in_11_time_ref_in1_tpl_dut, in_11_time_ref_in1_tpl_stm)
begin
END PROCESS;
...
-- General Purpose data in real output
checkin_13_CP_EN1_tpl : process (clk, areset, in_13_CP_EN1_tpl_dut, in_13_CP_EN1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_14_ripple_comp_en_tpl : process (clk, areset, in_14_ripple_comp_en_tpl_dut, in_14_ripple_comp_en_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_15_rc_bw_sel_tpl : process (clk, areset, in_15_rc_bw_sel_tpl_dut, in_15_rc_bw_sel_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_16_sym_metadata_in_tpl : process (clk, areset, in_16_sym_metadata_in_tpl_dut, in_16_sym_metadata_in_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_17_sym_metadata_in_valid_tpl : process (clk, areset, in_17_sym_metadata_in_valid_tpl_dut, in_17_sym_metadata_in_valid_tpl_stm)
begin
END PROCESS;
...
dut : streamtoblock_fft_DUT_S2B_FFT_PC port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
    ...
    busOut_readdata_dut,
    in_1_rx_vin1_tpl_stm,
    in_2_rx_chin1_tpl_stm,
    in_3_imag_rx_din1_tpl_stm,
    in_3_real_rx_din1_tpl_stm,
    in_4_fft_in1_tpl_stm,
    in_5_cp_in1_tpl_stm,
    in_6_nprb1_tpl_stm,
    in_7_hcs_bypass_l1_tpl_stm,
    in_8_fft_gain_l1_tpl_stm,
    in_9_fft_gain_im_l1_tpl_stm,
    in_10_fft_shift_l1_tpl_stm,
    in_11_time_ref_in1_tpl_stm,
    in_12_DC_SC_EN_tpl_stm,
    in_13_CP_EN1_tpl_stm,
    in_14_ripple_comp_en_tpl_stm,
    in_15_rc_bw_sel_tpl_stm,
    in_16_sym_metadata_in_tpl_stm,
    in_17_sym_metadata_in_valid_tpl_stm,
    in_AMMregisterWireData_streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_PhasorGenerate_RegField1_x_tpl_stm,
    ...
    in_sharedMemWireData_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_Transpose_ripple_comp_LookupTable_100MHz_x_tpl_stm,
    in_sharedMemWireData_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_Transpose_ripple_comp_LookupTable_60MHz_x_tpl_stm,
    out_1_rx_valid_tpl_dut,
    out_2_rx_chout_tpl_dut,
    out_3_imag_rx_dout_tpl_dut,
    out_3_real_rx_dout_tpl_dut,
    out_4_rx_time_out_tpl_dut,
    out_5_td_fft_in_v_tpl_dut,
    out_6_td_fft_in_chout_tpl_dut,
    ...
    out_11_fd_data_v_tpl_dut,
    out_12_fd_data_c_tpl_dut,
    out_13_imag_fd_data_q_tpl_dut,
    out_13_real_fd_data_q_tpl_dut,
    out_14_eAxCout_tpl_dut,
    out_15_symmetadataout_tpl_dut,
    out_16_eop_eAxC_tpl_dut,
    out_17_eop_sym_tpl_dut,
    out_18_sop_eAxC_tpl_dut,
    out_19_sop_sym_tpl_dut,
...
sim : streamtoblock_fft_DUT_S2B_FFT_PC_stm port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
    ...
    in_sharedMemWireData_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_Transpose_ripple_comp_LookupTable_100MHz_x_tpl_stm,
    in_sharedMemWireData_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_Transpose_ripple_comp_LookupTable_60MHz_x_tpl_stm,
    out_1_rx_valid_tpl_stm,
    out_2_rx_chout_tpl_stm,
    out_3_imag_rx_dout_tpl_stm,
    out_3_real_rx_dout_tpl_stm,
    out_4_rx_time_out_tpl_stm,
    out_5_td_fft_in_v_tpl_stm,
    out_6_td_fft_in_chout_tpl_stm,
    ...
    out_11_fd_data_v_tpl_stm,
    out_12_fd_data_c_tpl_stm,
    out_13_imag_fd_data_q_tpl_stm,
    out_13_real_fd_data_q_tpl_stm,
    out_14_eAxCout_tpl_stm,
    out_15_symmetadataout_tpl_stm,
    out_16_eop_eAxC_tpl_stm,
    out_17_eop_sym_tpl_stm,
    out_18_sop_eAxC_tpl_stm,
    out_19_sop_sym_tpl_stm,
