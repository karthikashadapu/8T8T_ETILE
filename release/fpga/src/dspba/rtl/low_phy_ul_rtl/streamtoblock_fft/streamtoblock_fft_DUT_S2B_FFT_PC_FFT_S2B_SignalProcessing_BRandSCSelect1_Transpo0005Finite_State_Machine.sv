...
// SystemVerilog created from streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_Transpose_falling_edge_Finite_State_Machine
...
module streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_Transpo0005Finite_State_Machine (
    ...
    begin
        ...
        unique case (bitJoin_13_q)
            ...
            3'b011 : lut_14_q = 3'b010;
            3'b100 : lut_14_q = 3'b101;
