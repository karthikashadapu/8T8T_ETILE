# This is the top level tcl file for 'streamtoblock_fft_DUT'
...
if {!$overwrite_opt && [project_exists streamtoblock_fft_DUT]} {
    puts "The streamtoblock_fft_DUT quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "../../rtl/low_phy_ul_rtl/streamtoblock_fft/streamtoblock_fft_DUT.tcl"]}    {
    puts "You must run streamtoblock_fft_DUT.tcl "
...
puts "Creating streamtoblock_fft_DUT Quartus project..."

if $overwrite_opt {
    project_new -overwrite streamtoblock_fft_DUT
} else {
    project_new streamtoblock_fft_DUT
}

set_global_assignment -name FAMILY "Agilex 7"
set_global_assignment -name TOP_LEVEL_ENTITY streamtoblock_fft_DUT
set_global_assignment -name DEVICE AGFB014R24A3E3V
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ../../rtl/low_phy_ul_rtl/streamtoblock_fft/streamtoblock_fft_DUT.sdc
set_global_assignment -name SYNCHRONIZATION_REGISTER_CHAIN_LENGTH 1
set_global_assignment -name SEARCH_PATH ../../rtl/low_phy_ul_rtl/streamtoblock_fft
source ../../rtl/low_phy_ul_rtl/streamtoblock_fft/streamtoblock_fft_DUT.add.tcl

set_instance_assignment -name VIRTUAL_PIN ON -to rx_vin_s
set_instance_assignment -name VIRTUAL_PIN ON -to rx_chin_s
set_instance_assignment -name VIRTUAL_PIN ON -to rx_din_im
set_instance_assignment -name VIRTUAL_PIN ON -to rx_din_re
set_instance_assignment -name VIRTUAL_PIN ON -to fft_in_s
set_instance_assignment -name VIRTUAL_PIN ON -to cp_in_s
set_instance_assignment -name VIRTUAL_PIN ON -to nprb_s
set_instance_assignment -name VIRTUAL_PIN ON -to hcs_bypass_s
set_instance_assignment -name VIRTUAL_PIN ON -to fft_gain_s
set_instance_assignment -name VIRTUAL_PIN ON -to fft_gain_im_s
set_instance_assignment -name VIRTUAL_PIN ON -to fft_shift_s
set_instance_assignment -name VIRTUAL_PIN ON -to time_ref_in_s
set_instance_assignment -name VIRTUAL_PIN ON -to DC_SC_EN_s
set_instance_assignment -name VIRTUAL_PIN ON -to CP_EN_s
...
set_instance_assignment -name VIRTUAL_PIN ON -to sym_metadata_in_s
set_instance_assignment -name VIRTUAL_PIN ON -to sym_metadata_in_valid_s
set_instance_assignment -name VIRTUAL_PIN ON -to rx_valid_s
set_instance_assignment -name VIRTUAL_PIN ON -to rx_chout_s
set_instance_assignment -name VIRTUAL_PIN ON -to rx_dout_im
set_instance_assignment -name VIRTUAL_PIN ON -to rx_dout_re
set_instance_assignment -name VIRTUAL_PIN ON -to rx_time_out_s
set_instance_assignment -name VIRTUAL_PIN ON -to fft_vout_s
set_instance_assignment -name VIRTUAL_PIN ON -to fft_chout_s
set_instance_assignment -name VIRTUAL_PIN ON -to fft_dout_im
set_instance_assignment -name VIRTUAL_PIN ON -to fft_dout_re
set_instance_assignment -name VIRTUAL_PIN ON -to nsc_out_s
set_instance_assignment -name VIRTUAL_PIN ON -to size_out_s
set_instance_assignment -name VIRTUAL_PIN ON -to td_time_out_s
...
set_instance_assignment -name VIRTUAL_PIN ON -to eAxCout_s
set_instance_assignment -name VIRTUAL_PIN ON -to symmetadataout_s
set_instance_assignment -name VIRTUAL_PIN ON -to eop_eAxC_s
set_instance_assignment -name VIRTUAL_PIN ON -to eop_sym_s
set_instance_assignment -name VIRTUAL_PIN ON -to sop_eAxC_s
set_instance_assignment -name VIRTUAL_PIN ON -to sop_sym_s
set_instance_assignment -name VIRTUAL_PIN ON -to version_out1_s
...
source "../../rtl/low_phy_ul_rtl/streamtoblock_fft/streamtoblock_fft_DUT_fpc.add.tcl"
