...
if {! [file exists $base_dir/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_CPRemoval]} {
    file delete -force $base_dir/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_CPRemoval
}

project new $base_dir streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_CPRemoval
...
do "$base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_CPRemoval_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_CPRemoval_atb.vhd}
project addfile $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_CPRemoval_atb.vhd vhdl
project addfile $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_CPRemoval_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_vout_x_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_vout_x_tpl $cyclenum
            }
            ...
            if { [catch {exa mismatch_out_4_time_out_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_4_time_out_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_5_nprb_out_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_5_nprb_out_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_6_fft_size_out_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_6_fft_size_out_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_7_eAxC_no_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_7_eAxC_no_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_8_sym_metadata_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_8_sym_metadata_tpl $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_CPRemoval_atb $ll
    do $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_CPRemoval_atb.wav.do
