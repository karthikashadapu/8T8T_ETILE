...
-- VHDL created from streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_RXScaling
...
entity streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_RXScaling_atb is
end;

architecture normal of streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_RXScaling_atb is

component streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_RXScaling is
    port (
        in_1_vin_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_2_chin_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_4_real_din_tpl : in std_logic_vector(28 downto 0);  -- sfix29_en15
        in_4_imag_din_tpl : in std_logic_vector(28 downto 0);  -- sfix29_en15
        in_3_size_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        in_5_nsc_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_6_fft_shift_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        ...
        out_3_real_dout_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en12
        out_3_imag_dout_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en12
        out_4_size_out_tpl : out std_logic_vector(3 downto 0);  -- ufix4
        out_5_nsc_out_tpl : out std_logic_vector(15 downto 0);  -- ufix16
...
component streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_RXScaling_stm is
    port (
        in_1_vin_tpl_stm : out std_logic_vector(0 downto 0);
        in_2_chin_tpl_stm : out std_logic_vector(7 downto 0);
        in_4_real_din_tpl_stm : out std_logic_vector(28 downto 0);
        in_4_imag_din_tpl_stm : out std_logic_vector(28 downto 0);
        in_3_size_tpl_stm : out std_logic_vector(3 downto 0);
        in_5_nsc_tpl_stm : out std_logic_vector(15 downto 0);
        in_6_fft_shift_tpl_stm : out std_logic_vector(3 downto 0);
        ...
        out_5_nsc_out_tpl_stm : out std_logic_vector(15 downto 0);
...
signal in_4_real_din_tpl_stm : STD_LOGIC_VECTOR (28 downto 0);
signal in_4_imag_din_tpl_stm : STD_LOGIC_VECTOR (28 downto 0);
signal in_3_size_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal in_5_nsc_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_6_fft_shift_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
...
signal out_5_nsc_out_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
...
signal in_4_real_din_tpl_dut : STD_LOGIC_VECTOR (28 downto 0);
signal in_4_imag_din_tpl_dut : STD_LOGIC_VECTOR (28 downto 0);
signal in_3_size_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal in_5_nsc_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_6_fft_shift_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
...
signal out_5_nsc_out_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
...
checkchannel_RXS1_in : process (clk, areset, in_4_real_din_tpl_dut, in_4_real_din_tpl_stm, in_4_imag_din_tpl_dut, in_4_imag_din_tpl_stm, in_3_size_tpl_dut, in_3_size_tpl_stm, in_5_nsc_tpl_dut, in_5_nsc_tpl_stm, in_6_fft_shift_tpl_dut, in_6_fft_shift_tpl_stm, in_7_time_in_tpl_dut, in_7_time_in_tpl_stm, in_8_eAxC_tpl_dut, in_8_eAxC_tpl_stm, in_9_sym_metadata_tpl_dut, in_9_sym_metadata_tpl_stm)
begin
END PROCESS;


-- Channelized data out check
checkchannel_RXS1_out : process (clk, areset, out_3_real_dout_tpl_dut, out_3_real_dout_tpl_stm, out_3_imag_dout_tpl_dut, out_3_imag_dout_tpl_stm, out_4_size_out_tpl_dut, out_4_size_out_tpl_stm, out_5_nsc_out_tpl_dut, out_5_nsc_out_tpl_stm, out_6_time_out_tpl_dut, out_6_time_out_tpl_stm, out_7_eAxCout_tpl_dut, out_7_eAxCout_tpl_stm, out_8_sym_metadataout_tpl_dut, out_8_sym_metadataout_tpl_stm)
...
variable mismatch_out_5_nsc_out_tpl : BOOLEAN := FALSE;
variable mismatch_out_6_time_out_tpl : BOOLEAN := FALSE;
variable mismatch_out_7_eAxCout_tpl : BOOLEAN := FALSE;
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        mismatch_out_5_nsc_out_tpl := FALSE;
        mismatch_out_6_time_out_tpl := FALSE;
        mismatch_out_7_eAxCout_tpl := FALSE;
        ...
        IF ((out_1_vout_tpl_dut = "1")) THEN
            ...
            END IF;
            IF ( (out_5_nsc_out_tpl_dut /= out_5_nsc_out_tpl_stm)) THEN
                mismatch_out_5_nsc_out_tpl := TRUE;
                report "mismatch in out_5_nsc_out_tpl signal" severity Warning;
            END IF;
            ...
            END IF;
            IF ( (out_7_eAxCout_tpl_dut /= out_7_eAxCout_tpl_stm)) THEN
                mismatch_out_7_eAxCout_tpl := TRUE;
                report "mismatch in out_7_eAxCout_tpl signal" severity Warning;
            END IF;
            ...
            END IF;
        END IF;
        IF (mismatch_out_1_vout_tpl = TRUE or mismatch_out_2_chout_tpl = TRUE or mismatch_out_3_real_dout_tpl = TRUE or mismatch_out_3_imag_dout_tpl = TRUE or mismatch_out_4_size_out_tpl = TRUE or mismatch_out_5_nsc_out_tpl = TRUE or mismatch_out_6_time_out_tpl = TRUE or mismatch_out_7_eAxCout_tpl = TRUE or mismatch_out_8_sym_metadataout_tpl = TRUE) THEN
            ok := FALSE;
        END IF;
        IF (ok = FALSE) THEN
...
dut : streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_RXScaling port map (
    in_1_vin_tpl_stm,
    in_2_chin_tpl_stm,
    in_4_real_din_tpl_stm,
    in_4_imag_din_tpl_stm,
    in_3_size_tpl_stm,
    in_5_nsc_tpl_stm,
    in_6_fft_shift_tpl_stm,
...
sim : streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_RXScaling_stm port map (
    in_1_vin_tpl_stm,
    in_2_chin_tpl_stm,
    in_4_real_din_tpl_stm,
    in_4_imag_din_tpl_stm,
