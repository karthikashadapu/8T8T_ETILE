...
if {! [file exists $base_dir/standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1]} {
    file delete -force $base_dir/standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1
}

project new $base_dir standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1
...
do "$base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_fpc.do"
...
project addfile $base_dir/streamtoblock_fft/standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1.sv systemverilog
...
puts {vcom -quiet -O0 $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_atb.vhd}
project addfile $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_atb.vhd vhdl
project addfile $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_qsizeout_s} mismatch] == 0 && $mismatch } {
                report_mismatch qsizeout_s $cyclenum
            }
            if { [catch {exa mismatch_time_out_s} mismatch] == 0 && $mismatch } {
                report_mismatch time_out_s $cyclenum
            }
            if { [catch {exa mismatch_eAxC_out_s} mismatch] == 0 && $mismatch } {
                report_mismatch eAxC_out_s $cyclenum
            }
            if { [catch {exa mismatch_meatadata_sym_out_s} mismatch] == 0 && $mismatch } {
                report_mismatch meatadata_sym_out_s $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_atb $ll
    do $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_atb.wav.do
