...
// SystemVerilog created from streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen
...
module streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen (
    ...
    input wire [1:0] in_4_eAxC_in_tpl,
    ...
    output wire [1:0] out_4_eAxC_out_tpl,
    ...
    wire [7:0] Const1_q;
    wire [0:0] streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_Rising_edge_Finite_State_Machine_x_out_1_fsm_q_tpl;
    wire [0:0] streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_falling_edge_Finite_State_Machine_x_out_1_fsm_q_tpl;
    ...
    reg [1:0] redist4_channel_RXG1_in_cunroll_x_in_4_eAxC_in_tpl_1_q;
    ...
    // CmpEQ1(LOGICAL,7)@0
    assign CmpEQ1_b = {6'b000000, redist4_channel_RXG1_in_cunroll_x_in_4_eAxC_in_tpl_1_q};
    assign CmpEQ1_q = $unsigned(Const1_q == CmpEQ1_b ? 1'b1 : 1'b0);

    // And1(LOGICAL,5)@0
    assign And1_q = streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_Rising_edge_Finite_State_Machine_x_out_1_fsm_q_tpl & CmpEQ1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_Rising_edge_Finite_State_Machine_x(BLACKBOX,18)@0
    streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_Rising_edge_Finite_State_Machine thestreamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_Rising_edge_Finite_State_Machine_x (
        .in_1_go_tpl(VCC_q),
        .in_2_x_tpl(redist0_channel_RXG1_in_cunroll_x_in_1_vin_tpl_1_q),
        .out_1_fsm_q_tpl(streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_Rising_edge_Finite_State_Machine_x_out_1_fsm_q_tpl),
        .clk(clk),
        .areset(areset)
    );
    ...
    // CmpEQ(LOGICAL,6)@0
    assign CmpEQ_b = {6'b000000, in_4_eAxC_in_tpl};
    assign CmpEQ_q = $unsigned(Const_rsrvd_fix_q == CmpEQ_b ? 1'b1 : 1'b0);

    // And_rsrvd_fix(LOGICAL,4)@0
    assign And_rsrvd_fix_q = streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_falling_edge_Finite_State_Machine_x_out_1_fsm_q_tpl & CmpEQ_q;

    // streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_falling_edge_Finite_State_Machine_x(BLACKBOX,20)@0
    streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_falling_edge_Finite_State_Machine thestreamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_falling_edge_Finite_State_Machine_x (
        .in_1_go_tpl(VCC_q),
        .in_2_x_tpl(in_1_vin_tpl),
        .out_1_fsm_q_tpl(streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_falling_edge_Finite_State_Machine_x_out_1_fsm_q_tpl),
        .clk(clk),
        .areset(areset)
    );
    ...
    assign out_5_eop_eAxC_tpl = streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_falling_edge_Finite_State_Machine_x_out_1_fsm_q_tpl;
    assign out_6_eop_sym_tpl = And_rsrvd_fix_q;
    assign out_7_sop_eAxC_tpl = streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_SOP_EOP_gen_Rising_edge_Finite_State_Machine_x_out_1_fsm_q_tpl;
