...
if {! [file exists $base_dir/streamtoblock_fft_DUT_S2B_FFT_PC]} {
    file delete -force $base_dir/streamtoblock_fft_DUT_S2B_FFT_PC
}

project new $base_dir streamtoblock_fft_DUT_S2B_FFT_PC
...
do "$base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_atb.vhd}
project addfile $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_atb.vhd vhdl
project addfile $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_rx_valid_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_rx_valid_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_2_rx_chout_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_rx_chout_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_3_imag_rx_dout_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_imag_rx_dout_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_3_real_rx_dout_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_real_rx_dout_tpl $cyclenum
            }
            ...
            if { [catch {exa mismatch_out_6_td_fft_in_chout_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_6_td_fft_in_chout_tpl $cyclenum
            }
            ...
            if { [catch {exa mismatch_out_11_fd_data_v_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_11_fd_data_v_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_12_fd_data_c_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_12_fd_data_c_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_13_imag_fd_data_q_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_13_imag_fd_data_q_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_13_real_fd_data_q_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_13_real_fd_data_q_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_14_eAxCout_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_14_eAxCout_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_15_symmetadataout_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_15_symmetadataout_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_16_eop_eAxC_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_16_eop_eAxC_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_17_eop_sym_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_17_eop_sym_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_18_sop_eAxC_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_18_sop_eAxC_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_19_sop_sym_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_19_sop_sym_tpl $cyclenum
            }
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps streamtoblock_fft_DUT_S2B_FFT_PC_atb $ll
    do $base_dir/streamtoblock_fft/streamtoblock_fft_DUT_S2B_FFT_PC_atb.wav.do
