...
-- VHDL created from streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B
...
entity streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_atb is
end;

architecture normal of streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_atb is

component streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B is
    port (
        ...
        in_2_imag_rx_din1_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en14
        in_2_real_rx_din1_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en14
        in_3_fft_in1_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        in_4_cp_in1_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_5_nprb1_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_6_hcs_bypass_l1_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_7_fft_gain_re_l1_tpl : in std_logic_vector(15 downto 0);  -- ufix16_en14
        in_8_fft_gain_im_l1_tpl : in std_logic_vector(15 downto 0);  -- ufix16_en14
        in_9_fft_shift_l1_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        in_10_time_in1_tpl : in std_logic_vector(63 downto 0);  -- ufix64
        in_11_DC_SC_EN_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_12_rx_ch_in_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_13_ripple_comp_en_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_14_rc_bw_sel_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_15_sym_metadata_in_tpl : in std_logic_vector(63 downto 0);  -- ufix64
        in_16_sym_metadata_in_valid_tpl : in std_logic_vector(0 downto 0);  -- ufix1
...
component streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_stm is
    port (
        ...
        in_2_imag_rx_din1_tpl_stm : out std_logic_vector(15 downto 0);
        in_2_real_rx_din1_tpl_stm : out std_logic_vector(15 downto 0);
        in_3_fft_in1_tpl_stm : out std_logic_vector(3 downto 0);
        in_4_cp_in1_tpl_stm : out std_logic_vector(15 downto 0);
        in_5_nprb1_tpl_stm : out std_logic_vector(15 downto 0);
        in_6_hcs_bypass_l1_tpl_stm : out std_logic_vector(0 downto 0);
        in_7_fft_gain_re_l1_tpl_stm : out std_logic_vector(15 downto 0);
        in_8_fft_gain_im_l1_tpl_stm : out std_logic_vector(15 downto 0);
        in_9_fft_shift_l1_tpl_stm : out std_logic_vector(3 downto 0);
        in_10_time_in1_tpl_stm : out std_logic_vector(63 downto 0);
        in_11_DC_SC_EN_tpl_stm : out std_logic_vector(0 downto 0);
        in_12_rx_ch_in_tpl_stm : out std_logic_vector(7 downto 0);
        in_13_ripple_comp_en_tpl_stm : out std_logic_vector(0 downto 0);
        in_14_rc_bw_sel_tpl_stm : out std_logic_vector(0 downto 0);
        in_15_sym_metadata_in_tpl_stm : out std_logic_vector(63 downto 0);
        in_16_sym_metadata_in_valid_tpl_stm : out std_logic_vector(0 downto 0);
...
signal in_2_imag_rx_din1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_2_real_rx_din1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_3_fft_in1_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal in_4_cp_in1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_5_nprb1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_6_hcs_bypass_l1_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_7_fft_gain_re_l1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_8_fft_gain_im_l1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_9_fft_shift_l1_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal in_10_time_in1_tpl_stm : STD_LOGIC_VECTOR (63 downto 0);
signal in_11_DC_SC_EN_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_12_rx_ch_in_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
...
signal in_15_sym_metadata_in_tpl_stm : STD_LOGIC_VECTOR (63 downto 0);
signal in_16_sym_metadata_in_valid_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
...
signal in_2_imag_rx_din1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_2_real_rx_din1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_3_fft_in1_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal in_4_cp_in1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_5_nprb1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_6_hcs_bypass_l1_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_7_fft_gain_re_l1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_8_fft_gain_im_l1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_9_fft_shift_l1_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal in_10_time_in1_tpl_dut : STD_LOGIC_VECTOR (63 downto 0);
signal in_11_DC_SC_EN_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_12_rx_ch_in_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
...
signal in_15_sym_metadata_in_tpl_dut : STD_LOGIC_VECTOR (63 downto 0);
signal in_16_sym_metadata_in_valid_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
...
-- General Purpose data in real output
checkin_2_imag_rx_din1_tpl : process (clk, areset, in_2_imag_rx_din1_tpl_dut, in_2_imag_rx_din1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_2_real_rx_din1_tpl : process (clk, areset, in_2_real_rx_din1_tpl_dut, in_2_real_rx_din1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_3_fft_in1_tpl : process (clk, areset, in_3_fft_in1_tpl_dut, in_3_fft_in1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_4_cp_in1_tpl : process (clk, areset, in_4_cp_in1_tpl_dut, in_4_cp_in1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_5_nprb1_tpl : process (clk, areset, in_5_nprb1_tpl_dut, in_5_nprb1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_6_hcs_bypass_l1_tpl : process (clk, areset, in_6_hcs_bypass_l1_tpl_dut, in_6_hcs_bypass_l1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_7_fft_gain_re_l1_tpl : process (clk, areset, in_7_fft_gain_re_l1_tpl_dut, in_7_fft_gain_re_l1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_8_fft_gain_im_l1_tpl : process (clk, areset, in_8_fft_gain_im_l1_tpl_dut, in_8_fft_gain_im_l1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_9_fft_shift_l1_tpl : process (clk, areset, in_9_fft_shift_l1_tpl_dut, in_9_fft_shift_l1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_10_time_in1_tpl : process (clk, areset, in_10_time_in1_tpl_dut, in_10_time_in1_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_11_DC_SC_EN_tpl : process (clk, areset, in_11_DC_SC_EN_tpl_dut, in_11_DC_SC_EN_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_12_rx_ch_in_tpl : process (clk, areset, in_12_rx_ch_in_tpl_dut, in_12_rx_ch_in_tpl_stm)
begin
END PROCESS;
...
-- General Purpose data in real output
checkin_15_sym_metadata_in_tpl : process (clk, areset, in_15_sym_metadata_in_tpl_dut, in_15_sym_metadata_in_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_16_sym_metadata_in_valid_tpl : process (clk, areset, in_16_sym_metadata_in_valid_tpl_dut, in_16_sym_metadata_in_valid_tpl_stm)
begin
END PROCESS;
...
dut : streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
    ...
    in_2_imag_rx_din1_tpl_stm,
    in_2_real_rx_din1_tpl_stm,
    in_3_fft_in1_tpl_stm,
    in_4_cp_in1_tpl_stm,
    in_5_nprb1_tpl_stm,
    in_6_hcs_bypass_l1_tpl_stm,
    in_7_fft_gain_re_l1_tpl_stm,
    in_8_fft_gain_im_l1_tpl_stm,
    in_9_fft_shift_l1_tpl_stm,
    in_10_time_in1_tpl_stm,
    in_11_DC_SC_EN_tpl_stm,
    in_12_rx_ch_in_tpl_stm,
    in_13_ripple_comp_en_tpl_stm,
    in_14_rc_bw_sel_tpl_stm,
    in_15_sym_metadata_in_tpl_stm,
    in_16_sym_metadata_in_valid_tpl_stm,
    in_sharedMemWireData_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_Transpose_ripple_comp_LookupTable_100MHz_x_tpl_stm,
    in_sharedMemWireData_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_SignalProcessing_BRandSCSelect1_Transpose_ripple_comp_LookupTable_60MHz_x_tpl_stm,
...
sim : streamtoblock_fft_DUT_S2B_FFT_PC_FFT_S2B_stm port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
