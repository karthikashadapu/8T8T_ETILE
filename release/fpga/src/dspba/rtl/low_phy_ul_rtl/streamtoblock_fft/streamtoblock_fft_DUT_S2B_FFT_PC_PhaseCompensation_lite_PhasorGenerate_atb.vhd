...
-- VHDL created from standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_PhasorGenerate
...
entity standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_PhasorGenerate_atb is
end;

architecture normal of standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_PhasorGenerate_atb is

component standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_PhasorGenerate is
    port (
        ...
        d1_im : in std_logic_vector(15 downto 0);  -- sfix16_en11
        d1_re : in std_logic_vector(15 downto 0);  -- sfix16_en11
        ...
        fft_size_s : in std_logic_vector(63 downto 0);  -- float64_m52
        CPLen_s : in std_logic_vector(63 downto 0);  -- float64_m52
        nsc_s : in std_logic_vector(63 downto 0);  -- float64_m52
        eAxC_s : in std_logic_vector(1 downto 0);  -- ufix2
        sym_metadata_s : in std_logic_vector(63 downto 0);  -- ufix64
        ul_timerefin_s : in std_logic_vector(63 downto 0);  -- ufix64
        dout1_im : out std_logic_vector(15 downto 0);  -- sfix16_en11
        dout1_re : out std_logic_vector(15 downto 0);  -- sfix16_en11
        ...
        fft_size_out_s : out std_logic_vector(63 downto 0);  -- float64_m52
        CPLenout_s : out std_logic_vector(63 downto 0);  -- float64_m52
        nsc_out_s : out std_logic_vector(63 downto 0);  -- float64_m52
        eAxC_out_s : out std_logic_vector(1 downto 0);  -- ufix2
        sym_metadata_out_s : out std_logic_vector(63 downto 0);  -- ufix64
...
component standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_PhasorGenerate_stm is
    port (
        ...
        fft_size_s_stm : out std_logic_vector(63 downto 0);
        CPLen_s_stm : out std_logic_vector(63 downto 0);
        nsc_s_stm : out std_logic_vector(63 downto 0);
        eAxC_s_stm : out std_logic_vector(1 downto 0);
        sym_metadata_s_stm : out std_logic_vector(63 downto 0);
        ...
        fft_size_out_s_stm : out std_logic_vector(63 downto 0);
        CPLenout_s_stm : out std_logic_vector(63 downto 0);
        nsc_out_s_stm : out std_logic_vector(63 downto 0);
        eAxC_out_s_stm : out std_logic_vector(1 downto 0);
        sym_metadata_out_s_stm : out std_logic_vector(63 downto 0);
...
signal fft_size_s_stm : STD_LOGIC_VECTOR (63 downto 0);
signal CPLen_s_stm : STD_LOGIC_VECTOR (63 downto 0);
signal nsc_s_stm : STD_LOGIC_VECTOR (63 downto 0);
signal eAxC_s_stm : STD_LOGIC_VECTOR (1 downto 0);
signal sym_metadata_s_stm : STD_LOGIC_VECTOR (63 downto 0);
...
signal fft_size_out_s_stm : STD_LOGIC_VECTOR (63 downto 0);
signal CPLenout_s_stm : STD_LOGIC_VECTOR (63 downto 0);
signal nsc_out_s_stm : STD_LOGIC_VECTOR (63 downto 0);
signal eAxC_out_s_stm : STD_LOGIC_VECTOR (1 downto 0);
signal sym_metadata_out_s_stm : STD_LOGIC_VECTOR (63 downto 0);
...
signal fft_size_s_dut : STD_LOGIC_VECTOR (63 downto 0);
signal CPLen_s_dut : STD_LOGIC_VECTOR (63 downto 0);
signal nsc_s_dut : STD_LOGIC_VECTOR (63 downto 0);
signal eAxC_s_dut : STD_LOGIC_VECTOR (1 downto 0);
signal sym_metadata_s_dut : STD_LOGIC_VECTOR (63 downto 0);
...
signal fft_size_out_s_dut : STD_LOGIC_VECTOR (63 downto 0);
signal CPLenout_s_dut : STD_LOGIC_VECTOR (63 downto 0);
signal nsc_out_s_dut : STD_LOGIC_VECTOR (63 downto 0);
signal eAxC_out_s_dut : STD_LOGIC_VECTOR (1 downto 0);
signal sym_metadata_out_s_dut : STD_LOGIC_VECTOR (63 downto 0);
...
variable fft_size_s_real : REAL := 0.0;
variable fft_size_s_stm_real : REAL := 0.0;
begin
 fft_size_s_real := vIEEE_2_real(fft_size_s_dut, 11, 52, false);
 fft_size_s_stm_real := vIEEE_2_real(fft_size_s_stm, 11, 52, false);
END PROCESS;


-- General Purpose data in real output
checkCPLen_s : process (clk, areset, CPLen_s_dut, CPLen_s_stm)
variable CPLen_s_real : REAL := 0.0;
variable CPLen_s_stm_real : REAL := 0.0;
begin
 CPLen_s_real := vIEEE_2_real(CPLen_s_dut, 11, 52, false);
 CPLen_s_stm_real := vIEEE_2_real(CPLen_s_stm, 11, 52, false);
END PROCESS;


-- General Purpose data in real output
checknsc_s : process (clk, areset, nsc_s_dut, nsc_s_stm)
variable nsc_s_real : REAL := 0.0;
variable nsc_s_stm_real : REAL := 0.0;
begin
 nsc_s_real := vIEEE_2_real(nsc_s_dut, 11, 52, false);
 nsc_s_stm_real := vIEEE_2_real(nsc_s_stm, 11, 52, false);
END PROCESS;
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ( (abs(signed(dout1_im_dut) - signed(dout1_im_stm)) > 3) and vout_s_dut = "1") THEN
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ( (abs(signed(dout1_re_dut) - signed(dout1_re_stm)) > 3) and vout_s_dut = "1") THEN
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ( (abs(signed(cout_s_dut) - signed(cout_s_stm)) > 3) and vout_s_dut = "1") THEN
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ( (abs(signed(sin_s_dut) - signed(sin_s_stm)) > 3) and vout_s_dut = "1") THEN
            mismatch_sin_s := TRUE;
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ( (abs(signed(cos_s_dut) - signed(cos_s_stm)) > 3) and vout_s_dut = "1") THEN
            mismatch_cos_s := TRUE;
...
variable fft_size_out_s_real : REAL := 0.0;
variable fft_size_out_s_stm_real : REAL := 0.0;
variable ok : BOOLEAN := TRUE;
begin
 fft_size_out_s_real := vIEEE_2_real(fft_size_out_s_dut, 11, 52, false);
 fft_size_out_s_stm_real := vIEEE_2_real(fft_size_out_s_stm, 11, 52, false);
    IF ((areset = '1')) THEN
        -- do nothing during reset
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ok := TRUE;
        mismatch_fft_size_out_s := FALSE;
        IF ( not vIEEEisEqual(fft_size_out_s_dut, fft_size_out_s_stm, 11, 52, 0.000000e+00, 0.000000e+00) and vout_s_dut = "1") THEN
...
variable CPLenout_s_real : REAL := 0.0;
variable CPLenout_s_stm_real : REAL := 0.0;
variable ok : BOOLEAN := TRUE;
begin
 CPLenout_s_real := vIEEE_2_real(CPLenout_s_dut, 11, 52, false);
 CPLenout_s_stm_real := vIEEE_2_real(CPLenout_s_stm, 11, 52, false);
    IF ((areset = '1')) THEN
        -- do nothing during reset
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ok := TRUE;
        mismatch_CPLenout_s := FALSE;
        IF ( not vIEEEisEqual(CPLenout_s_dut, CPLenout_s_stm, 11, 52, 0.000000e+00, 0.000000e+00) and vout_s_dut = "1") THEN
...
variable nsc_out_s_real : REAL := 0.0;
variable nsc_out_s_stm_real : REAL := 0.0;
variable ok : BOOLEAN := TRUE;
begin
 nsc_out_s_real := vIEEE_2_real(nsc_out_s_dut, 11, 52, false);
 nsc_out_s_stm_real := vIEEE_2_real(nsc_out_s_stm, 11, 52, false);
    IF ((areset = '1')) THEN
        -- do nothing during reset
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ok := TRUE;
        mismatch_nsc_out_s := FALSE;
        IF ( not vIEEEisEqual(nsc_out_s_dut, nsc_out_s_stm, 11, 52, 0.000000e+00, 0.000000e+00) and vout_s_dut = "1") THEN
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ( (abs(signed(sym_metadata_out_s_dut) - signed(sym_metadata_out_s_stm)) > 3) and vout_s_dut = "1") THEN
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ( (abs(signed(ul_timeref_out_s_dut) - signed(ul_timeref_out_s_stm)) > 3) and vout_s_dut = "1") THEN
...
dut : standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_PhasorGenerate port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
...
sim : standaloneTopLevel_streamtoblock_fft_DUT_S2B_FFT_PC_PhaseCompensation_lite_PhasorGenerate_stm port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
