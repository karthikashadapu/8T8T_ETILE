...
if {! [file exists $base_dir/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT]} {
    file delete -force $base_dir/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT
}

project new $base_dir ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT
...
do "$base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_atb.vhd}
project addfile $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_atb.vhd vhdl
project addfile $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_4_sizeout_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_4_sizeout_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_5_cplen_Out_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_5_cplen_Out_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_6_nprb_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_6_nprb_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_7_fd_data_v_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_7_fd_data_v_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_8_fd_data_c_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_8_fd_data_c_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_9_imag_fd_data_q_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_9_imag_fd_data_q_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_9_real_fd_data_q_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_9_real_fd_data_q_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_10_fd_time_out_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_10_fd_time_out_tpl $cyclenum
            }
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_atb $ll
    do $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_atb.wav.do
