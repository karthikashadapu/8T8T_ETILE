...
entity ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer_ComplexMixer_atb is
end;

architecture normal of ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer_ComplexMixer_atb is

component ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer_ComplexMixer is
    port (
...
component ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer_ComplexMixer_stm is
    port (
...
dut : ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer_ComplexMixer port map (
    In_v_stm,
    In_c_stm,
    iIn_0_stm,
    qIn_0_stm,
...
sim : ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer_ComplexMixer_stm port map (
    In_v_stm,
    In_c_stm,
    iIn_0_stm,
    qIn_0_stm,
