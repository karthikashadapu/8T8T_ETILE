...
if {! [file exists $base_dir/standaloneTopLevel_ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate]} {
    file delete -force $base_dir/standaloneTopLevel_ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate
}

project new $base_dir standaloneTopLevel_ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate
...
do "$base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate_fpc.do"
...
project addfile $base_dir/ifft_blocktostream/standaloneTopLevel_ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate.sv systemverilog
...
puts {vcom -quiet -O0 $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate_atb.vhd}
project addfile $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate_atb.vhd vhdl
project addfile $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps standaloneTopLevel_ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate_atb $ll
    do $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate_atb.wav.do
