...
-- VHDL created from ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT
...
entity ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_atb is
end;

architecture normal of ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_atb is

component ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT is
    port (
        ...
        in_2_valid1_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        ...
        out_2_cout1_tpl : out std_logic_vector(7 downto 0);  -- ufix8
        ...
        out_4_sizeout1_tpl : out std_logic_vector(3 downto 0);  -- ufix4
        out_5_cpout1_tpl : out std_logic_vector(10 downto 0);  -- ufix11
...
component ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_stm is
    port (
        in_1_imag_data1_tpl_stm : out std_logic_vector(15 downto 0);
        in_1_real_data1_tpl_stm : out std_logic_vector(15 downto 0);
        in_2_valid1_tpl_stm : out std_logic_vector(0 downto 0);
        ...
        out_2_cout1_tpl_stm : out std_logic_vector(7 downto 0);
        out_3_imag_dout1_tpl_stm : out std_logic_vector(15 downto 0);
        out_3_real_dout1_tpl_stm : out std_logic_vector(15 downto 0);
        out_4_sizeout1_tpl_stm : out std_logic_vector(3 downto 0);
        out_5_cpout1_tpl_stm : out std_logic_vector(10 downto 0);
...
signal in_2_valid1_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
...
signal out_2_cout1_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_imag_dout1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal out_3_real_dout1_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal out_4_sizeout1_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal out_5_cpout1_tpl_stm : STD_LOGIC_VECTOR (10 downto 0);
...
signal in_2_valid1_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
...
signal out_2_cout1_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_imag_dout1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal out_3_real_dout1_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal out_4_sizeout1_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal out_5_cpout1_tpl_dut : STD_LOGIC_VECTOR (10 downto 0);
...
-- General Purpose data in real output
checkin_2_valid1_tpl : process (clk, areset, in_2_valid1_tpl_dut, in_2_valid1_tpl_stm)
begin
END PROCESS;
...
dut : ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT port map (
    ...
    out_4_sizeout1_tpl_dut,
    out_5_cpout1_tpl_dut,
    out_6_nprb_tpl_dut,
...
sim : ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_stm port map (
    in_1_imag_data1_tpl_stm,
    in_1_real_data1_tpl_stm,
    in_2_valid1_tpl_stm,
    in_3_channel1_tpl_stm,
    ...
    out_4_sizeout1_tpl_stm,
    out_5_cpout1_tpl_stm,
    out_6_nprb_tpl_stm,
