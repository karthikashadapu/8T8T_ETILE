...
if {! [file exists $base_dir/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_SOP_EOP_gen]} {
    file delete -force $base_dir/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_SOP_EOP_gen
}

project new $base_dir ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_SOP_EOP_gen
...
do "$base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_SOP_EOP_gen_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_SOP_EOP_gen_atb.vhd}
project addfile $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_SOP_EOP_gen_atb.vhd vhdl
project addfile $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_SOP_EOP_gen_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_4_eAxC_out_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_4_eAxC_out_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_5_eop_eAxC_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_5_eop_eAxC_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_6_eop_sym_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_6_eop_sym_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_7_sop_eAxC_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_7_sop_eAxC_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_8_sop_sym_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_8_sop_sym_tpl $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_SOP_EOP_gen_atb $ll
    do $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_SOP_EOP_gen_atb.wav.do
