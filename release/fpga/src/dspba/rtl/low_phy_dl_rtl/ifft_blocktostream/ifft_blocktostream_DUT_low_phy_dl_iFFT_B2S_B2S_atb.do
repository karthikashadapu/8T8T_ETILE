...
if {! [file exists $base_dir/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_B2S]} {
    file delete -force $base_dir/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_B2S
}

project new $base_dir ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_B2S
...
do "$base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_B2S_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_B2S_atb.vhd}
project addfile $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_B2S_atb.vhd vhdl
project addfile $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_B2S_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_B2S_atb $ll
    do $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_B2S_atb.wav.do
