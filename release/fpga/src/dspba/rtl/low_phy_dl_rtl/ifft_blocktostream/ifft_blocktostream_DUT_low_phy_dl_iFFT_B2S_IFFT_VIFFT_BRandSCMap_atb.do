...
if {! [file exists $base_dir/standaloneTopLevel_ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_BRandSCMap]} {
    file delete -force $base_dir/standaloneTopLevel_ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_BRandSCMap
}

project new $base_dir standaloneTopLevel_ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_BRandSCMap
...
do "$base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_BRandSCMap_fpc.do"
...
project addfile $base_dir/ifft_blocktostream/standaloneTopLevel_ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_BRandSCMap.sv systemverilog
...
puts {vcom -quiet -O0 $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_BRandSCMap_atb.vhd}
project addfile $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_BRandSCMap_atb.vhd vhdl
project addfile $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_BRandSCMap_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_qc_s} mismatch] == 0 && $mismatch } {
                report_mismatch qc_s $cyclenum
            }
            ...
            if { [catch {exa mismatch_ready_s} mismatch] == 0 && $mismatch } {
                report_mismatch ready_s $cyclenum
            }
            if { [catch {exa mismatch_size_out_s} mismatch] == 0 && $mismatch } {
                report_mismatch size_out_s $cyclenum
            }
            if { [catch {exa mismatch_cp_len_s} mismatch] == 0 && $mismatch } {
                report_mismatch cp_len_s $cyclenum
            }
            if { [catch {exa mismatch_q_rc_off_im} mismatch] == 0 && $mismatch } {
                report_mismatch q_rc_off_im $cyclenum
            }
            if { [catch {exa mismatch_q_rc_off_re} mismatch] == 0 && $mismatch } {
                report_mismatch q_rc_off_re $cyclenum
            }
            if { [catch {exa mismatch_fd_time_out_s} mismatch] == 0 && $mismatch } {
                report_mismatch fd_time_out_s $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps standaloneTopLevel_ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_BRandSCMap_atb $ll
    do $base_dir/ifft_blocktostream/ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_BRandSCMap_atb.wav.do
