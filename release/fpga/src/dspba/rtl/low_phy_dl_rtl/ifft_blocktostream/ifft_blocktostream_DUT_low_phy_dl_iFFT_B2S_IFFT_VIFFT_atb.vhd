...
entity ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_atb is
end;

architecture normal of ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_atb is

component ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT is
    port (
        in_1_imag_data_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en14
        in_1_real_data_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en14
        in_2_valid_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_3_channel_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_4_size_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        in_5_cplen_tpl : in std_logic_vector(10 downto 0);  -- ufix11
        in_6_nsc_tpl : in std_logic_vector(11 downto 0);  -- ufix12
        in_7_ifft_gain_re_tpl : in std_logic_vector(15 downto 0);  -- ufix16_en14
        in_8_ifft_gain_im_tpl : in std_logic_vector(15 downto 0);  -- ufix16_en14
        in_9_ifft_shift_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        in_10_ifft_mux_const_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en15
        in_11_muxsel_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        ...
        out_4_sizeout_tpl : out std_logic_vector(3 downto 0);  -- ufix4
        out_5_cplen_Out_tpl : out std_logic_vector(10 downto 0);  -- ufix11
        out_6_nprb_tpl : out std_logic_vector(11 downto 0);  -- ufix12
        out_7_fd_data_v_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_8_fd_data_c_tpl : out std_logic_vector(7 downto 0);  -- ufix8
        out_9_imag_fd_data_q_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en14
        out_9_real_fd_data_q_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en14
        out_10_fd_time_out_tpl : out std_logic_vector(63 downto 0);  -- ufix64
...
component ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_stm is
    port (
...
signal in_1_imag_data_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_1_real_data_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_2_valid_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_3_channel_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal in_4_size_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal in_5_cplen_tpl_stm : STD_LOGIC_VECTOR (10 downto 0);
signal in_6_nsc_tpl_stm : STD_LOGIC_VECTOR (11 downto 0);
signal in_7_ifft_gain_re_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_8_ifft_gain_im_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_9_ifft_shift_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal in_10_ifft_mux_const_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_11_muxsel_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
...
signal out_4_sizeout_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal out_5_cplen_Out_tpl_stm : STD_LOGIC_VECTOR (10 downto 0);
signal out_6_nprb_tpl_stm : STD_LOGIC_VECTOR (11 downto 0);
signal out_7_fd_data_v_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_8_fd_data_c_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal out_9_imag_fd_data_q_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal out_9_real_fd_data_q_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal out_10_fd_time_out_tpl_stm : STD_LOGIC_VECTOR (63 downto 0);
...
signal in_1_imag_data_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_1_real_data_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_2_valid_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_3_channel_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal in_4_size_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal in_5_cplen_tpl_dut : STD_LOGIC_VECTOR (10 downto 0);
signal in_6_nsc_tpl_dut : STD_LOGIC_VECTOR (11 downto 0);
signal in_7_ifft_gain_re_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_8_ifft_gain_im_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_9_ifft_shift_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal in_10_ifft_mux_const_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_11_muxsel_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
...
signal out_4_sizeout_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal out_5_cplen_Out_tpl_dut : STD_LOGIC_VECTOR (10 downto 0);
signal out_6_nprb_tpl_dut : STD_LOGIC_VECTOR (11 downto 0);
signal out_7_fd_data_v_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_8_fd_data_c_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal out_9_imag_fd_data_q_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal out_9_real_fd_data_q_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal out_10_fd_time_out_tpl_dut : STD_LOGIC_VECTOR (63 downto 0);
...
checkin_1_imag_data_tpl : process (clk, areset, in_1_imag_data_tpl_dut, in_1_imag_data_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_1_real_data_tpl : process (clk, areset, in_1_real_data_tpl_dut, in_1_real_data_tpl_stm)
begin
END PROCESS;
...
-- General Purpose data in real output
checkin_3_channel_tpl : process (clk, areset, in_3_channel_tpl_dut, in_3_channel_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_4_size_tpl : process (clk, areset, in_4_size_tpl_dut, in_4_size_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_5_cplen_tpl : process (clk, areset, in_5_cplen_tpl_dut, in_5_cplen_tpl_stm)
begin
END PROCESS;
...
-- General Purpose data in real output
checkin_7_ifft_gain_re_tpl : process (clk, areset, in_7_ifft_gain_re_tpl_dut, in_7_ifft_gain_re_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_8_ifft_gain_im_tpl : process (clk, areset, in_8_ifft_gain_im_tpl_dut, in_8_ifft_gain_im_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_9_ifft_shift_tpl : process (clk, areset, in_9_ifft_shift_tpl_dut, in_9_ifft_shift_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_10_ifft_mux_const_tpl : process (clk, areset, in_10_ifft_mux_const_tpl_dut, in_10_ifft_mux_const_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_11_muxsel_tpl : process (clk, areset, in_11_muxsel_tpl_dut, in_11_muxsel_tpl_stm)
begin
END PROCESS;
...
dut : ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT port map (
    in_1_imag_data_tpl_stm,
    in_1_real_data_tpl_stm,
    in_2_valid_tpl_stm,
    in_3_channel_tpl_stm,
    in_4_size_tpl_stm,
    in_5_cplen_tpl_stm,
    in_6_nsc_tpl_stm,
    in_7_ifft_gain_re_tpl_stm,
    in_8_ifft_gain_im_tpl_stm,
    in_9_ifft_shift_tpl_stm,
    in_10_ifft_mux_const_tpl_stm,
    in_11_muxsel_tpl_stm,
    ...
    out_2_vout_tpl_dut,
    out_3_cout_tpl_dut,
    out_4_sizeout_tpl_dut,
    out_5_cplen_Out_tpl_dut,
    out_6_nprb_tpl_dut,
    out_7_fd_data_v_tpl_dut,
    out_8_fd_data_c_tpl_dut,
    out_9_imag_fd_data_q_tpl_dut,
    out_9_real_fd_data_q_tpl_dut,
    out_10_fd_time_out_tpl_dut,
...
sim : ifft_blocktostream_DUT_low_phy_dl_iFFT_B2S_IFFT_VIFFT_stm port map (
    in_1_imag_data_tpl_stm,
    in_1_real_data_tpl_stm,
    in_2_valid_tpl_stm,
    in_3_channel_tpl_stm,
    ...
    out_2_vout_tpl_stm,
    out_3_cout_tpl_stm,
    out_4_sizeout_tpl_stm,
    out_5_cplen_Out_tpl_stm,
    out_6_nprb_tpl_stm,
    out_7_fd_data_v_tpl_stm,
    out_8_fd_data_c_tpl_stm,
    out_9_imag_fd_data_q_tpl_stm,
    out_9_real_fd_data_q_tpl_stm,
    out_10_fd_time_out_tpl_stm,
