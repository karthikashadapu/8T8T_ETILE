...
-- VHDL created from ifft_blocktostream_DUT
-- VHDL created on Thu Jun 12 21:17:49 2025
...
entity ifft_blocktostream_DUT_atb is
end;

architecture normal of ifft_blocktostream_DUT_atb is

component ifft_blocktostream_DUT is
    port (
        ...
        td_ifft_out_data_im : out std_logic_vector(15 downto 0);  -- sfix16_en14
        td_ifft_out_data_re : out std_logic_vector(15 downto 0);  -- sfix16_en14
        td_ifft_out_ch_s : out std_logic_vector(7 downto 0);  -- ufix8
        td_ifft_out_valid_s : out std_logic_vector(0 downto 0);  -- ufix1
...
component ifft_blocktostream_DUT_stm is
    port (
        ...
        td_ifft_out_data_im_stm : out std_logic_vector(15 downto 0);
        td_ifft_out_data_re_stm : out std_logic_vector(15 downto 0);
        td_ifft_out_ch_s_stm : out std_logic_vector(7 downto 0);
        td_ifft_out_valid_s_stm : out std_logic_vector(0 downto 0);
...
signal td_ifft_out_data_im_stm : STD_LOGIC_VECTOR (15 downto 0);
signal td_ifft_out_data_re_stm : STD_LOGIC_VECTOR (15 downto 0);
signal td_ifft_out_ch_s_stm : STD_LOGIC_VECTOR (7 downto 0);
signal td_ifft_out_valid_s_stm : STD_LOGIC_VECTOR (0 downto 0);
...
signal td_ifft_out_data_im_dut : STD_LOGIC_VECTOR (15 downto 0);
signal td_ifft_out_data_re_dut : STD_LOGIC_VECTOR (15 downto 0);
signal td_ifft_out_ch_s_dut : STD_LOGIC_VECTOR (7 downto 0);
signal td_ifft_out_valid_s_dut : STD_LOGIC_VECTOR (0 downto 0);
...
-- General Purpose data out check
checktd_ifft_out_data_im : process (clk, areset)
variable mismatch_td_ifft_out_data_im : BOOLEAN := FALSE;
variable ok : BOOLEAN := TRUE;
begin
    IF ((areset = '1')) THEN
        -- do nothing during reset
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ok := TRUE;
        mismatch_td_ifft_out_data_im := FALSE;
        IF ( (td_ifft_out_data_im_dut /= td_ifft_out_data_im_stm) and td_ifft_out_valid_s_dut = "1") THEN
            mismatch_td_ifft_out_data_im := TRUE;
            report "Mismatch on device output pin td_ifft_out_data_im" severity Warning;
        END IF;
        IF (mismatch_td_ifft_out_data_im = TRUE) THEN
            ok := FALSE;
        END IF;
        assert (ok)
...
-- General Purpose data out check
checktd_ifft_out_data_re : process (clk, areset)
variable mismatch_td_ifft_out_data_re : BOOLEAN := FALSE;
variable ok : BOOLEAN := TRUE;
begin
    IF ((areset = '1')) THEN
        -- do nothing during reset
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ok := TRUE;
        mismatch_td_ifft_out_data_re := FALSE;
        IF ( (td_ifft_out_data_re_dut /= td_ifft_out_data_re_stm) and td_ifft_out_valid_s_dut = "1") THEN
            mismatch_td_ifft_out_data_re := TRUE;
            report "Mismatch on device output pin td_ifft_out_data_re" severity Warning;
        END IF;
        IF (mismatch_td_ifft_out_data_re = TRUE) THEN
            ok := FALSE;
        END IF;
        assert (ok)
        report "mismatch in device level signal." severity Failure;
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ( (td_ifft_out_ch_s_dut /= td_ifft_out_ch_s_stm) and td_ifft_out_valid_s_dut = "1") THEN
...
-- General Purpose data out check
checktd_ifft_out_valid_s : process (clk, areset)
variable mismatch_td_ifft_out_valid_s : BOOLEAN := FALSE;
variable ok : BOOLEAN := TRUE;
begin
    IF ((areset = '1')) THEN
        -- do nothing during reset
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ok := TRUE;
        mismatch_td_ifft_out_valid_s := FALSE;
        IF ( (td_ifft_out_valid_s_dut /= td_ifft_out_valid_s_stm)) THEN
            mismatch_td_ifft_out_valid_s := TRUE;
            report "Mismatch on device output pin td_ifft_out_valid_s" severity Warning;
        END IF;
        IF (mismatch_td_ifft_out_valid_s = TRUE) THEN
            ok := FALSE;
        END IF;
        assert (ok)
        report "mismatch in device level signal." severity Failure;
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ( (ifft_size_out_s_dut /= ifft_size_out_s_stm) and td_ifft_out_valid_s_dut = "1") THEN
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF ( (ifft_cp_out_s_dut /= ifft_cp_out_s_stm) and td_ifft_out_valid_s_dut = "1") THEN
...
dut : ifft_blocktostream_DUT port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
    ...
    dout2_im_dut,
    dout2_re_dut,
    td_ifft_out_data_im_dut,
    td_ifft_out_data_re_dut,
    td_ifft_out_ch_s_dut,
    td_ifft_out_valid_s_dut,
    ifft_size_out_s_dut,
    ifft_nprb_out_s_dut,
    ifft_cp_out_s_dut,
    fd_data_v_s_dut,
...
sim : ifft_blocktostream_DUT_stm port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
    ...
    dout2_im_stm,
    dout2_re_stm,
    td_ifft_out_data_im_stm,
    td_ifft_out_data_re_stm,
    td_ifft_out_ch_s_stm,
    td_ifft_out_valid_s_stm,
    ifft_size_out_s_stm,
    ifft_nprb_out_s_stm,
    ifft_cp_out_s_stm,
    fd_data_v_s_stm,
