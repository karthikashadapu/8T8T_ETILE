...
// SystemVerilog created from ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer
...
module ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer (
    ...
    ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer_ComplexMixer theComplexMixer (
    ...
    // Scaleq(BLACKBOX,5)
    ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer_Scaleq theScaleq (
    ...
    // Scalei(BLACKBOX,4)
    ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer_Scalei theScalei (
