...
// SystemVerilog created from ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite
...
module ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite (
    ...
    input wire [3:0] in_5_fft_size_tpl,
    input wire [10:0] in_6_CPLen_tpl,
    input wire [11:0] in_7_nsc_tpl,
    input wire [0:0] in_8_eAxC_tpl,
    input wire [0:0] in_9_sym_metadata_tpl,
    ...
    output wire [3:0] out_4_fft_size_out_tpl,
    output wire [10:0] out_5_CPLenout_tpl,
    output wire [11:0] out_6_nsc_out_tpl,
    output wire [0:0] out_7_eAxCout_tpl,
    output wire [0:0] out_8_sym_metadataout_tpl,
    ...
    wire [3:0] PhasorGenerate_cunroll_x_out_6_fft_size_out_tpl;
    wire [10:0] PhasorGenerate_cunroll_x_out_7_CPLenout_tpl;
    wire [11:0] PhasorGenerate_cunroll_x_out_8_nsc_out_tpl;
    wire [0:0] PhasorGenerate_cunroll_x_out_9_eAxC_out_tpl;
    wire [0:0] PhasorGenerate_cunroll_x_out_10_sym_metadata_out_tpl;
    ...
    wire [0:0] SOP_EOP_gen_cunroll_x_out_4_eAxC_out_tpl;
    ...
    ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_PhasorGenerate thePhasorGenerate_cunroll_x (
    ...
    ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_ComplexMixer theComplexMixer_cunroll_x (
    ...
    ifft_blocktostream_DUT_low_phy_dl_PhaseCompensation_lite_SOP_EOP_gen theSOP_EOP_gen_cunroll_x (
