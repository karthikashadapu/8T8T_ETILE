...
// SystemVerilog created from busFabric_ca_interp_DUT_2ouiflr06j62696x6u0qu5xajz
...
module busFabric_ca_interp_DUT_2ouiflr06j62696x6u0qu5xajz (
    ...
    output wire [15:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Subsystem_RegField_x_tpl,
    output wire [15:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField_x_tpl,
    output wire [15:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField1_x_tpl,
    output wire [15:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField2_x_tpl,
    output wire [15:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField3_x_tpl,
    output wire [7:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField1_x_tpl,
    output wire [7:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField2_x_tpl,
    output wire [7:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField3_x_tpl,
    output wire [7:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField4_x_tpl,
    output wire [7:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField6_x_tpl,
    output wire [7:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField7_x_tpl,
    output wire [7:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField8_x_tpl,
    output wire [7:0] out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField9_x_tpl,
    input wire clk,
    input wire areset,
    input wire bus_clk,
    ...
    wire [15:0] ca_interp_DUT_Summer_DUC_Subsystem_RegField_bitsel_x_b;
    wire [15:0] ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField_bitsel_x_b;
    wire [15:0] ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField1_bitsel_x_b;
    wire [15:0] ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField2_bitsel_x_b;
    wire [15:0] ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField3_bitsel_x_b;
    wire [7:0] ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField1_bitsel_x_b;
    wire [7:0] ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField2_bitsel_x_b;
    wire [7:0] ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField3_bitsel_x_b;
    wire [7:0] ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField4_bitsel_x_b;
    wire [7:0] ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField6_bitsel_x_b;
    wire [7:0] ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField7_bitsel_x_b;
    wire [7:0] ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField8_bitsel_x_b;
    wire [7:0] ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField9_bitsel_x_b;
    ...
    // ca_interp_DUT_Summer_DUC_Subsystem_RegField_bitsel_x(BITSELECT,61)@0
    assign ca_interp_DUT_Summer_DUC_Subsystem_RegField_bitsel_x_b = mm_reg_4_x_v[15:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Subsystem_RegField_x_tpl(GPOUT,20)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Subsystem_RegField_x_tpl = ca_interp_DUT_Summer_DUC_Subsystem_RegField_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField_bitsel_x(BITSELECT,63)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField_bitsel_x_b = mm_reg_0_x_v[15:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField_x_tpl(GPOUT,21)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField1_bitsel_x(BITSELECT,65)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField1_bitsel_x_b = mm_reg_1_x_v[15:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField1_x_tpl(GPOUT,22)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField1_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField1_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField2_bitsel_x(BITSELECT,67)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField2_bitsel_x_b = mm_reg_2_x_v[15:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField2_x_tpl(GPOUT,23)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField2_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField2_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField3_bitsel_x(BITSELECT,69)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField3_bitsel_x_b = mm_reg_3_x_v[15:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField3_x_tpl(GPOUT,24)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField3_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Carrier_Aggregation_and_Gain_RegField3_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField1_bitsel_x(BITSELECT,71)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField1_bitsel_x_b = mm_reg_7_x_v[7:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField1_x_tpl(GPOUT,25)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField1_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField1_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField2_bitsel_x(BITSELECT,73)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField2_bitsel_x_b = mm_reg_8_x_v[7:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField2_x_tpl(GPOUT,26)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField2_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField2_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField3_bitsel_x(BITSELECT,75)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField3_bitsel_x_b = mm_reg_11_x_v[7:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField3_x_tpl(GPOUT,27)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField3_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField3_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField4_bitsel_x(BITSELECT,77)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField4_bitsel_x_b = mm_reg_5_x_v[7:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField4_x_tpl(GPOUT,28)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField4_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField4_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField6_bitsel_x(BITSELECT,79)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField6_bitsel_x_b = mm_reg_6_x_v[7:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField6_x_tpl(GPOUT,29)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField6_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField6_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField7_bitsel_x(BITSELECT,81)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField7_bitsel_x_b = mm_reg_12_x_v[7:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField7_x_tpl(GPOUT,30)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField7_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField7_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField8_bitsel_x(BITSELECT,83)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField8_bitsel_x_b = mm_reg_9_x_v[7:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField8_x_tpl(GPOUT,31)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField8_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField8_bitsel_x_b;

    // ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField9_bitsel_x(BITSELECT,85)@0
    assign ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField9_bitsel_x_b = mm_reg_10_x_v[7:0];

    // out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField9_x_tpl(GPOUT,32)@0
    assign out_AMMregisterWireData_ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField9_x_tpl = ca_interp_DUT_Summer_DUC_Summer_Delay_Compensation_RegField9_bitsel_x_b;
