...
if {! [file exists $base_dir/ca_interp_DUT_Summer_DUC_Summer]} {
    file delete -force $base_dir/ca_interp_DUT_Summer_DUC_Summer
}

project new $base_dir ca_interp_DUT_Summer_DUC_Summer
...
do "$base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_atb.vhd}
project addfile $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_atb.vhd vhdl
project addfile $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_0_imag_alt_data1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_0_imag_alt_data1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_0_real_alt_data1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_0_real_alt_data1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_1_imag_alt_data1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_1_imag_alt_data1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_1_real_alt_data1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_1_real_alt_data1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_2_imag_alt_data1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_2_imag_alt_data1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_2_real_alt_data1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_2_real_alt_data1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_3_imag_alt_data1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_3_imag_alt_data1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_3_real_alt_data1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_3_real_alt_data1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_2_alt_v1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_alt_v1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_3_alt_c1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_alt_c1_tpl $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ca_interp_DUT_Summer_DUC_Summer_atb $ll
    do $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_atb.wav.do
