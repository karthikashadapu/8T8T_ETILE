...
if {! [file exists $base_dir/standaloneTopLevel_ca_interp_DUT_Summer_DUC_Subsystem]} {
    file delete -force $base_dir/standaloneTopLevel_ca_interp_DUT_Summer_DUC_Subsystem
}

project new $base_dir standaloneTopLevel_ca_interp_DUT_Summer_DUC_Subsystem
...
do "$base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Subsystem_fpc.do"
...
project addfile $base_dir/ca_interp/standaloneTopLevel_ca_interp_DUT_Summer_DUC_Subsystem.sv systemverilog
...
puts {vcom -quiet -O0 $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Subsystem_atb.vhd}
project addfile $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Subsystem_atb.vhd vhdl
project addfile $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Subsystem_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps standaloneTopLevel_ca_interp_DUT_Summer_DUC_Subsystem_atb $ll
    do $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Subsystem_atb.wav.do
