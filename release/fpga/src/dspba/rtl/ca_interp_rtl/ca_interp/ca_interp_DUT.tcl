# This is the top level tcl file for 'ca_interp_DUT'
...
if {!$overwrite_opt && [project_exists ca_interp_DUT]} {
    puts "The ca_interp_DUT quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "../../rtl/ca_interp_rtl/ca_interp/ca_interp_DUT.tcl"]}    {
    puts "You must run ca_interp_DUT.tcl "
...
puts "Creating ca_interp_DUT Quartus project..."

if $overwrite_opt {
    project_new -overwrite ca_interp_DUT
} else {
    project_new ca_interp_DUT
}

set_global_assignment -name FAMILY "Agilex 7"
set_global_assignment -name TOP_LEVEL_ENTITY ca_interp_DUT
set_global_assignment -name DEVICE AGFB014R24A3E3V
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ../../rtl/ca_interp_rtl/ca_interp/ca_interp_DUT.sdc
set_global_assignment -name SYNCHRONIZATION_REGISTER_CHAIN_LENGTH 1
set_global_assignment -name SEARCH_PATH ../../rtl/ca_interp_rtl/ca_interp
source ./additional_settings.qsf
source ../../rtl/ca_interp_rtl/ca_interp/ca_interp_DUT.add.tcl

set_instance_assignment -name DUPLICATE_REGISTER 2 -to reset_fanout_mitigation_signal_out[*]
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Valid_l1_s
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Chan_l1_s
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l1_0im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l1_0re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l1_1im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l1_1re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l1_2im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l1_2re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l1_3im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l1_3re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Valid_l2_s
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Chan_l2_s
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l2_0im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l2_0re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l2_1im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l2_1re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l2_2im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l2_2re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l2_3im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l2_3re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Valid_Out_s
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Chan_Out_s
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_0im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_0re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_1im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_1re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_2im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_2re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_3im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_3re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_4im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_4re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_5im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_5re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_6im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_6re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_7im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Ant_Data_Out_7re
set_instance_assignment -name VIRTUAL_PIN ON -to summer_vout_s
set_instance_assignment -name VIRTUAL_PIN ON -to summer_cout_s
set_instance_assignment -name VIRTUAL_PIN ON -to summer_dout_0im
set_instance_assignment -name VIRTUAL_PIN ON -to summer_dout_0re
set_instance_assignment -name VIRTUAL_PIN ON -to summer_dout_1im
set_instance_assignment -name VIRTUAL_PIN ON -to summer_dout_1re
set_instance_assignment -name VIRTUAL_PIN ON -to summer_dout_2im
set_instance_assignment -name VIRTUAL_PIN ON -to summer_dout_2re
set_instance_assignment -name VIRTUAL_PIN ON -to summer_dout_3im
set_instance_assignment -name VIRTUAL_PIN ON -to summer_dout_3re
...
source "../../rtl/ca_interp_rtl/ca_interp/ca_interp_DUT_fpc.add.tcl"
