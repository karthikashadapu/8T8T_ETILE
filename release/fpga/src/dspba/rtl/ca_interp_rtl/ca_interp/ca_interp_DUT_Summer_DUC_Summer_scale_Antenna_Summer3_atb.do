...
if {! [file exists $base_dir/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer3]} {
    file delete -force $base_dir/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer3
}

project new $base_dir ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer3
...
do "$base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer3_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer3_atb.vhd}
project addfile $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer3_atb.vhd vhdl
project addfile $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer3_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer3_atb $ll
    do $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer3_atb.wav.do
