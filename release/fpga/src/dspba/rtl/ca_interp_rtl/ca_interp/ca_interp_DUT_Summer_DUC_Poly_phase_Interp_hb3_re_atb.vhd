...
-- VHDL created from ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_re
...
entity ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_re_atb is
end;

architecture normal of ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_re_atb is

component ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_re is
    port (
        ...
        xOut_1 : out std_logic_vector(37 downto 0);  -- sfix38
        xOut_2 : out std_logic_vector(37 downto 0);  -- sfix38
        xOut_3 : out std_logic_vector(37 downto 0);  -- sfix38
        xOut_4 : out std_logic_vector(37 downto 0);  -- sfix38
        xOut_5 : out std_logic_vector(37 downto 0);  -- sfix38
        xOut_6 : out std_logic_vector(37 downto 0);  -- sfix38
        xOut_7 : out std_logic_vector(37 downto 0);  -- sfix38
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_re_stm is
    port (
...
signal xOut_1_stm : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_2_stm : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_3_stm : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_4_stm : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_5_stm : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_6_stm : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_7_stm : STD_LOGIC_VECTOR (37 downto 0);
...
signal xOut_1_dut : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_2_dut : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_3_dut : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_4_dut : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_5_dut : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_6_dut : STD_LOGIC_VECTOR (37 downto 0);
signal xOut_7_dut : STD_LOGIC_VECTOR (37 downto 0);
...
checkxIn : process (clk, areset, xIn_0_dut, xIn_0_stm, xIn_1_dut, xIn_1_stm, xIn_2_dut, xIn_2_stm, xIn_3_dut, xIn_3_stm)
begin
END PROCESS;


-- Channelized data out check
checkxOut : process (clk, areset, xOut_0_dut, xOut_0_stm, xOut_1_dut, xOut_1_stm, xOut_2_dut, xOut_2_stm, xOut_3_dut, xOut_3_stm, xOut_4_dut, xOut_4_stm, xOut_5_dut, xOut_5_stm, xOut_6_dut, xOut_6_stm, xOut_7_dut, xOut_7_stm)
...
variable mismatch_xOut_4 : BOOLEAN := FALSE;
variable mismatch_xOut_5 : BOOLEAN := FALSE;
variable mismatch_xOut_6 : BOOLEAN := FALSE;
variable mismatch_xOut_7 : BOOLEAN := FALSE;
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        mismatch_xOut_4 := FALSE;
        mismatch_xOut_5 := FALSE;
        mismatch_xOut_6 := FALSE;
        mismatch_xOut_7 := FALSE;
        ...
        IF ((xOut_v_dut = "1")) THEN
            ...
            END IF;
            IF ( (xOut_4_dut /= xOut_4_stm)) THEN
                mismatch_xOut_4 := TRUE;
                report "mismatch in xOut_4 signal" severity Warning;
            END IF;
            IF ( (xOut_5_dut /= xOut_5_stm)) THEN
                mismatch_xOut_5 := TRUE;
                report "mismatch in xOut_5 signal" severity Warning;
            END IF;
            IF ( (xOut_6_dut /= xOut_6_stm)) THEN
                mismatch_xOut_6 := TRUE;
                report "mismatch in xOut_6 signal" severity Warning;
            END IF;
            IF ( (xOut_7_dut /= xOut_7_stm)) THEN
                mismatch_xOut_7 := TRUE;
                report "mismatch in xOut_7 signal" severity Warning;
            END IF;
        END IF;
        IF (mismatch_xOut_v = TRUE or mismatch_xOut_c = TRUE or mismatch_xOut_0 = TRUE or mismatch_xOut_1 = TRUE or mismatch_xOut_2 = TRUE or mismatch_xOut_3 = TRUE or mismatch_xOut_4 = TRUE or mismatch_xOut_5 = TRUE or mismatch_xOut_6 = TRUE or mismatch_xOut_7 = TRUE) THEN
            ok := FALSE;
        END IF;
        IF (ok = FALSE) THEN
...
dut : ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_re port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
...
sim : ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_re_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
