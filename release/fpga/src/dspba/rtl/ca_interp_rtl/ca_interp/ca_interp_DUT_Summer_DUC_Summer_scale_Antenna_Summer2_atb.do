...
if {! [file exists $base_dir/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer2]} {
    file delete -force $base_dir/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer2
}

project new $base_dir ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer2
...
do "$base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer2_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer2_atb.vhd}
project addfile $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer2_atb.vhd vhdl
project addfile $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer2_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer2_atb $ll
    do $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Summer_scale_Antenna_Summer2_atb.wav.do
