...
entity ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im_atb is
end;

architecture normal of ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im_atb is

component ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im is
    port (
...
component ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im_stm is
    port (
...
dut : ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
...
sim : ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
