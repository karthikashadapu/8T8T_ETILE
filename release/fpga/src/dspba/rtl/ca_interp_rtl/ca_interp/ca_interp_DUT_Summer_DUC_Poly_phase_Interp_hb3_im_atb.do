...
if {! [file exists $base_dir/ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im]} {
    file delete -force $base_dir/ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im
}

project new $base_dir ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im
...
do "$base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im_atb.vhd}
project addfile $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im_atb.vhd vhdl
project addfile $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im_atb $ll
    do $base_dir/ca_interp/ca_interp_DUT_Summer_DUC_Poly_phase_Interp_hb3_im_atb.wav.do
