# This is the top level tcl file for 'dec_dly_comp_DUT'
...
if {!$overwrite_opt && [project_exists dec_dly_comp_DUT]} {
    puts "The dec_dly_comp_DUT quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "../../rtl/dec_dly_comp_rtl/dec_dly_comp/dec_dly_comp_DUT.tcl"]}    {
    puts "You must run dec_dly_comp_DUT.tcl "
...
puts "Creating dec_dly_comp_DUT Quartus project..."

if $overwrite_opt {
    project_new -overwrite dec_dly_comp_DUT
} else {
    project_new dec_dly_comp_DUT
}

set_global_assignment -name FAMILY "Agilex 7"
set_global_assignment -name TOP_LEVEL_ENTITY dec_dly_comp_DUT
set_global_assignment -name DEVICE AGFB014R24A3E3V
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ../../rtl/dec_dly_comp_rtl/dec_dly_comp/dec_dly_comp_DUT.sdc
set_global_assignment -name SYNCHRONIZATION_REGISTER_CHAIN_LENGTH 1
set_global_assignment -name SEARCH_PATH ../../rtl/dec_dly_comp_rtl/dec_dly_comp
source ./additional_settings.qsf
source ../../rtl/dec_dly_comp_rtl/dec_dly_comp/dec_dly_comp_DUT.add.tcl
...
set_instance_assignment -name VIRTUAL_PIN ON -to DDC_Ant_Data_In_4im
set_instance_assignment -name VIRTUAL_PIN ON -to DDC_Ant_Data_In_4re
set_instance_assignment -name VIRTUAL_PIN ON -to DDC_Ant_Data_In_5im
set_instance_assignment -name VIRTUAL_PIN ON -to DDC_Ant_Data_In_5re
set_instance_assignment -name VIRTUAL_PIN ON -to DDC_Ant_Data_In_6im
set_instance_assignment -name VIRTUAL_PIN ON -to DDC_Ant_Data_In_6re
set_instance_assignment -name VIRTUAL_PIN ON -to DDC_Ant_Data_In_7im
set_instance_assignment -name VIRTUAL_PIN ON -to DDC_Ant_Data_In_7re
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l1_dout_0im
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l1_dout_0re
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l1_dout_1im
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l1_dout_1re
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l1_dout_2im
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l1_dout_2re
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l1_dout_3im
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l1_dout_3re
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l1_vout_s
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l1_cout_s
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l2_dout_0im
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l2_dout_0re
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l2_dout_1im
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l2_dout_1re
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l2_dout_2im
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l2_dout_2re
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l2_dout_3im
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l2_dout_3re
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l2_vout_s
set_instance_assignment -name VIRTUAL_PIN ON -to alq_l2_cout_s
...
source "../../rtl/dec_dly_comp_rtl/dec_dly_comp/dec_dly_comp_DUT_fpc.add.tcl"
