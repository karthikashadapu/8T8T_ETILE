...
if {! [file exists $base_dir/dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im]} {
    file delete -force $base_dir/dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im
}

project new $base_dir dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im
...
do "$base_dir/dec_dly_comp/dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/dec_dly_comp/dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im_atb.vhd}
project addfile $base_dir/dec_dly_comp/dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im_atb.vhd vhdl
project addfile $base_dir/dec_dly_comp/dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im_atb $ll
    do $base_dir/dec_dly_comp/dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im_atb.wav.do
