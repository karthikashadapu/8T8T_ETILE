...
entity dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im_atb is
end;

architecture normal of dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im_atb is

component dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im is
    port (
...
component dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im_stm is
    port (
...
dut : dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
...
sim : dec_dly_comp_DUT_DUT_Polyphase_Decimator_HB3_im_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
