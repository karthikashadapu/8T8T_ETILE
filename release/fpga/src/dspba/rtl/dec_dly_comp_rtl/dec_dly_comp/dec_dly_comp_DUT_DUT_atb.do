...
if {! [file exists $base_dir/standaloneTopLevel_dec_dly_comp_DUT_DUT]} {
    file delete -force $base_dir/standaloneTopLevel_dec_dly_comp_DUT_DUT
}

project new $base_dir standaloneTopLevel_dec_dly_comp_DUT_DUT
...
do "$base_dir/dec_dly_comp/dec_dly_comp_DUT_DUT_fpc.do"
...
project addfile $base_dir/dec_dly_comp/standaloneTopLevel_dec_dly_comp_DUT_DUT.sv systemverilog
...
puts {vcom -quiet -O0 $base_dir/dec_dly_comp/dec_dly_comp_DUT_DUT_atb.vhd}
project addfile $base_dir/dec_dly_comp/dec_dly_comp_DUT_DUT_atb.vhd vhdl
project addfile $base_dir/dec_dly_comp/dec_dly_comp_DUT_DUT_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_q1_0im} mismatch] == 0 && $mismatch } {
                report_mismatch q1_0im $cyclenum
            }
            if { [catch {exa mismatch_q1_0re} mismatch] == 0 && $mismatch } {
                report_mismatch q1_0re $cyclenum
            }
            if { [catch {exa mismatch_q1_1im} mismatch] == 0 && $mismatch } {
                report_mismatch q1_1im $cyclenum
            }
            if { [catch {exa mismatch_q1_1re} mismatch] == 0 && $mismatch } {
                report_mismatch q1_1re $cyclenum
            }
            if { [catch {exa mismatch_q1_2im} mismatch] == 0 && $mismatch } {
                report_mismatch q1_2im $cyclenum
            }
            if { [catch {exa mismatch_q1_2re} mismatch] == 0 && $mismatch } {
                report_mismatch q1_2re $cyclenum
            }
            if { [catch {exa mismatch_q1_3im} mismatch] == 0 && $mismatch } {
                report_mismatch q1_3im $cyclenum
            }
            if { [catch {exa mismatch_q1_3re} mismatch] == 0 && $mismatch } {
                report_mismatch q1_3re $cyclenum
            }
            if { [catch {exa mismatch_q_v1_s} mismatch] == 0 && $mismatch } {
                report_mismatch q_v1_s $cyclenum
            }
            if { [catch {exa mismatch_q_c1_s} mismatch] == 0 && $mismatch } {
                report_mismatch q_c1_s $cyclenum
            }
            if { [catch {exa mismatch_q2_0im} mismatch] == 0 && $mismatch } {
                report_mismatch q2_0im $cyclenum
            }
            if { [catch {exa mismatch_q2_0re} mismatch] == 0 && $mismatch } {
                report_mismatch q2_0re $cyclenum
            }
            if { [catch {exa mismatch_q2_1im} mismatch] == 0 && $mismatch } {
                report_mismatch q2_1im $cyclenum
            }
            if { [catch {exa mismatch_q2_1re} mismatch] == 0 && $mismatch } {
                report_mismatch q2_1re $cyclenum
            }
            if { [catch {exa mismatch_q2_2im} mismatch] == 0 && $mismatch } {
                report_mismatch q2_2im $cyclenum
            }
            if { [catch {exa mismatch_q2_2re} mismatch] == 0 && $mismatch } {
                report_mismatch q2_2re $cyclenum
            }
            if { [catch {exa mismatch_q2_3im} mismatch] == 0 && $mismatch } {
                report_mismatch q2_3im $cyclenum
            }
            if { [catch {exa mismatch_q2_3re} mismatch] == 0 && $mismatch } {
                report_mismatch q2_3re $cyclenum
            }
            if { [catch {exa mismatch_q_v2_s} mismatch] == 0 && $mismatch } {
                report_mismatch q_v2_s $cyclenum
            }
            if { [catch {exa mismatch_q_c2_s} mismatch] == 0 && $mismatch } {
                report_mismatch q_c2_s $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps standaloneTopLevel_dec_dly_comp_DUT_DUT_atb $ll
    do $base_dir/dec_dly_comp/dec_dly_comp_DUT_DUT_atb.wav.do
