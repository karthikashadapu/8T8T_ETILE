...
-- VHDL created from dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_im
...
entity dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_im_atb is
end;

architecture normal of dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_im_atb is

component dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_im is
    port (
        xIn_v : in std_logic_vector(0 downto 0);  -- sfix1
        xIn_c : in std_logic_vector(7 downto 0);  -- sfix8
        xIn_0 : in std_logic_vector(38 downto 0);  -- sfix39
        xIn_1 : in std_logic_vector(38 downto 0);  -- sfix39
        xIn_2 : in std_logic_vector(38 downto 0);  -- sfix39
        xIn_3 : in std_logic_vector(38 downto 0);  -- sfix39
...
component dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_im_stm is
    port (
        xIn_v_stm : out std_logic_vector(0 downto 0);
        xIn_c_stm : out std_logic_vector(7 downto 0);
        xIn_0_stm : out std_logic_vector(38 downto 0);
        xIn_1_stm : out std_logic_vector(38 downto 0);
        xIn_2_stm : out std_logic_vector(38 downto 0);
        xIn_3_stm : out std_logic_vector(38 downto 0);
...
signal xIn_0_stm : STD_LOGIC_VECTOR (38 downto 0);
signal xIn_1_stm : STD_LOGIC_VECTOR (38 downto 0);
signal xIn_2_stm : STD_LOGIC_VECTOR (38 downto 0);
signal xIn_3_stm : STD_LOGIC_VECTOR (38 downto 0);
...
signal xIn_0_dut : STD_LOGIC_VECTOR (38 downto 0);
signal xIn_1_dut : STD_LOGIC_VECTOR (38 downto 0);
signal xIn_2_dut : STD_LOGIC_VECTOR (38 downto 0);
signal xIn_3_dut : STD_LOGIC_VECTOR (38 downto 0);
...
dut : dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_im port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
...
sim : dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_im_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
