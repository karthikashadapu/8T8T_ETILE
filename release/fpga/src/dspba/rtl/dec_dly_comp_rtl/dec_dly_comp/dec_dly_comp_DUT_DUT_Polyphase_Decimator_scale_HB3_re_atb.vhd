...
-- VHDL created from dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_re
...
entity dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_re_atb is
end;

architecture normal of dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_re_atb is

component dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_re is
    port (
...
component dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_re_stm is
    port (
...
dut : dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_re port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
...
sim : dec_dly_comp_DUT_DUT_Polyphase_Decimator_scale_HB3_re_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
