...
entity duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer_atb is
end;

architecture normal of duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer_atb is

component duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer is
    port (
        ...
        iIn_1 : in std_logic_vector(15 downto 0);  -- sfix16
        iIn_2 : in std_logic_vector(15 downto 0);  -- sfix16
        iIn_3 : in std_logic_vector(15 downto 0);  -- sfix16
        qIn_0 : in std_logic_vector(15 downto 0);  -- sfix16
        qIn_1 : in std_logic_vector(15 downto 0);  -- sfix16
        qIn_2 : in std_logic_vector(15 downto 0);  -- sfix16
        qIn_3 : in std_logic_vector(15 downto 0);  -- sfix16
        ...
        qOut_0 : out std_logic_vector(32 downto 0);  -- sfix33
        qOut_1 : out std_logic_vector(32 downto 0);  -- sfix33
        qOut_2 : out std_logic_vector(32 downto 0);  -- sfix33
        qOut_3 : out std_logic_vector(32 downto 0);  -- sfix33
        Out_v : out std_logic_vector(0 downto 0);  -- ufix1
        Out_c : out std_logic_vector(7 downto 0);  -- ufix8
        iOut_0 : out std_logic_vector(32 downto 0);  -- sfix33
        iOut_1 : out std_logic_vector(32 downto 0);  -- sfix33
        iOut_2 : out std_logic_vector(32 downto 0);  -- sfix33
        iOut_3 : out std_logic_vector(32 downto 0);  -- sfix33
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer_stm is
    port (
...
signal iIn_1_stm : STD_LOGIC_VECTOR (15 downto 0);
signal iIn_2_stm : STD_LOGIC_VECTOR (15 downto 0);
signal iIn_3_stm : STD_LOGIC_VECTOR (15 downto 0);
signal qIn_0_stm : STD_LOGIC_VECTOR (15 downto 0);
signal qIn_1_stm : STD_LOGIC_VECTOR (15 downto 0);
signal qIn_2_stm : STD_LOGIC_VECTOR (15 downto 0);
signal qIn_3_stm : STD_LOGIC_VECTOR (15 downto 0);
...
signal qOut_0_stm : STD_LOGIC_VECTOR (32 downto 0);
signal qOut_1_stm : STD_LOGIC_VECTOR (32 downto 0);
signal qOut_2_stm : STD_LOGIC_VECTOR (32 downto 0);
signal qOut_3_stm : STD_LOGIC_VECTOR (32 downto 0);
signal Out_v_stm : STD_LOGIC_VECTOR (0 downto 0);
signal Out_c_stm : STD_LOGIC_VECTOR (7 downto 0);
signal iOut_0_stm : STD_LOGIC_VECTOR (32 downto 0);
signal iOut_1_stm : STD_LOGIC_VECTOR (32 downto 0);
signal iOut_2_stm : STD_LOGIC_VECTOR (32 downto 0);
signal iOut_3_stm : STD_LOGIC_VECTOR (32 downto 0);
...
signal iIn_1_dut : STD_LOGIC_VECTOR (15 downto 0);
signal iIn_2_dut : STD_LOGIC_VECTOR (15 downto 0);
signal iIn_3_dut : STD_LOGIC_VECTOR (15 downto 0);
signal qIn_0_dut : STD_LOGIC_VECTOR (15 downto 0);
signal qIn_1_dut : STD_LOGIC_VECTOR (15 downto 0);
signal qIn_2_dut : STD_LOGIC_VECTOR (15 downto 0);
signal qIn_3_dut : STD_LOGIC_VECTOR (15 downto 0);
...
signal qOut_0_dut : STD_LOGIC_VECTOR (32 downto 0);
signal qOut_1_dut : STD_LOGIC_VECTOR (32 downto 0);
signal qOut_2_dut : STD_LOGIC_VECTOR (32 downto 0);
signal qOut_3_dut : STD_LOGIC_VECTOR (32 downto 0);
signal Out_v_dut : STD_LOGIC_VECTOR (0 downto 0);
signal Out_c_dut : STD_LOGIC_VECTOR (7 downto 0);
signal iOut_0_dut : STD_LOGIC_VECTOR (32 downto 0);
signal iOut_1_dut : STD_LOGIC_VECTOR (32 downto 0);
signal iOut_2_dut : STD_LOGIC_VECTOR (32 downto 0);
signal iOut_3_dut : STD_LOGIC_VECTOR (32 downto 0);
...
dut : duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer port map (
    In_v_stm,
    In_c_stm,
    iIn_0_stm,
    iIn_1_stm,
...
sim : duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer_stm port map (
    In_v_stm,
    In_c_stm,
    iIn_0_stm,
    iIn_1_stm,
