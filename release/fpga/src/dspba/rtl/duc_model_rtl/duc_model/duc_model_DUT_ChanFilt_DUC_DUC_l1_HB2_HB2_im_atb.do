...
if {! [file exists $base_dir/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im]} {
    file delete -force $base_dir/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im
}

project new $base_dir duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im
...
do "$base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im_atb.vhd}
project addfile $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im_atb.vhd vhdl
project addfile $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im_atb $ll
    do $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im_atb.wav.do
