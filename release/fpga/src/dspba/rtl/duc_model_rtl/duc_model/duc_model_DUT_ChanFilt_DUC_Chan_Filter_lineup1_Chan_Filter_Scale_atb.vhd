...
-- VHDL created from duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale
...
entity duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale_atb is
end;

architecture normal of duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale_atb is

component duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale is
    port (
...
component duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale_stm is
    port (
...
dut : duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
