...
-- VHDL created from duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1
...
entity duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_atb is
end;

architecture normal of duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_atb is

component duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1 is
    port (
        ...
        in_4_Config_CC1_tpl : in std_logic_vector(7 downto 0);  -- ufix8
...
component duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_stm is
    port (
        ...
        in_4_Config_CC1_tpl_stm : out std_logic_vector(7 downto 0);
...
signal in_4_Config_CC1_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
...
signal in_4_Config_CC1_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
...
checkin_1_imag_d_tpl : process (clk, areset, in_1_imag_d_tpl_dut, in_1_imag_d_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_1_real_d_tpl : process (clk, areset, in_1_real_d_tpl_dut, in_1_real_d_tpl_stm)
begin
END PROCESS;
...
-- General Purpose data in real output
checkin_4_Config_CC1_tpl : process (clk, areset, in_4_Config_CC1_tpl_dut, in_4_Config_CC1_tpl_stm)
begin
END PROCESS;


dut : duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1 port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
...
sim : duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_stm port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
