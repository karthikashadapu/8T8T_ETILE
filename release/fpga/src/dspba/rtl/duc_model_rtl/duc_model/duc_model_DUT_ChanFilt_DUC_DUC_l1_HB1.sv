...
// SystemVerilog created from duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1
...
module duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1 (
    ...
    wire [0:0] GND_q;
    wire [37:0] HB1_im_xOut_0;
    wire [37:0] HB1_im_xOut_1;
    wire [0:0] HB1_im_xOut_v;
    wire [7:0] HB1_im_xOut_c;
    wire [37:0] HB1_re_xOut_0;
    wire [37:0] HB1_re_xOut_1;
    wire [0:0] HB1_re_xOut_v;
    wire [7:0] HB1_re_xOut_c;
    wire [15:0] scale_HB1_im_qOut_0;
    wire [15:0] scale_HB1_im_qOut_1;
    wire [15:0] scale_HB1_re_qOut_0;
    wire [15:0] scale_HB1_re_qOut_1;
    ...
    // HB1_im(BLACKBOX,4)
    duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_HB1_im theHB1_im (
        .xIn_0(in_1_imag_a_tpl),
        .xIn_v(in_2_v_tpl),
        .xIn_c(in_3_c_tpl),
        .xOut_0(HB1_im_xOut_0),
        .xOut_1(HB1_im_xOut_1),
    ...
    duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_im thescale_HB1_im (
        .xIn_0(HB1_im_xOut_0),
        .xIn_1(HB1_im_xOut_1),
        .xIn_v(HB1_im_xOut_v),
        .xIn_c(HB1_im_xOut_c),
    ...
    // out_1_0_imag_q_tpl(GPOUT,12)
    assign out_1_0_imag_q_tpl = scale_HB1_im_qOut_0;

    // HB1_re(BLACKBOX,5)
    duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_HB1_re theHB1_re (
        .xIn_0(in_1_real_a_tpl),
        .xIn_v(in_2_v_tpl),
        .xIn_c(in_3_c_tpl),
        .xOut_0(HB1_re_xOut_0),
        .xOut_1(HB1_re_xOut_1),
    ...
    duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_re thescale_HB1_re (
        .xIn_0(HB1_re_xOut_0),
        .xIn_1(HB1_re_xOut_1),
        .xIn_v(HB1_re_xOut_v),
        .xIn_c(HB1_re_xOut_c),
    ...
    // out_1_0_real_q_tpl(GPOUT,13)
    assign out_1_0_real_q_tpl = scale_HB1_re_qOut_0;

    // out_1_1_imag_q_tpl(GPOUT,14)
    assign out_1_1_imag_q_tpl = scale_HB1_im_qOut_1;

    // out_1_1_real_q_tpl(GPOUT,15)
    assign out_1_1_real_q_tpl = scale_HB1_re_qOut_1;
