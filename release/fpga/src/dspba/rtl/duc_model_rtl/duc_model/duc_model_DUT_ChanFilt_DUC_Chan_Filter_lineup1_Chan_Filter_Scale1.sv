...
// SystemVerilog created from duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale1
...
module duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Chan_Filter_Scale1 (
    input wire [0:0] xIn_v,
    input wire [7:0] xIn_c,
    input wire [39:0] xIn_0,
    ...
    wire [8:0] u0_rnd_add_p2_of_2_a;
    wire [8:0] u0_rnd_add_p2_of_2_b;
    logic [8:0] u0_rnd_add_p2_of_2_o;
    wire [0:0] u0_rnd_add_p2_of_2_cin;
    wire [6:0] u0_rnd_add_p2_of_2_q;
    wire [19:0] u0_rnd_add_BitSelect_for_b_BitJoin_for_b_q_const_q;
    wire [6:0] u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q;
    reg [0:0] redist0_u0_rnd_add_BitSelect_for_a_tessel1_1_b_1_q;
    reg [5:0] redist1_u0_rnd_add_BitSelect_for_a_tessel1_0_b_1_q;
    ...
    wire [39:0] u0_shiftsel_q;
    wire [39:0] u0_shiftsel_qint;
    wire [26:0] u0_rnd_add_BitJoin_for_q_q;
    wire [6:0] u0_rnd_add_BitSelect_for_a_BitJoin_for_c_q;
    wire [25:0] u0_rnd_trunc_q;
    wire [39:0] u0_rnd_trunc_qint;
    wire [25:0] u0_rnd_shift_q;
    wire [26:0] u0_rnd_shift_qint;
    wire [19:0] u0_rnd_add_BitSelect_for_a_tessel0_0_b;
    wire [5:0] u0_rnd_add_BitSelect_for_a_tessel1_0_b;
    ...
    // u0_rnd_add_BitSelect_for_b_BitJoin_for_b_q_const(CONSTANT,77)
    ...
    assign u0_shiftsel_q = u0_shiftsel_qint[39:0];

    // u0_rnd_trunc(BITSHIFT,8)@0
    assign u0_rnd_trunc_qint = u0_shiftsel_q;
    assign u0_rnd_trunc_q = u0_rnd_trunc_qint[39:14];
    ...
    // u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const(CONSTANT,85)
    assign u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q = $unsigned(7'b0000000);

    // u0_rnd_add_BitSelect_for_a_tessel1_1(BITSELECT,26)@0
    assign u0_rnd_add_BitSelect_for_a_tessel1_1_b = $unsigned(u0_rnd_trunc_q[25:25]);

    // redist0_u0_rnd_add_BitSelect_for_a_tessel1_1_b_1(DELAY,86)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    assign u0_rnd_add_BitSelect_for_a_tessel1_0_b = $unsigned(u0_rnd_trunc_q[25:20]);

    // redist1_u0_rnd_add_BitSelect_for_a_tessel1_0_b_1(DELAY,87)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    assign u0_rnd_add_p2_of_2_a = $unsigned({ {{1{u0_rnd_add_BitSelect_for_a_BitJoin_for_c_q[6]}}, u0_rnd_add_BitSelect_for_a_BitJoin_for_c_q}, 1'b1 });
    assign u0_rnd_add_p2_of_2_b = $unsigned({ {{1{u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q[6]}}, u0_rnd_add_BitSelect_for_b_BitJoin_for_c_q_const_q}, u0_rnd_add_p2_of_2_cin[0] });
    always @ (posedge clk)
    begin
        if (areset)
        begin
            u0_rnd_add_p2_of_2_o <= 9'b0;
        end
        else
        begin
    ...
    assign u0_rnd_add_p2_of_2_q = u0_rnd_add_p2_of_2_o[7:1];

    // redist2_u0_rnd_add_p1_of_2_q_1(DELAY,88)
    always @ (posedge clk)
    begin
        if (areset)
        begin
    ...
    assign u0_rnd_shift_q = u0_rnd_shift_qint[26:1];

    // redist4_xIn_c_2(DELAY,90)
    always @ (posedge clk)
    begin
        if (areset)
        begin
