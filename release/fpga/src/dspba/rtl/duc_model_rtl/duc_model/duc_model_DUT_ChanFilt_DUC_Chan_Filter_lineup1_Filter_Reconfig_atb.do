...
if {! [file exists $base_dir/duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Filter_Reconfig]} {
    file delete -force $base_dir/duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Filter_Reconfig
}

project new $base_dir duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Filter_Reconfig
...
do "$base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Filter_Reconfig_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Filter_Reconfig_atb.vhd}
project addfile $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Filter_Reconfig_atb.vhd vhdl
project addfile $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Filter_Reconfig_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_2_Out4_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_Out4_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_3_Out6_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_Out6_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_real_Out1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_real_Out1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_1_imag_Out1_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_imag_Out1_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_4_CoefBankSel_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_4_CoefBankSel_tpl $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Filter_Reconfig_atb $ll
    do $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_Chan_Filter_lineup1_Filter_Reconfig_atb.wav.do
