...
if {! [file exists $base_dir/duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer]} {
    file delete -force $base_dir/duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer
}

project new $base_dir duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer
...
do "$base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer_atb.vhd}
project addfile $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer_atb.vhd vhdl
project addfile $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_iOut_1} mismatch] == 0 && $mismatch } {
                report_mismatch iOut_1 $cyclenum
            }
            if { [catch {exa mismatch_iOut_2} mismatch] == 0 && $mismatch } {
                report_mismatch iOut_2 $cyclenum
            }
            if { [catch {exa mismatch_iOut_3} mismatch] == 0 && $mismatch } {
                report_mismatch iOut_3 $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer_atb $ll
    do $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_COMPLEX_MIXER1_ComplexMixer_atb.wav.do
