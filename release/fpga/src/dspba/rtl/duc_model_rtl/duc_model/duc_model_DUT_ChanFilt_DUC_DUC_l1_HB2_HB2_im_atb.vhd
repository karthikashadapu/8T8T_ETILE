...
-- VHDL created from duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im
...
entity duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im_atb is
end;

architecture normal of duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im_atb is

component duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im is
    port (
        ...
        xOut_1 : out std_logic_vector(35 downto 0);  -- sfix36
        xOut_2 : out std_logic_vector(35 downto 0);  -- sfix36
        xOut_3 : out std_logic_vector(35 downto 0);  -- sfix36
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im_stm is
    port (
        ...
        xOut_0_stm : out std_logic_vector(35 downto 0);
        xOut_1_stm : out std_logic_vector(35 downto 0);
        xOut_2_stm : out std_logic_vector(35 downto 0);
        xOut_3_stm : out std_logic_vector(35 downto 0);
        clk : out std_logic;
...
signal xOut_0_stm : STD_LOGIC_VECTOR (35 downto 0);
signal xOut_1_stm : STD_LOGIC_VECTOR (35 downto 0);
signal xOut_2_stm : STD_LOGIC_VECTOR (35 downto 0);
signal xOut_3_stm : STD_LOGIC_VECTOR (35 downto 0);
...
signal xOut_0_dut : STD_LOGIC_VECTOR (35 downto 0);
signal xOut_1_dut : STD_LOGIC_VECTOR (35 downto 0);
signal xOut_2_dut : STD_LOGIC_VECTOR (35 downto 0);
signal xOut_3_dut : STD_LOGIC_VECTOR (35 downto 0);
...
checkxIn : process (clk, areset, xIn_0_dut, xIn_0_stm, xIn_1_dut, xIn_1_stm)
begin
END PROCESS;
...
dut : duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
...
sim : duc_model_DUT_ChanFilt_DUC_DUC_l1_HB2_HB2_im_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xIn_1_stm,
