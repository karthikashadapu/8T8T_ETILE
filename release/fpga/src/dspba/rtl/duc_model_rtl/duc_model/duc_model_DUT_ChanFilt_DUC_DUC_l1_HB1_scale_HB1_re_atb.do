...
if {! [file exists $base_dir/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_re]} {
    file delete -force $base_dir/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_re
}

project new $base_dir duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_re
...
do "$base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_re_fpc.do"
...
puts {vcom -quiet -O0 $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_re_atb.vhd}
project addfile $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_re_atb.vhd vhdl
project addfile $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_re_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_re_atb $ll
    do $base_dir/duc_model/duc_model_DUT_ChanFilt_DUC_DUC_l1_HB1_scale_HB1_re_atb.wav.do
