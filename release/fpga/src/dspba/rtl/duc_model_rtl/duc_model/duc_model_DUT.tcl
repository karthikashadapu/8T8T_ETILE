# This is the top level tcl file for 'duc_model_DUT'
...
if {!$overwrite_opt && [project_exists duc_model_DUT]} {
    puts "The duc_model_DUT quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "../../rtl/duc_model_rtl/duc_model/duc_model_DUT.tcl"]}    {
    puts "You must run duc_model_DUT.tcl "
...
puts "Creating duc_model_DUT Quartus project..."

if $overwrite_opt {
    project_new -overwrite duc_model_DUT
} else {
    project_new duc_model_DUT
}

set_global_assignment -name FAMILY "Agilex 7"
set_global_assignment -name TOP_LEVEL_ENTITY duc_model_DUT
set_global_assignment -name DEVICE AGFB014R24A3E3V
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ../../rtl/duc_model_rtl/duc_model/duc_model_DUT.sdc
set_global_assignment -name SYNCHRONIZATION_REGISTER_CHAIN_LENGTH 1
set_global_assignment -name SEARCH_PATH ../../rtl/duc_model_rtl/duc_model
source ./additional_settings.qsf
source ../../rtl/duc_model_rtl/duc_model/duc_model_DUT.add.tcl
...
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l1_im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_l1_re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_NCO_sync_0
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_NCO_sync_1
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_NCO_sync_2
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_NCO_sync_3
...
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_Out_0im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_Out_0re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_Out_1im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_Out_1re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_Out_2im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_Out_2re
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_Out_3im
set_instance_assignment -name VIRTUAL_PIN ON -to DUC_Data_Out_3re
set_instance_assignment -name VIRTUAL_PIN ON -to duc_l1_vout_s
set_instance_assignment -name VIRTUAL_PIN ON -to duc_l1_cout_s
set_instance_assignment -name VIRTUAL_PIN ON -to duc_l1_dout_0im
set_instance_assignment -name VIRTUAL_PIN ON -to duc_l1_dout_0re
set_instance_assignment -name VIRTUAL_PIN ON -to duc_l1_dout_1im
set_instance_assignment -name VIRTUAL_PIN ON -to duc_l1_dout_1re
set_instance_assignment -name VIRTUAL_PIN ON -to duc_l1_dout_2im
set_instance_assignment -name VIRTUAL_PIN ON -to duc_l1_dout_2re
set_instance_assignment -name VIRTUAL_PIN ON -to duc_l1_dout_3im
set_instance_assignment -name VIRTUAL_PIN ON -to duc_l1_dout_3re
...
source "../../rtl/duc_model_rtl/duc_model/duc_model_DUT_fpc.add.tcl"
