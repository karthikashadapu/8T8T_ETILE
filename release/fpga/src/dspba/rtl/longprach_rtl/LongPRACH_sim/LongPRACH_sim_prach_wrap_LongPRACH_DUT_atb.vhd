...
-- VHDL created from LongPRACH_sim_prach_wrap_LongPRACH_DUT
...
entity LongPRACH_sim_prach_wrap_LongPRACH_DUT_atb is
end;

architecture normal of LongPRACH_sim_prach_wrap_LongPRACH_DUT_atb is

component LongPRACH_sim_prach_wrap_LongPRACH_DUT is
    port (
        ...
        in_11_filt_flush_en_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_12_start_sym_tpl : in std_logic_vector(3 downto 0);  -- ufix4
        in_13_SubFrame_cplane_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_14_gain_re_tpl : in std_logic_vector(15 downto 0);  -- ufix16_en14
        in_15_gain_im_tpl : in std_logic_vector(15 downto 0);  -- ufix16_en14
        in_16_ch0_info_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_17_ch1_info_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_18_ch2_info_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_19_ch3_info_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_20_RFN_cplane_tpl : in std_logic_vector(11 downto 0);  -- ufix12
...
component LongPRACH_sim_prach_wrap_LongPRACH_DUT_stm is
    port (
        ...
        in_11_filt_flush_en_tpl_stm : out std_logic_vector(0 downto 0);
        in_12_start_sym_tpl_stm : out std_logic_vector(3 downto 0);
        in_13_SubFrame_cplane_tpl_stm : out std_logic_vector(7 downto 0);
        in_14_gain_re_tpl_stm : out std_logic_vector(15 downto 0);
        in_15_gain_im_tpl_stm : out std_logic_vector(15 downto 0);
        in_16_ch0_info_tpl_stm : out std_logic_vector(15 downto 0);
        in_17_ch1_info_tpl_stm : out std_logic_vector(15 downto 0);
        in_18_ch2_info_tpl_stm : out std_logic_vector(15 downto 0);
        in_19_ch3_info_tpl_stm : out std_logic_vector(15 downto 0);
        in_20_RFN_cplane_tpl_stm : out std_logic_vector(11 downto 0);
...
signal in_11_filt_flush_en_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_12_start_sym_tpl_stm : STD_LOGIC_VECTOR (3 downto 0);
signal in_13_SubFrame_cplane_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal in_14_gain_re_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_15_gain_im_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_16_ch0_info_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_17_ch1_info_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_18_ch2_info_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_19_ch3_info_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_20_RFN_cplane_tpl_stm : STD_LOGIC_VECTOR (11 downto 0);
...
signal in_11_filt_flush_en_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_12_start_sym_tpl_dut : STD_LOGIC_VECTOR (3 downto 0);
signal in_13_SubFrame_cplane_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal in_14_gain_re_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_15_gain_im_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_16_ch0_info_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_17_ch1_info_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_18_ch2_info_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_19_ch3_info_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_20_RFN_cplane_tpl_dut : STD_LOGIC_VECTOR (11 downto 0);
...
-- General Purpose data in real output
checkin_11_filt_flush_en_tpl : process (clk, areset, in_11_filt_flush_en_tpl_dut, in_11_filt_flush_en_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_12_start_sym_tpl : process (clk, areset, in_12_start_sym_tpl_dut, in_12_start_sym_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_13_SubFrame_cplane_tpl : process (clk, areset, in_13_SubFrame_cplane_tpl_dut, in_13_SubFrame_cplane_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_14_gain_re_tpl : process (clk, areset, in_14_gain_re_tpl_dut, in_14_gain_re_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_15_gain_im_tpl : process (clk, areset, in_15_gain_im_tpl_dut, in_15_gain_im_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_16_ch0_info_tpl : process (clk, areset, in_16_ch0_info_tpl_dut, in_16_ch0_info_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_17_ch1_info_tpl : process (clk, areset, in_17_ch1_info_tpl_dut, in_17_ch1_info_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_18_ch2_info_tpl : process (clk, areset, in_18_ch2_info_tpl_dut, in_18_ch2_info_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_19_ch3_info_tpl : process (clk, areset, in_19_ch3_info_tpl_dut, in_19_ch3_info_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_20_RFN_cplane_tpl : process (clk, areset, in_20_RFN_cplane_tpl_dut, in_20_RFN_cplane_tpl_stm)
begin
END PROCESS;


dut : LongPRACH_sim_prach_wrap_LongPRACH_DUT port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
    ...
    in_11_filt_flush_en_tpl_stm,
    in_12_start_sym_tpl_stm,
    in_13_SubFrame_cplane_tpl_stm,
    in_14_gain_re_tpl_stm,
    in_15_gain_im_tpl_stm,
    in_16_ch0_info_tpl_stm,
    in_17_ch1_info_tpl_stm,
    in_18_ch2_info_tpl_stm,
    in_19_ch3_info_tpl_stm,
    in_20_RFN_cplane_tpl_stm,
...
sim : LongPRACH_sim_prach_wrap_LongPRACH_DUT_stm port map (
    busIn_writedata_stm,
    busIn_address_stm,
    busIn_write_stm,
    busIn_read_stm,
