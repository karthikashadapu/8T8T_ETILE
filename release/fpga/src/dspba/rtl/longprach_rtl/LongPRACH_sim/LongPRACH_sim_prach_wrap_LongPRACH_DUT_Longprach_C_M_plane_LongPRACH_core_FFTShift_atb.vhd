...
entity LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_FFTShift_atb is
end;

architecture normal of LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_FFTShift_atb is

component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_FFTShift is
    port (
        in_2_data_valid_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_3_chin_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_1_real_data_in_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en8
        in_1_imag_data_in_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en8
        out_2_valid_out_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_3_ch_no_tpl : out std_logic_vector(7 downto 0);  -- ufix8
        out_1_real_data_out_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en8
        out_1_imag_data_out_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en8
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_FFTShift_stm is
    port (
...
checkChannelIn_cunroll_x : process (clk, areset, in_1_real_data_in_tpl_dut, in_1_real_data_in_tpl_stm, in_1_imag_data_in_tpl_dut, in_1_imag_data_in_tpl_stm)
begin
END PROCESS;
...
dut : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_FFTShift port map (
...
sim : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_FFTShift_stm port map (
    in_2_data_valid_tpl_stm,
    in_3_chin_tpl_stm,
    in_1_real_data_in_tpl_stm,
    in_1_imag_data_in_tpl_stm,
