...
entity LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_gain_atb is
end;

architecture normal of LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_gain_atb is

component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_gain is
    port (
        ...
        out_1_real_data_out_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en13
        out_1_imag_data_out_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en13
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_gain_stm is
    port (
...
dut : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_gain port map (
...
sim : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_gain_stm port map (
    in_2_data_valid_tpl_stm,
    in_3_chin_tpl_stm,
    in_1_real_data_in_tpl_stm,
    in_1_imag_data_in_tpl_stm,
