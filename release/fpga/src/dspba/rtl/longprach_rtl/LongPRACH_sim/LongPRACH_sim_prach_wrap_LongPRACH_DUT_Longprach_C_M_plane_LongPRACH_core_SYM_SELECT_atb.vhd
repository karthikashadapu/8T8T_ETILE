...
entity LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_SYM_SELECT_atb is
end;

architecture normal of LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_SYM_SELECT_atb is

component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_SYM_SELECT is
    port (
        in_2_vin_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_3_chin_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_1_real_din_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en8
        in_1_imag_din_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en8
        in_4_TimeRef_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_5_prach_outstart_tpl : in std_logic_vector(6 downto 0);  -- ufix7
        in_6_prach_outend_tpl : in std_logic_vector(9 downto 0);  -- ufix10
        in_7_ch0_info_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_8_ch1_info_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_9_ch2_info_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        in_10_ch3_info_tpl : in std_logic_vector(15 downto 0);  -- ufix16
        ...
        out_4_TimeReference_tpl : out std_logic_vector(0 downto 0);  -- ufix1
...
component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_SYM_SELECT_stm is
    port (
...
signal in_4_TimeRef_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal in_5_prach_outstart_tpl_stm : STD_LOGIC_VECTOR (6 downto 0);
signal in_6_prach_outend_tpl_stm : STD_LOGIC_VECTOR (9 downto 0);
signal in_7_ch0_info_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_8_ch1_info_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_9_ch2_info_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_10_ch3_info_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
...
signal out_4_TimeReference_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
...
signal in_4_TimeRef_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_5_prach_outstart_tpl_dut : STD_LOGIC_VECTOR (6 downto 0);
signal in_6_prach_outend_tpl_dut : STD_LOGIC_VECTOR (9 downto 0);
signal in_7_ch0_info_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_8_ch1_info_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_9_ch2_info_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_10_ch3_info_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
...
signal out_4_TimeReference_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
...
checkChannelIn_cunroll_x : process (clk, areset, in_1_real_din_tpl_dut, in_1_real_din_tpl_stm, in_1_imag_din_tpl_dut, in_1_imag_din_tpl_stm, in_4_TimeRef_tpl_dut, in_4_TimeRef_tpl_stm, in_5_prach_outstart_tpl_dut, in_5_prach_outstart_tpl_stm, in_6_prach_outend_tpl_dut, in_6_prach_outend_tpl_stm, in_7_ch0_info_tpl_dut, in_7_ch0_info_tpl_stm, in_8_ch1_info_tpl_dut, in_8_ch1_info_tpl_stm, in_9_ch2_info_tpl_dut, in_9_ch2_info_tpl_stm, in_10_ch3_info_tpl_dut, in_10_ch3_info_tpl_stm)
begin
END PROCESS;


-- Channelized data out check
checkChannelOut_cunroll_x : process (clk, areset, out_1_real_dout_tpl_dut, out_1_real_dout_tpl_stm, out_1_imag_dout_tpl_dut, out_1_imag_dout_tpl_stm, out_4_TimeReference_tpl_dut, out_4_TimeReference_tpl_stm, out_5_ch_info_tpl_dut, out_5_ch_info_tpl_stm)
...
variable mismatch_out_5_ch_info_tpl : BOOLEAN := FALSE;
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        mismatch_out_5_ch_info_tpl := FALSE;
        ...
        IF ((out_2_vout_tpl_dut = "1")) THEN
            ...
            END IF;
            IF ( (out_5_ch_info_tpl_dut /= out_5_ch_info_tpl_stm)) THEN
                mismatch_out_5_ch_info_tpl := TRUE;
                report "mismatch in out_5_ch_info_tpl signal" severity Warning;
            END IF;
        END IF;
        IF (mismatch_out_2_vout_tpl = TRUE or mismatch_out_3_cout_tpl = TRUE or mismatch_out_1_real_dout_tpl = TRUE or mismatch_out_1_imag_dout_tpl = TRUE or mismatch_out_4_TimeReference_tpl = TRUE or mismatch_out_5_ch_info_tpl = TRUE) THEN
            ok := FALSE;
        END IF;
        IF (ok = FALSE) THEN
...
dut : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_SYM_SELECT port map (
    in_2_vin_tpl_stm,
    in_3_chin_tpl_stm,
    in_1_real_din_tpl_stm,
    in_1_imag_din_tpl_stm,
    in_4_TimeRef_tpl_stm,
    in_5_prach_outstart_tpl_stm,
    in_6_prach_outend_tpl_stm,
    in_7_ch0_info_tpl_stm,
    in_8_ch1_info_tpl_stm,
    in_9_ch2_info_tpl_stm,
    in_10_ch3_info_tpl_stm,
    out_2_vout_tpl_dut,
    out_3_cout_tpl_dut,
...
sim : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_SYM_SELECT_stm port map (
    in_2_vin_tpl_stm,
    in_3_chin_tpl_stm,
    in_1_real_din_tpl_stm,
    in_1_imag_din_tpl_stm,
