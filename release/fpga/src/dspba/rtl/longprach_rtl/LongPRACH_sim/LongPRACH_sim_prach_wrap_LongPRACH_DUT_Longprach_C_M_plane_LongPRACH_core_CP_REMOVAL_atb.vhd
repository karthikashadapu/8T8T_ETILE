...
-- VHDL created from LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_CP_REMOVAL
...
entity LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_CP_REMOVAL_atb is
end;

architecture normal of LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_CP_REMOVAL_atb is

component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_CP_REMOVAL is
    port (
...
component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_CP_REMOVAL_stm is
    port (
...
-- General Purpose data in real output
checkin_4_cp_start_tpl : process (clk, areset, in_4_cp_start_tpl_dut, in_4_cp_start_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_5_gt_end_tpl : process (clk, areset, in_5_gt_end_tpl_dut, in_5_gt_end_tpl_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_6_filt_flush_en_tpl : process (clk, areset, in_6_filt_flush_en_tpl_dut, in_6_filt_flush_en_tpl_stm)
begin
END PROCESS;


dut : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_CP_REMOVAL port map (
...
sim : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_CP_REMOVAL_stm port map (
    in_1_imag_din_tpl_stm,
    in_1_real_din_tpl_stm,
    in_2_vin_tpl_stm,
    in_3_cin_tpl_stm,
