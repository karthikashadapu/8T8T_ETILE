...
entity LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_S2B_atb is
end;

architecture normal of LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_S2B_atb is

component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_S2B is
    port (
...
component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_S2B_stm is
    port (
...
checkChannelIn_cunroll_x : process (clk, areset, in_1_real_data_in_tpl_dut, in_1_real_data_in_tpl_stm, in_1_imag_data_in_tpl_dut, in_1_imag_data_in_tpl_stm, in_4_resetin_tpl_dut, in_4_resetin_tpl_stm)
begin
END PROCESS;
...
dut : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_S2B port map (
...
sim : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_S2B_FFT_S2B_stm port map (
    in_2_data_valid_tpl_stm,
    in_3_chin_tpl_stm,
    in_1_real_data_in_tpl_stm,
    in_1_imag_data_in_tpl_stm,
