# This is the top level tcl file for 'LongPRACH_sim_prach_wrap'
...
if {!$overwrite_opt && [project_exists LongPRACH_sim_prach_wrap]} {
    puts "The LongPRACH_sim_prach_wrap quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "../../rtl/longprach_rtl/LongPRACH_sim/LongPRACH_sim_prach_wrap.tcl"]}    {
    puts "You must run LongPRACH_sim_prach_wrap.tcl "
...
puts "Creating LongPRACH_sim_prach_wrap Quartus project..."

if $overwrite_opt {
    project_new -overwrite LongPRACH_sim_prach_wrap
} else {
    project_new LongPRACH_sim_prach_wrap
}

set_global_assignment -name FAMILY "Agilex 7"
set_global_assignment -name TOP_LEVEL_ENTITY LongPRACH_sim_prach_wrap
set_global_assignment -name DEVICE AGFB014R24A3E3V
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ../../rtl/longprach_rtl/LongPRACH_sim/LongPRACH_sim_prach_wrap.sdc
set_global_assignment -name SYNCHRONIZATION_REGISTER_CHAIN_LENGTH 1
set_global_assignment -name SEARCH_PATH ../../rtl/longprach_rtl/LongPRACH_sim
source ../../rtl/longprach_rtl/LongPRACH_sim/LongPRACH_sim_prach_wrap.add.tcl

set_instance_assignment -name VIRTUAL_PIN ON -to vin0_s
set_instance_assignment -name VIRTUAL_PIN ON -to chin0_s
set_instance_assignment -name VIRTUAL_PIN ON -to din0_im
set_instance_assignment -name VIRTUAL_PIN ON -to din0_re
set_instance_assignment -name VIRTUAL_PIN ON -to RFN_s
set_instance_assignment -name VIRTUAL_PIN ON -to subframe_s
set_instance_assignment -name VIRTUAL_PIN ON -to prach_cfg_idx_s
set_instance_assignment -name VIRTUAL_PIN ON -to cp_len_s
set_instance_assignment -name VIRTUAL_PIN ON -to offset_s
set_instance_assignment -name VIRTUAL_PIN ON -to c_m_plane_sel_s
set_instance_assignment -name VIRTUAL_PIN ON -to prach_tech_s
set_instance_assignment -name VIRTUAL_PIN ON -to filt_flush_en_s
set_instance_assignment -name VIRTUAL_PIN ON -to start_sym_s
set_instance_assignment -name VIRTUAL_PIN ON -to SubFrame_cplane_s
set_instance_assignment -name VIRTUAL_PIN ON -to gain_re_s
set_instance_assignment -name VIRTUAL_PIN ON -to gain_im_s
set_instance_assignment -name VIRTUAL_PIN ON -to ch0_info_s
set_instance_assignment -name VIRTUAL_PIN ON -to ch1_info_s
set_instance_assignment -name VIRTUAL_PIN ON -to ch2_info_s
set_instance_assignment -name VIRTUAL_PIN ON -to ch3_info_s
set_instance_assignment -name VIRTUAL_PIN ON -to RFN_cplane_s
set_instance_assignment -name VIRTUAL_PIN ON -to dout_im
set_instance_assignment -name VIRTUAL_PIN ON -to dout_re
...
set_instance_assignment -name VIRTUAL_PIN ON -to version_info_s
set_instance_assignment -name VIRTUAL_PIN ON -to ch_info_s
...
source "../../rtl/longprach_rtl/LongPRACH_sim/LongPRACH_sim_prach_wrap_fpc.add.tcl"
