...
-- VHDL created from LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMATION1
...
entity LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMATION1_atb is
end;

architecture normal of LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMATION1_atb is

component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMATION1 is
    port (
        ...
        in_4_filt_flush_tpl : in std_logic_vector(0 downto 0);  -- ufix1
...
component LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMATION1_stm is
    port (
        ...
        in_4_filt_flush_tpl_stm : out std_logic_vector(0 downto 0);
...
signal in_4_filt_flush_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
...
signal in_4_filt_flush_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
...
-- General Purpose data in real output
checkin_4_filt_flush_tpl : process (clk, areset, in_4_filt_flush_tpl_dut, in_4_filt_flush_tpl_stm)
begin
END PROCESS;


dut : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMATION1 port map (
    in_1_imag_din_tpl_stm,
    in_1_real_din_tpl_stm,
    in_2_vin_tpl_stm,
    in_3_cin_tpl_stm,
    in_4_filt_flush_tpl_stm,
...
sim : LongPRACH_sim_prach_wrap_LongPRACH_DUT_Longprach_C_M_plane_LongPRACH_core_DECIMATION1_stm port map (
    in_1_imag_din_tpl_stm,
    in_1_real_din_tpl_stm,
    in_2_vin_tpl_stm,
    in_3_cin_tpl_stm,
