...
% |SNRdB| as an array of values or a scalar. Table 8.4.1.5-1 in TS 38.141-1
% specifies the frequency offset |foffset| that is modeled between
...
channel.NumReceiveAntennas = 4;             % Number of receive antennas
