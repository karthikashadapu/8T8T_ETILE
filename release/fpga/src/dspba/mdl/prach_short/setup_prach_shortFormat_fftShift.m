...
%% Set Parameters 
set_param('prach_shortFormat_fftShift/prach/PRACH_CC/ControlDecode/ChannelI3n','scheduleOrigin','on');
%% MM Register Setting
PRACH_reg_setting;
...
%% Simulation
prach_short.SimulationTime = max(prach_short.ClockRate/prach_short.SampleRateMSPS, NTxAnts)*length(waveform)+Nfft*2;
close all;
