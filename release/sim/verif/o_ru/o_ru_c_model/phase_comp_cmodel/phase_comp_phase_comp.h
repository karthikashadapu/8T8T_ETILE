...
private:
    ...
    void execute()
    {
        ...
        if ((m_segment_cycle[6] == m_update_cycle) && (m_io_cycle[7] > m_update_cycle) && (m_io_cycle[6] > m_update_cycle) && (m_io_cycle[5] > m_update_cycle) && (m_io_cycle[4] > m_update_cycle) && (m_io_cycle[8] > m_update_cycle))
        {
            execute_segment_6();
            ++m_segment_cycle[6];
        }
